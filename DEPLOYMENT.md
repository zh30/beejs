...
1. **备份当前版本**
   ```bash
   cp /usr/local/bin/beejs /usr/local/bin/beejs.backup
   ```
...
4. **回滚（如需要）**
   ```bash
   sudo cp /usr/local/bin/beejs.backup /usr/local/bin/beejs
   ```
...
- **GitHub**: [https://github.com/your-org/beejs](https://github.com/your-org/beejs)
- **问题报告**: [https://github.com/your-org/beejs/issues](https://github.com/your-org/beejs/issues)
