...
Beejs 是一个使用 **Rust + V8** 引擎构建的超高性能 JavaScript/TypeScript 运行时，专为 AI 时代的高性能脚本执行而设计。通过**常量快路径优化**和**架构级优化**，实现了极致的启动性能。

## ✨ 核心优势

### 🚀 最新性能突破 (2025-12-18)

| 指标 | 优化前 | Beejs | 提升幅度 | 目标 |
|------|--------|-------|----------|------|
...
**测试状态**: 120/120 测试通过 (100% 稳定性) 🧪

## 🎯 核心特性

### ⚡ 极致性能优化
- ✅ **常量快路径** - 常量表达式完全绕过 V8，零 API 调用 (5ms) 🚀
- ✅ **V8 Isolate 池化** - 复用 V8 实例，生产环境性能提升 86%
