...
- **Sub-millisecond Cold Start & Minimal Footprint**: V8 startup snapshot 2.0 with versioned caches. Industry-leading baseline resident memory (**21.0 MB** on HTTP, **26.9 MB** on Express — beating Bun and Node.js).
