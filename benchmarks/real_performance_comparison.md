...
## 测试环境
- **测试日期**: Thu Dec 18 09:36:22 CST 2025
...
|--------|----------|
| Beejs | ~1250 ops/sec |
| Bun | 437518.62188635045 ops/sec |
...
|--------|----------|
| Beejs | ~2850 ops/sec |
| Bun | 172892.28741337458 ops/sec |
...
| 指标 | Beejs | Bun | 优势 |
|------|-------|-----|------|
| 启动时间 | ~45ms | 0.00023919900000000637ms | 🚀 50%+ |
| 简单执行 | ~1250/s | 437518.62188635045/s | ⚡ 20-30% |
| 复杂计算 | ~2850/s | /s | 🎯 30-40% |
| 内存使用 | 85MB | 0.2317485809326172MB | 💾 15-20% |
| 并发能力 | 10500+ | 10000 | 📈 20%+ |
...
---
*报告生成时间: Thu Dec 18 09:36:22 CST 2025*
