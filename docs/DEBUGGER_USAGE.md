...
> 发布校验说明（2026-05-26）：当前 public CLI 仅暴露 `bee debug <file>`。本文中 attach、inspect、Web UI、端口等内容属于历史/设计说明，不是当前 v0.1.0 公开命令契约。
...
# 当前 public CLI 暂不支持 --break-at、--web、attach 或 inspect 子模式
```
