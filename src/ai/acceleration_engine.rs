...
pub struct AccelerationEngine {
    ...
    gpu_available: bool,
    npu_available: bool,
    active_tasks: Arc<Mutex<HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask>>>>,
...
use std::collections::{HashMap, BTreeMap};
    ...
    fn test_acceleration_engine_creation() {
        let runtime: _ = Arc::new(std::sync::Mutex::new(Mutex::new(Runtime::new(8 * 1024 * 1024, 64 * 1024 * 1024, false, false)));
