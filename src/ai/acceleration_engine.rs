...
pub struct AccelerationEngine {
    ...
    gpu_available: bool,
    npu_available: bool,
    active_tasks: Arc<Mutex<HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask, u64, InferenceTask, std::collections::HashMap<u64, InferenceTask, u64, InferenceTask>>>>>>>,
...
impl AccelerationEngine {
    ...
    pub fn new(runtime: &Arc<Runtime>, config: AccelerationConfig) -> Result<Self, String> {
        ...
        Ok(AccelerationEngine {
            ...
            gpu_available,
            npu_available,
            active_tasks: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(HashMap::new())))),
            batch_queue: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(VecDeque::new())))),
            performance_stats: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(AccelerationStats::default())))),
            batch_config: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(BatchConfig {
...
use std::collections::{HashMap, BTreeMap};
    ...
    fn test_acceleration_engine_creation() {
        let runtime: _ = Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(Runtime::new(8 * 1024 * 1024, 64 * 1024 * 1024, false, false)))));
