...
pub struct AiLlmEngine {
    ...
    token_cache: Arc<RwLock<HashMap<String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry, String, TokenCacheEntry, std::collections::HashMap<String, TokenCacheEntry, String, TokenCacheEntry>>>>>>>,
    memory_pool: Arc<Mutex<Vec<Vec<f32>>,
    active_sessions: Arc<Mutex<HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo>>>>>>>,
}
...
impl AiLlmEngine {
    ...
    pub fn new(runtime: &Arc<tokio::runtime::Runtime>, config: LlmConfig) -> Result<Self, String> {
        let engine: _ = AiLlmEngine {
            ...
            token_cache: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new())))),
            memory_pool: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(Vec::new())))),
            active_sessions: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(HashMap::new())))),
        };
    ...
    fn update_cache(
        ...
        let entry: _ = TokenCacheEntry {
            ...
            kv_cache: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(kv_cache))))),
