...
pub struct AiLlmEngine {
    ...
    active_sessions: Arc<Mutex<HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo, String, SessionInfo, std::collections::HashMap<String, SessionInfo, String, SessionInfo>>>>,
}
...
impl AiLlmEngine {
    ...
    pub fn new(runtime: &Arc<tokio::runtime::Runtime>, config: LlmConfig) -> Result<Self, String> {
        let engine: _ = AiLlmEngine {
            ...
            token_cache: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new())),
