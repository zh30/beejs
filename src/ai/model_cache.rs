...
impl ModelCache {
    ...
    pub fn new(config: ModelCacheConfig) -> Result<Self, String> {
        ...
        Ok(ModelCache {
            ...
            l3_cache: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(HashMap::new())))),
            access_patterns: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new())))),
    ...
    pub fn load_model(&mut self, model_name: String) -> Result<CacheResult, String> {
        ...
        let entry: _ = CacheEntry {
            ...
            model_data: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(model_data))))),
            tier: CacheTier::L2Disk,
