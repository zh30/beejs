...
impl ModelRegistry {
    ...
    pub fn new(config: ModelRegistryConfig) -> Result<Self, String> {
        Ok(ModelRegistry {
            config: config.clone(),
            registered_models: Arc::new(Mutex::new(RwLock::new(HashMap::new())),
            health_status: Arc::new(Mutex::new(RwLock::new(HashMap::new())),
        })
    }
...
impl ModelRouter {
    ...
    pub fn new(config: RouterConfig) -> Result<Self, String> {
        Ok(ModelRouter {
            config: config.clone(),
            model_metrics: Arc::new(Mutex::new(RwLock::new(HashMap::new())),
...
impl ModelManager {
    ...
    pub fn new(runtime: &Arc<tokio::runtime::Runtime>, config: ManagerConfig) -> Result<Self, String> {
        ...
        Ok(ModelManager {
            ...
            registry,
            router,
            active_models: Arc::new(Mutex::new(RwLock::new(HashMap::new())),
