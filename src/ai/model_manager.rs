...
pub struct ModelRegistry {
    ...
    registered_models: Arc<RwLock<HashMap<String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo, String, ModelInfo, std::collections::HashMap<String, ModelInfo, String, ModelInfo>>>>>>>,
    health_status: Arc<RwLock<HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool>>>>>>>,
}
...
pub struct ModelManager {
    ...
    router: ModelRouter,
    active_models: Arc<RwLock<HashMap<String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle, String, ModelHandle, std::collections::HashMap<String, ModelHandle, String, ModelHandle>>>>>>>,
...
impl ModelRegistry {
    ...
    pub fn new(config: ModelRegistryConfig) -> Result<Self, String> {
        Ok(ModelRegistry {
            config: config.clone(),
            registered_models: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new())))),
            health_status: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new())))),
        })
    }
...
impl ModelRouter {
    ...
    pub fn new(config: RouterConfig) -> Result<Self, String> {
        Ok(ModelRouter {
            config: config.clone(),
            model_metrics: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new())))),
            route_cache: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new())))),
        })
    }
...
impl ModelManager {
    ...
    pub fn new(runtime: &Arc<tokio::runtime::Runtime>, config: ManagerConfig) -> Result<Self, String> {
        ...
        Ok(ModelManager {
            ...
            registry,
            router,
            active_models: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new())))),
            model_handles: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(Vec::new())))),
        })
    }
...
use std::collections::{HashMap, BTreeMap};
    ...
    fn test_model_manager_creation() {
        let runtime: _ = Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(tokio::runtime::Runtime::new())))).unwrap());
