...
impl AIInferenceEngine {
    ...
    pub async fn new() -> Result<Self> {
        ...
        Ok(AIInferenceEngine {
            ...
            gpu_accelerator,
            model_cache,
            inference_count: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(0)))))),
            total_inference_time: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(Duration::from_secs(0)))))),
        })
    }
