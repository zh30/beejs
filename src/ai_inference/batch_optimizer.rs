...
impl BatchProcessor {
    ...
    pub fn new(strategy: BatchStrategy) -> Self {
        BatchProcessor {
            strategy,
            current_batch: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(Vec::new()))))),
            stats: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(BatchStats {
                total_batches: 0,
                total_items: 0,
            ...
            processing_task: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(None)))))),
        }
    }
...
impl SmartBatchProcessor {
    ...
    pub fn new(initial_batch_size: usize) -> Self {
        ...
        SmartBatchProcessor {
            ...
            adaptive_params: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(AdaptiveParams {
...
impl PerformanceMonitor {
    ...
    fn new(window_size: usize) -> Self {
        PerformanceMonitor {
            latency_history: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(Vec::with_capacity(window_size)))))),
            throughput_history: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(Vec::with_capacity(window_size)))))),
            window_size,
        }
    }
