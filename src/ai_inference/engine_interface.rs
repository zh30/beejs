...
impl EngineManager {
    ...
    pub fn new(default_engine_type: EngineType) -> Self {
        EngineManager {
            ...
            active_engines: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(std::collections::HashMap::new())))),
            default_engine_type,
        }
    }
