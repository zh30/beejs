...
pub struct InferenceOptions {
    ...
    /// 自定义配置参数
    pub custom_options: std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String>>>>,
}
...
pub struct ModelHandle {
    ...
    /// 模型元数据
    pub metadata: std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String>>>>,
}
...
pub struct EngineManager {
    /// 引擎工厂注册表
    factories: std::collections::HashMap<String, Box<dyn EngineFactory, std::collections::HashMap<String, Box<dyn EngineFactory, String, Box<dyn EngineFactory, std::collections::HashMap<String, Box<dyn EngineFactory, std::collections::HashMap<String, Box<dyn EngineFactory, String, Box<dyn EngineFactory, String, Box<dyn EngineFactory, std::collections::HashMap<String, Box<dyn EngineFactory, String, Box<dyn EngineFactory>>>>,
    /// 活跃的引擎实例
    active_engines: Arc<RwLock<std::collections::HashMap<String, Box<dyn InferenceEngine, std::collections::HashMap<String, Box<dyn InferenceEngine, String, Box<dyn InferenceEngine, std::collections::HashMap<String, Box<dyn InferenceEngine, std::collections::HashMap<String, Box<dyn InferenceEngine, String, Box<dyn InferenceEngine, String, Box<dyn InferenceEngine, std::collections::HashMap<String, Box<dyn InferenceEngine, String, Box<dyn InferenceEngine>>>>>,
    /// 默认引擎类型
...
impl EngineManager {
    ...
    pub fn new(default_engine_type: EngineType) -> Self {
        EngineManager {
            ...
            active_engines: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(std::collections::HashMap::new())),
            default_engine_type,
        }
    }
