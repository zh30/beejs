...
impl GPUAccelerator {
    ...
    pub async fn new() -> Result<Self> {
        ...
        Ok(GPUAccelerator {
            devices,
            active_device: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(0)))))),
            stats: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(stats)))))),
        })
    }
