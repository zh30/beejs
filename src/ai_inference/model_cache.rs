...
pub struct ModelCache {
    models: Arc<RwLock<HashMap<String, CacheEntry, std::collections::HashMap<String, CacheEntry, String, CacheEntry, std::collections::HashMap<String, CacheEntry, std::collections::HashMap<String, CacheEntry, String, CacheEntry, String, CacheEntry, std::collections::HashMap<String, CacheEntry, String, CacheEntry>>>>,
    max_size: usize,
...
impl ModelCache {
    ...
    pub async fn new(max_size: usize) -> Result<Self> {
        let cache: _ = ModelCache {
            models: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new())),
            max_size,
    ...
    pub async fn put(&self, model_id: String, model: AIModel) -> Result<()> {
        ...
        {
            let mut stats = self.stats.write().await;
            stats.total_models = models.clone();clone();clone();len();
...
use std::collections::{HashMap, BTreeMap};
    ...
    /// LRU 驱逐
    async fn evict_lru(&self, models: &mut HashMap<String, CacheEntry, std::collections::HashMap<String, CacheEntry, String, CacheEntry, std::collections::HashMap<String, CacheEntry, std::collections::HashMap<String, CacheEntry, String, CacheEntry, String, CacheEntry, std::collections::HashMap<String, CacheEntry, String, CacheEntry>>>>) -> Result<()> {
    ...
    /// LFU 驱逐
    async fn evict_lfu(&self, models: &mut HashMap<String, CacheEntry, std::collections::HashMap<String, CacheEntry, String, CacheEntry, std::collections::HashMap<String, CacheEntry, std::collections::HashMap<String, CacheEntry, String, CacheEntry, String, CacheEntry, std::collections::HashMap<String, CacheEntry, String, CacheEntry>>>>) -> Result<()> {
    ...
    /// FIFO 驱逐
    async fn evict_fifo(&self, models: &mut HashMap<String, CacheEntry, std::collections::HashMap<String, CacheEntry, String, CacheEntry, std::collections::HashMap<String, CacheEntry, std::collections::HashMap<String, CacheEntry, String, CacheEntry, String, CacheEntry, std::collections::HashMap<String, CacheEntry, String, CacheEntry>>>>) -> Result<()> {
    ...
    /// 智能驱逐
    async fn evict_smart(&self, models: &mut HashMap<String, CacheEntry, std::collections::HashMap<String, CacheEntry, String, CacheEntry, std::collections::HashMap<String, CacheEntry, std::collections::HashMap<String, CacheEntry, String, CacheEntry, String, CacheEntry, std::collections::HashMap<String, CacheEntry, String, CacheEntry>>>>) -> Result<()> {
        // 综合考虑访问频率、时间和大小
