...
pub struct OnnxSession {
    ...
    /// 会话元数据
    metadata: std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String>>>>,
}
...
impl EngineFactory for OnnxEngineFactory {
    async fn create(&self, engine_type: EngineType) -> Result<Box<dyn InferenceEngine>> {
        ...
        let engine: _ = OnnxEngine {
            session: Arc::new(std::sync::Mutex::new(Mutex::new(session))),
            gpu_accelerator,
            optimizer,
            stats,
