...
pub struct AiModelManager {
    models: Arc<Mutex<HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel>>>>,
...
impl AiModelManager {
    ...
    /// 健康检查
    pub async fn health_check(&self) -> HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool>>>> {
        let models: _ = self.models.lock().unwrap();
