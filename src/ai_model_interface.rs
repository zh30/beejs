...
pub struct AiModelManager {
    models: Arc<Mutex<HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel, String, AiModel, std::collections::HashMap<String, AiModel, String, AiModel>>>>>>>,
...
impl AiModelManager {
    ...
    pub fn new() -> Self {
        Self {
            models: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(HashMap::new())))),
            default_model_id: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(None))))),
            routing_strategy: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(ModelRoutingStrategy::default())))),
        }
    }
...
pub fn create_text_generation_model(model_id: &str) -> AiModel {
    ...
    AiModel {
        ...
        is_loaded: false,
        load_time: None,
        metrics: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(ModelMetrics::default())))),
    }
}
