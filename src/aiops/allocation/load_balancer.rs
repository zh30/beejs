...
pub struct LoadBalancer {
    /// 后端服务器列表
    backends: HashMap<String, Backend, std::collections::HashMap<String, Backend, String, Backend, std::collections::HashMap<String, Backend, std::collections::HashMap<String, Backend, String, Backend, String, Backend, std::collections::HashMap<String, Backend, String, Backend>>>>,
    /// 负载均衡配置
