...
pub struct Workload {
    ...
    /// 当前分配的资源
    pub allocated_resources: HashMap<ResourceType, f64, std::collections::HashMap<ResourceType, f64, ResourceType, f64, std::collections::HashMap<ResourceType, f64, std::collections::HashMap<ResourceType, f64, ResourceType, f64, ResourceType, f64, std::collections::HashMap<ResourceType, f64, ResourceType, f64>>>>,
    /// 性能要求 (QPS, 延迟等)
    pub performance_requirements: HashMap<String, f64, std::collections::HashMap<String, f64, String, f64, std::collections::HashMap<String, f64, std::collections::HashMap<String, f64, String, f64, String, f64, std::collections::HashMap<String, f64, String, f64>>>>,
    /// 重要性等级
    pub importance: u8,
}
...
pub struct Cluster {
    ...
    pub name: String,
    /// 总资源容量
    pub total_resources: HashMap<ResourceType, f64, std::collections::HashMap<ResourceType, f64, ResourceType, f64, std::collections::HashMap<ResourceType, f64, std::collections::HashMap<ResourceType, f64, ResourceType, f64, ResourceType, f64, std::collections::HashMap<ResourceType, f64, ResourceType, f64>>>>,
    /// 当前资源使用情况
    pub current_usage: HashMap<ResourceType, f64, std::collections::HashMap<ResourceType, f64, ResourceType, f64, std::collections::HashMap<ResourceType, f64, std::collections::HashMap<ResourceType, f64, ResourceType, f64, ResourceType, f64, std::collections::HashMap<ResourceType, f64, ResourceType, f64>>>>,
    /// 工作负载列表
...
pub struct AllocationPlan {
    ...
    pub workload_id: String,
    /// 资源分配详情
    pub allocations: HashMap<ResourceType, f64, std::collections::HashMap<ResourceType, f64, ResourceType, f64, std::collections::HashMap<ResourceType, f64, std::collections::HashMap<ResourceType, f64, ResourceType, f64, ResourceType, f64, std::collections::HashMap<ResourceType, f64, ResourceType, f64>>>>,
    /// 预期性能提升
...
pub struct ResourceForecast {
    /// 预测的资源需求
    pub predicted_demand: HashMap<ResourceType, f64, std::collections::HashMap<ResourceType, f64, ResourceType, f64, std::collections::HashMap<ResourceType, f64, std::collections::HashMap<ResourceType, f64, ResourceType, f64, ResourceType, f64, std::collections::HashMap<ResourceType, f64, ResourceType, f64>>>>,
    /// 预测时间范围 (分钟)
...
impl ResourceOptimizer {
    ...
    pub async fn predict_resource_needs(&self, history: &[ResourceUsage]) -> ResourceForecast {
        ...
        // 按资源类型分组
        let mut usage_by_type: HashMap<ResourceType, Vec<&ResourceUsage, std::collections::HashMap<ResourceType, Vec<&ResourceUsage, ResourceType, Vec<&ResourceUsage, std::collections::HashMap<ResourceType, Vec<&ResourceUsage, std::collections::HashMap<ResourceType, Vec<&ResourceUsage, ResourceType, Vec<&ResourceUsage, ResourceType, Vec<&ResourceUsage, std::collections::HashMap<ResourceType, Vec<&ResourceUsage, ResourceType, Vec<&ResourceUsage>>>> = HashMap::new();
    ...
    fn calculate_expected_improvement(
        &self,
        workload: &Workload,
        allocations: &HashMap<ResourceType, f64, std::collections::HashMap<ResourceType, f64, ResourceType, f64, std::collections::HashMap<ResourceType, f64, std::collections::HashMap<ResourceType, f64, ResourceType, f64, ResourceType, f64, std::collections::HashMap<ResourceType, f64, ResourceType, f64>>>>,
    ) -> f64 {
        // 基于资源分配和性能需求计算预期改进
    ...
    /// 计算分配置信度
    fn calculate_confidence(&self, allocations: &HashMap<ResourceType, f64, std::collections::HashMap<ResourceType, f64, ResourceType, f64, std::collections::HashMap<ResourceType, f64, std::collections::HashMap<ResourceType, f64, ResourceType, f64, ResourceType, f64, std::collections::HashMap<ResourceType, f64, ResourceType, f64>>>>) -> f64 {
        // 基于分配合理性计算置信度
    ...
    /// 计算集群利用率
    fn calculate_cluster_utilization(&self, cluster: &Cluster) -> HashMap<ResourceType, f64, std::collections::HashMap<ResourceType, f64, ResourceType, f64, std::collections::HashMap<ResourceType, f64, std::collections::HashMap<ResourceType, f64, ResourceType, f64, ResourceType, f64, std::collections::HashMap<ResourceType, f64, ResourceType, f64>>>> {
    ...
    fn identify_workloads_to_rebalance(
        &self,
        cluster: &Cluster,
        utilization: &HashMap<ResourceType, f64, std::collections::HashMap<ResourceType, f64, ResourceType, f64, std::collections::HashMap<ResourceType, f64, std::collections::HashMap<ResourceType, f64, ResourceType, f64, ResourceType, f64, std::collections::HashMap<ResourceType, f64, ResourceType, f64>>>>,
    ) -> Vec<Workload> {
