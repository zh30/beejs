...
pub struct Task {
    ...
    /// 需要的资源类型和数量
    pub resource_requirements: HashMap<String, f64, std::collections::HashMap<String, f64, String, f64, std::collections::HashMap<String, f64, std::collections::HashMap<String, f64, String, f64, String, f64, std::collections::HashMap<String, f64, String, f64>>>>,
    /// 估计执行时间 (毫秒)
...
pub struct SchedulingDecision {
    ...
    /// 分配的资源
    pub allocated_resources: HashMap<String, f64, std::collections::HashMap<String, f64, String, f64, std::collections::HashMap<String, f64, std::collections::HashMap<String, f64, String, f64, String, f64, std::collections::HashMap<String, f64, String, f64>>>>,
    /// 预计开始时间
...
pub struct WorkloadProfile {
    ...
    /// 平均资源需求
    pub avg_resource_usage: HashMap<String, f64, std::collections::HashMap<String, f64, String, f64, std::collections::HashMap<String, f64, std::collections::HashMap<String, f64, String, f64, String, f64, std::collections::HashMap<String, f64, String, f64>>>>,
    /// 并发度
    pub concurrency: usize,
    /// 优先级分布
    pub priority_distribution: HashMap<TaskPriority, f64, std::collections::HashMap<TaskPriority, f64, TaskPriority, f64, std::collections::HashMap<TaskPriority, f64, std::collections::HashMap<TaskPriority, f64, TaskPriority, f64, TaskPriority, f64, std::collections::HashMap<TaskPriority, f64, TaskPriority, f64>>>>,
}
...
struct TaskExecution {
    task_id: String,
    start_time: Instant,
    allocated_resources: HashMap<String, f64, std::collections::HashMap<String, f64, String, f64, std::collections::HashMap<String, f64, std::collections::HashMap<String, f64, String, f64, String, f64, std::collections::HashMap<String, f64, String, f64>>>>,
}
...
impl Scheduler {
    ...
    pub async fn schedule_next(
        &mut self,
        available_resources: &HashMap<String, f64, std::collections::HashMap<String, f64, String, f64, std::collections::HashMap<String, f64, std::collections::HashMap<String, f64, String, f64, String, f64, std::collections::HashMap<String, f64, String, f64>>>>,
    ...
    fn allocate_resources_for_task(
        ...
        task: &Task,
        available_resources: &HashMap<String, f64, std::collections::HashMap<String, f64, String, f64, std::collections::HashMap<String, f64, std::collections::HashMap<String, f64, String, f64, String, f64, std::collections::HashMap<String, f64, String, f64>>>>,
    ) -> HashMap<String, f64, std::collections::HashMap<String, f64, String, f64, std::collections::HashMap<String, f64, std::collections::HashMap<String, f64, String, f64, String, f64, std::collections::HashMap<String, f64, String, f64>>>> {
...
pub struct SchedulerStatistics {
    ...
    /// 优先级分布
    pub priority_distribution: HashMap<TaskPriority, usize, std::collections::HashMap<TaskPriority, usize, TaskPriority, usize, std::collections::HashMap<TaskPriority, usize, std::collections::HashMap<TaskPriority, usize, TaskPriority, usize, TaskPriority, usize, std::collections::HashMap<TaskPriority, usize, TaskPriority, usize>>>>,
    /// 平均效率分数
