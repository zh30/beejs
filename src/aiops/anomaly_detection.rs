...
impl MLAnomalyDetector {
    pub fn new() -> Self {
        Self {
            model: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(MLModel::new(2.0)))))),
            feature_extractor: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(FeatureExtractor::new(10)))))),
        }
    }
...
impl AnomalyDetector {
    pub fn new() -> Self {
        Self {
            statistical_detector: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(StatisticalAnomalyDetector::new()))))),
            ml_detector: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(MLAnomalyDetector::new()))))),
        }
    }
