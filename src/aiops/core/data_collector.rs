...
impl DataCollector {
    ...
    pub fn new(interval: Duration) -> Self {
        Self {
            interval,
            latest_metrics: std::sync::Arc::new(std::sync::Mutex::new(Mutex::new(tokio::sync::Mutex::new(Vec::new())),
            history: std::sync::Arc::new(std::sync::Mutex::new(Mutex::new(tokio::sync::Mutex::new(Vec::new())),
        }
    }
