...
pub struct ModelManager {
    /// Models cache
    models: Arc<RwLock<HashMap<String, Model, std::collections::HashMap<String, Model, String, Model, std::collections::HashMap<String, Model, std::collections::HashMap<String, Model, String, Model, String, Model, std::collections::HashMap<String, Model, String, Model>>>>,

    /// Model metadata
    metadata: Arc<RwLock<HashMap<String, ModelMetadata, std::collections::HashMap<String, ModelMetadata, String, ModelMetadata, std::collections::HashMap<String, ModelMetadata, std::collections::HashMap<String, ModelMetadata, String, ModelMetadata, String, ModelMetadata, std::collections::HashMap<String, ModelMetadata, String, ModelMetadata>>>>,
}
...
impl ModelManager {
    ...
    pub fn new() -> Self {
        Self {
            ...
            metadata: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new())),
        }
    }
