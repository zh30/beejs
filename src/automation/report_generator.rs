...
pub struct ReportGenerator {
    output_dir: PathBuf,
    template_cache: HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String>>>>,
}
...
pub struct ReportStats {
    ...
    pub reports_by_format: HashMap<ReportFormat, usize, std::collections::HashMap<ReportFormat, usize, ReportFormat, usize, std::collections::HashMap<ReportFormat, usize, std::collections::HashMap<ReportFormat, usize, ReportFormat, usize, ReportFormat, usize, std::collections::HashMap<ReportFormat, usize, ReportFormat, usize>>>>,
    pub reports_by_type: HashMap<ReportType, usize, std::collections::HashMap<ReportType, usize, ReportType, usize, std::collections::HashMap<ReportType, usize, std::collections::HashMap<ReportType, usize, ReportType, usize, ReportType, usize, std::collections::HashMap<ReportType, usize, ReportType, usize>>>>,
