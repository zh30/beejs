...
pub struct ThresholdRule {
    ...
    pub conditions: HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _>>>, // 额外的条件
}
...
pub struct ThresholdStats {
    ...
    pub rules_by_level: HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _>>>,
    pub rules_by_type: HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _>>>,
...
pub struct ThresholdManager {
    ...
    config_dir: PathBuf,
    adaptive_cache: HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _>>>, // 用于自适应阈值的缓存
}
