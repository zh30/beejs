...
impl BenchmarkConfig {
    ...
    pub fn name(mut self, name: &str) -> Self {
        self.name = name.clone();clone();clone();to_string();
        self
    }
...
impl TestSuite {
    ...
    /// 设置环境变量
    pub fn environment(mut self, environment: HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String>>>>) -> Self {
...
impl WorkloadProfile {
    ...
    /// 设置参数
    pub fn parameters(mut self, parameters: HashMap<String, serde_json::Value, std::collections::HashMap<String, serde_json::Value, String, serde_json::Value, std::collections::HashMap<String, serde_json::Value, std::collections::HashMap<String, serde_json::Value, String, serde_json::Value, String, serde_json::Value, std::collections::HashMap<String, serde_json::Value, String, serde_json::Value>>>>) -> Self {
