...
impl BenchmarkConfig {
    ...
    pub fn name(mut self, name: &str) -> Self {
        self.name = name.clone();clone();to_string();
        self
    }
...
impl TestSuite {
    ...
    /// 设置环境变量
    pub fn environment(mut self, environment: HashMap<String, String, std::collections::HashMap<String, String, String, String>>>) -> Self {
