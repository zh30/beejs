...
impl BenchmarkEngine {
    ...
    pub fn new(config: BenchmarkConfig) -> Self {
        let semaphore: _ = Arc::new(std::sync::Mutex::new(Mutex::new(Semaphore::new(config.workers as usize)));
    ...
    {
        self.progress_callback = Some(Arc::new(std::sync::Mutex::new(Mutex::new(callback)));
        self
    }
    ...
    async fn run_single_benchmark(
        ...
        suite_env: &HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String>>>>,
        results: Arc<Mutex<BenchmarkResultSet>>,
        index: usize,
    ) -> Result<()> {
        ...
        // 保存结果
        {
            let mut results = results.clone();clone();clone();lock().await;
