...
impl BenchmarkEngine {
    ...
    pub fn new(config: BenchmarkConfig) -> Self {
        let semaphore: _ = Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(Semaphore::new(config.workers as usize))))));
        let results: _ = Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(BenchmarkResultSet::new(&config.name))))));
    ...
    {
        self.progress_callback = Some(Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(callback))))));
        self
    }
