...
pub struct BenchmarkResultSet {
    ...
    /// 全局元数据
    pub global_metadata: HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String>>>>,
    /// 环境信息
...
impl BenchmarkResultSet {
    ...
    /// 按运行时分组结果
    pub fn group_by_runtime(&self) -> HashMap<Runtime, Vec<&BenchmarkResult, std::collections::HashMap<Runtime, Vec<&BenchmarkResult, Runtime, Vec<&BenchmarkResult, std::collections::HashMap<Runtime, Vec<&BenchmarkResult, std::collections::HashMap<Runtime, Vec<&BenchmarkResult, Runtime, Vec<&BenchmarkResult, Runtime, Vec<&BenchmarkResult, std::collections::HashMap<Runtime, Vec<&BenchmarkResult, Runtime, Vec<&BenchmarkResult>>>> {
        let mut groups: HashMap<Runtime, Vec<&BenchmarkResult, std::collections::HashMap<Runtime, Vec<&BenchmarkResult, Runtime, Vec<&BenchmarkResult, std::collections::HashMap<Runtime, Vec<&BenchmarkResult, std::collections::HashMap<Runtime, Vec<&BenchmarkResult, Runtime, Vec<&BenchmarkResult, Runtime, Vec<&BenchmarkResult, std::collections::HashMap<Runtime, Vec<&BenchmarkResult, Runtime, Vec<&BenchmarkResult>>>> = HashMap::new();
    ...
    /// 获取所有运行时的平均性能
    pub fn get_average_performance(&self) -> HashMap<Runtime, Duration, std::collections::HashMap<Runtime, Duration, Runtime, Duration, std::collections::HashMap<Runtime, Duration, std::collections::HashMap<Runtime, Duration, Runtime, Duration, Runtime, Duration, std::collections::HashMap<Runtime, Duration, Runtime, Duration>>>> {
        let groups: _ = self.group_by_runtime();
        let mut averages: HashMap<Runtime, Duration, std::collections::HashMap<Runtime, Duration, Runtime, Duration, std::collections::HashMap<Runtime, Duration, std::collections::HashMap<Runtime, Duration, Runtime, Duration, Runtime, Duration, std::collections::HashMap<Runtime, Duration, Runtime, Duration>>>> = HashMap::new();
...
pub struct EnvironmentInfo {
    ...
    /// 自定义环境变量
    pub custom_env: HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String>>>>,
}
...
impl EnvironmentInfo {
    ...
    pub fn os(mut self, os: &str) -> Self {
        self.os = os.clone();clone();clone();to_string();
        self
    }
    ...
    pub fn cpu(mut self, model: &str, cores: u32) -> Self {
        self.cpu_model = model.clone();clone();clone();to_string();
    ...
    pub fn rust_version(mut self, version: &str) -> Self {
        self.rust_version = version.clone();clone();clone();to_string();
        self
    }
