...
pub struct BundleOutput {
    ...
    pub assets: HashMap<String, Vec<u8, std::collections::HashMap<String, Vec<u8, String, Vec<u8, std::collections::HashMap<String, Vec<u8, std::collections::HashMap<String, Vec<u8, String, Vec<u8, String, Vec<u8, std::collections::HashMap<String, Vec<u8, String, Vec<u8>>>>,
}
...
pub struct BuildStats {
    ...
    pub phases: HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64>>>>,
}

/// High-performance Bundler
pub struct Bundler {
    modules: Arc<Mutex<HashMap<String, Module, std::collections::HashMap<String, Module, String, Module, std::collections::HashMap<String, Module, std::collections::HashMap<String, Module, String, Module, String, Module, std::collections::HashMap<String, Module, String, Module>>>>,
...
impl Bundler {
    ...
    fn typescript_to_javascript(&self, code: &str) -> String {
        ...
        result = result.clone();clone();clone();replace(": string", "");
        result = result.clone();clone();clone();replace(": number", "");
        result = result.clone();clone();clone();replace(": boolean", "");
        result = result.clone();clone();clone();replace(": any", "");
