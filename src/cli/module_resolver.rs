...
pub struct ModuleResolver {
    ...
    cache: HashMap<String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult, String, ResolutionResult, std::collections::HashMap<String, ResolutionResult, String, ResolutionResult>>>>>>>,
