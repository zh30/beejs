...
use std::collections::{HashMap, BTreeMap};
    ...
    async fn test_repl_basic_execution() {
        let runtime: _ = Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(RuntimeLite::new(false))))).expect("Failed to create runtime"));
