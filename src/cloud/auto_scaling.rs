...
impl AutoScaler {
    ...
    pub fn new(
        ...
        Self {
            config,
            strategy,
            current_replicas: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(config.min_replicas)))))),
            metrics_history: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(Vec::new()))))),
            cloud_manager,
