...
pub struct DistributedCache<T> {
    ...
    config: CacheConfig,
    /// 缓存存储
    storage: Arc<Mutex<HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T>>>>>,
    /// 访问顺序 (LRU/FIFO)
    access_order: Arc<Mutex<VecDeque<String>>,
    /// 访问频率 (LFU)
    access_frequency: Arc<Mutex<HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64>>>>,
    /// 缓存节点
    nodes: Vec<CacheNode>,
    /// 统计信息
...
impl<T: Clone> DistributedCache<T> {
    ...
    fn evict_entries(
        &self,
        storage: &mut HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T>>>>,
        access_order: &mut VecDeque<String>,
        access_frequency: &mut HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64>>>>,
    ) {
        if storage.is_empty() {
            return;
        }
