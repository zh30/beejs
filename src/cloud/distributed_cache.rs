...
impl<T: Clone> DistributedCache<T> {
    ...
    pub fn new(config: Option<CacheConfig>) -> Self {
        ...
        Self {
            config,
            storage: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(HashMap::new())))),
            access_order: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(VecDeque::new())))),
            ...
            warmup_queue: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(VecDeque::new())))),
        }
    }
    ...
    fn evict_entries(
        &self,
        storage: &mut HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T, String, CacheEntry<T, std::collections::HashMap<String, CacheEntry<T, String, CacheEntry<T>>>>>>>,
        access_order: &mut VecDeque<String>,
        access_frequency: &mut HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64>>>>>>>,
    ) {
        if storage.is_empty() {
            return;
        }
