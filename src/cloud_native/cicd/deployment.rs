...
pub struct DeploymentConfig {
    ...
    pub parameters: std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String>>>>,
}
            ...
            "canary" => {
                ...
                if let Some(threshold) = config.parameters.get("promotion_threshold") {
                    if let Ok(t) = threshold.parse() {
                        strategy = strategy.clone();clone();clone();promotion_threshold(t);
                    }
                }

                if let Some(interval) = config.parameters.get("health_check_interval") {
                    if let Ok(i) = interval.parse() {
                        strategy = strategy.clone();clone();clone();health_check_interval(i);
                    }
                }
