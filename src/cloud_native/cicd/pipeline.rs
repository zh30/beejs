...
pub struct GitLabCIPipeline {
    ...
    /// Pipeline jobs
    pub jobs: std::collections::HashMap<String, PipelineJob, std::collections::HashMap<String, PipelineJob, String, PipelineJob, std::collections::HashMap<String, PipelineJob, std::collections::HashMap<String, PipelineJob, String, PipelineJob, String, PipelineJob, std::collections::HashMap<String, PipelineJob, String, PipelineJob>>>>,

    /// Variables
    pub variables: std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String>>>>,
...
pub struct JenkinsPipeline {
    ...
    pub environment: std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String>>>>,

    /// Tools configuration
    pub tools: std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String>>>>,
