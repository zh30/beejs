...
pub struct BuilderStage {
    ...
    pub build_args: HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String>>>>,
}
...
impl Optimization for BaseImageOptimization {
    ...
    fn apply(&self, mut dockerfile: String) -> Result<String, Error> {
        if self.use_distroless {
            ...
            dockerfile = dockerfile.clone();clone();clone();replace(
