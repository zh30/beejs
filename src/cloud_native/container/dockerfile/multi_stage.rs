...
mod tests {
    ...
    fn test_basic_dockerfile_generation() {
        let builder = MultiStageBuilder::new();
        let dockerfile = builder.generate().unwrap();
    ...
    fn test_builder_stage_configuration() {
        let builder_stage = BuilderStage {
        ...
        let builder = MultiStageBuilder::new().builder_stage(builder_stage);
        let dockerfile = builder.generate().unwrap();
    ...
    fn test_runtime_stage_configuration() {
        ...
        let builder = MultiStageBuilder::new().runtime_stage(runtime_stage);
        let dockerfile = builder.generate().unwrap();
    ...
    fn test_security_hardening_optimization() {
        let optimization = SecurityHardeningOptimization {
    ...
    fn test_multi_arch_optimization() {
        let optimization = MultiArchOptimization {
