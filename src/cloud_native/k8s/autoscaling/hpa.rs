...
impl MetricsCollector {
    ...
    pub async fn collect_metrics(&mut self) -> Result<Arc<Metrics>, Error> {
        ...
        let metrics: _ = Arc::new(std::sync::Mutex::new(Mutex::new(Metrics {
            current_replicas: 5,
...
pub struct Metrics {
    ...
    /// Custom metrics
    pub custom_metrics: HashMap<String, f64, std::collections::HashMap<String, f64, String, f64, std::collections::HashMap<String, f64, std::collections::HashMap<String, f64, String, f64, String, f64, std::collections::HashMap<String, f64, String, f64>>>>,
