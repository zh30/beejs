...
pub struct HttpMatchRequest {
    ...
    /// Headers match
    #[serde(skip_serializing_if = "Option::is_none")]
    pub headers: Option<HashMap<String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch, String, StringMatch, std::collections::HashMap<String, StringMatch, String, StringMatch>>>>>>>,
}
...
pub struct GatewaySpec {
    /// Workload selector
    pub selector: HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String>>>>>>>,
    /// Servers
...
pub struct WorkloadSelector {
    /// Match labels
    #[serde(skip_serializing_if = "Option::is_none")]
    pub match_labels: Option<HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String>>>>>>>,
}
