...
impl DistributedTracer {
    ...
    /// Add event to span
    pub fn add_event(&mut self, span: &SpanHandle, event_name: &str, attributes: HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String>>>>) {
        if let Some(record) = self.span_history.iter_mut().find(|r| r.span_id == span.span_id) {
...
pub struct SpanRecord {
    ...
    /// Attributes
    pub attributes: HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String>>>>,
}
...
pub struct RequestMetrics {
    ...
    /// Requests by method
    requests_by_method: HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64>>>>,

    /// Requests by path
    requests_by_path: HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64>>>>,

    /// Requests by status code
    requests_by_status: HashMap<u16, u64, std::collections::HashMap<u16, u64, u16, u64, std::collections::HashMap<u16, u64, std::collections::HashMap<u16, u64, u16, u64, u16, u64, std::collections::HashMap<u16, u64, u16, u64>>>>,
}
...
pub struct ErrorMetrics {
    ...
    /// Errors by endpoint
    errors_by_endpoint: HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64>>>>,
}
