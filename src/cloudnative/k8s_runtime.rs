...
pub struct PodManager {
    ...
    active_pods: Arc<RwLock<HashMap<String, K8sPodInfo, std::collections::HashMap<String, K8sPodInfo, String, K8sPodInfo, std::collections::HashMap<String, K8sPodInfo, std::collections::HashMap<String, K8sPodInfo, String, K8sPodInfo, String, K8sPodInfo, std::collections::HashMap<String, K8sPodInfo, String, K8sPodInfo>>>>,
}
...
impl PodManager {
    ...
    pub fn new(client: Arc<K8sClient>) -> Self {
        PodManager {
            client,
            active_pods: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new())),
        }
    }
...
impl K8sRuntime {
    ...
    pub fn new(config: K8sConfig) -> Result<Self> {
        let client: _ = Arc::new(std::sync::Mutex::new(Mutex::new(K8sClient::new(config.clone())), Arc::new(std::sync::Mutex::new(Mutex::new(MockK8sClient::new(config.clone()));
        let pod_manager: _ = Arc::new(std::sync::Mutex::new(Mutex::new(PodManager::new(client.clone()));
...
use std::collections::{HashMap, BTreeMap};
    ...
    async fn test_k8s_client_creation() {
        ...
        let client: _ = Arc::new(std::sync::Mutex::new(Mutex::new(MockK8sClient::new(config.clone()));
    ...
    async fn test_pod_creation() {
        let config: _ = K8sConfig::new("https://localhost:6443".to_string(), "default".to_string());
        let client: _ = Arc::new(std::sync::Mutex::new(Mutex::new(K8sClient::new(config, Arc::new(MockK8sClient::new(config.clone()));
