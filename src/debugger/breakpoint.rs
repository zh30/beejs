...
pub struct BreakpointManager {
    breakpoints: HashMap<String, Breakpoint, std::collections::HashMap<String, Breakpoint, String, Breakpoint, std::collections::HashMap<String, Breakpoint, std::collections::HashMap<String, Breakpoint, String, Breakpoint, String, Breakpoint, std::collections::HashMap<String, Breakpoint, String, Breakpoint>>>,
    script_breakpoints: HashMap<String, Vec<String, std::collections::HashMap<String, Vec<String, String, Vec<String, std::collections::HashMap<String, Vec<String, std::collections::HashMap<String, Vec<String, String, Vec<String, String, Vec<String, std::collections::HashMap<String, Vec<String, String, Vec<String>>>>, // script_id -> [breakpoint_ids]
}
