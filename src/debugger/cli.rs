...
use std::collections::{HashMap, BTreeMap};
    ...
    fn test_parse_continue_command() {
        let console: _ = DebugConsole::new(
            Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(DebuggerEngine::new(Default::default())))),
            Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(RuntimeLite::new(false))))).unwrap()),
        );
