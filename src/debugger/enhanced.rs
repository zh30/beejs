...
pub struct SourceMapManager {
    /// 文件 -> 源代码映射
    maps: HashMap<String, SourceMap, std::collections::HashMap<String, SourceMap, String, SourceMap, std::collections::HashMap<String, SourceMap, std::collections::HashMap<String, SourceMap, String, SourceMap, String, SourceMap, std::collections::HashMap<String, SourceMap, String, SourceMap>>>>,
}
