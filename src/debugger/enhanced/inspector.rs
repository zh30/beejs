...
pub struct HeapSnapshot {
    objects: HashMap<String, HeapObject, std::collections::HashMap<String, HeapObject, String, HeapObject, std::collections::HashMap<String, HeapObject, std::collections::HashMap<String, HeapObject, String, HeapObject, String, HeapObject, std::collections::HashMap<String, HeapObject, String, HeapObject>>>>,
    total_size: usize,
}
...
pub struct ObjectTracer {
    traces: HashMap<String, ObjectTrace, std::collections::HashMap<String, ObjectTrace, String, ObjectTrace, std::collections::HashMap<String, ObjectTrace, std::collections::HashMap<String, ObjectTrace, String, ObjectTrace, String, ObjectTrace, std::collections::HashMap<String, ObjectTrace, String, ObjectTrace>>>>,
}
