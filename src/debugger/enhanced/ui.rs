...
pub struct BreakpointManager {
    next_id: u32,
    breakpoints: HashMap<u32, Breakpoint, std::collections::HashMap<u32, Breakpoint, u32, Breakpoint, std::collections::HashMap<u32, Breakpoint, std::collections::HashMap<u32, Breakpoint, u32, Breakpoint, u32, Breakpoint, std::collections::HashMap<u32, Breakpoint, u32, Breakpoint>>>>,
}
...
impl BreakpointManager {
    ...
    pub async fn should_break(&self, id: u32, _variables: &HashMap<String, JsValue, std::collections::HashMap<String, JsValue, String, JsValue, std::collections::HashMap<String, JsValue, std::collections::HashMap<String, JsValue, String, JsValue, String, JsValue, std::collections::HashMap<String, JsValue, String, JsValue>>>>) -> Result<bool> {
