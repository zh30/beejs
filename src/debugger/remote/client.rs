...
pub struct ConnectionManager {
    connections: std::collections::HashMap<String, Connection, std::collections::HashMap<String, Connection, String, Connection, std::collections::HashMap<String, Connection, std::collections::HashMap<String, Connection, String, Connection, String, Connection, std::collections::HashMap<String, Connection, String, Connection>>>>,
}
