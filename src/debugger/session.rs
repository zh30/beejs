...
impl DebugSession {
    ...
    pub fn new(
        ...
        let debugger: _ = Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(DebuggerEngine::new(config))))));
        let event_listener: _ = Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(SimpleEventListener::new())))));
    ...
    async fn start_interactive_cli(&mut self) -> Result<()> {
        ...
        let mut console = DebugConsole::new(
            ...
            Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(self.runtime.clone()))))),
        );
