...
impl ClusterConsole {
    ...
    pub fn new(
        ...
        Self {
            ...
            health_monitor,
            fault_detector,
            cluster_overview: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(None))),
            node_status: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new())),
            performance_metrics: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(None))),
            alerts: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(Vec::new())),
            trace_analysis: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(None))),
        }
    }
