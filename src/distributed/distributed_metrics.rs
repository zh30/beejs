...
pub struct RealTimeMetrics {
    ...
    pub node_metrics: HashMap<String, NodeMetrics, std::collections::HashMap<String, NodeMetrics, String, NodeMetrics, std::collections::HashMap<String, NodeMetrics, std::collections::HashMap<String, NodeMetrics, String, NodeMetrics, String, NodeMetrics, std::collections::HashMap<String, NodeMetrics, String, NodeMetrics>>>>,
...
impl DistributedMetrics {
    ...
    pub fn new(
        ...
        Self {
            ...
            task_executor,
            task_scheduler,
            metric_points: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(Vec::new())),
            real_time_metrics: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(None))),
            historical_stats: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new())),
        }
    }
