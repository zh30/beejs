...
impl DistributedMetrics {
    ...
    pub fn new(
        ...
        Self {
            ...
            task_executor,
            task_scheduler,
            metric_points: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(Vec::new()))))),
            real_time_metrics: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(None)))))),
            historical_stats: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new()))))),
        }
    }
