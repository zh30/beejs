...
impl DistributedTracer {
    ...
    pub fn new(
        ...
        Self {
            ...
            node_manager,
            task_executor,
            active_traces: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new()))))),
            completed_traces: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new()))))),
            performance_stats: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(initial_stats)))))),
        }
    }
