...
impl DistributedTracer {
    ...
    pub fn new(
        ...
        Self {
            ...
            node_manager,
            task_executor,
            active_traces: Arc::new(std::sync::Mutex::new(RwLock::new(HashMap::new()))),
            completed_traces: Arc::new(std::sync::Mutex::new(RwLock::new(HashMap::new()))),
            performance_stats: Arc::new(std::sync::Mutex::new(RwLock::new(initial_stats))),
        }
    }
