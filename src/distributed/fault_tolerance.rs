...
pub struct RecoveryAction {
    ...
    pub parameters: HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String>>>>,
...
pub struct FaultDetector {
    ...
    active_faults: Arc<RwLock<HashMap<String, FaultEvent, std::collections::HashMap<String, FaultEvent, String, FaultEvent, std::collections::HashMap<String, FaultEvent, std::collections::HashMap<String, FaultEvent, String, FaultEvent, String, FaultEvent, std::collections::HashMap<String, FaultEvent, String, FaultEvent>>>>,
    fault_history: Arc<RwLock<Vec<FaultEvent>>,
    recovery_actions: Arc<RwLock<HashMap<String, RecoveryAction, std::collections::HashMap<String, RecoveryAction, String, RecoveryAction, std::collections::HashMap<String, RecoveryAction, std::collections::HashMap<String, RecoveryAction, String, RecoveryAction, String, RecoveryAction, std::collections::HashMap<String, RecoveryAction, String, RecoveryAction>>>>,
}
...
impl FaultDetector {
    ...
    pub fn new(
        ...
        let detector: _ = Self {
            ...
            node_manager,
            task_scheduler,
            active_faults: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new())),
            fault_history: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(Vec::new())),
            recovery_actions: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new())),
        };
...
pub struct FaultStatistics {
    ...
    pub fault_type_counts: HashMap<FaultType, usize, std::collections::HashMap<FaultType, usize, FaultType, usize, std::collections::HashMap<FaultType, usize, std::collections::HashMap<FaultType, usize, FaultType, usize, FaultType, usize, std::collections::HashMap<FaultType, usize, FaultType, usize>>>>,
...
use std::collections::{HashMap, BTreeMap};
    ...
    async fn test_fault_detection() {
        ...
        let node_manager: _ = Arc::new(std::sync::Mutex::new(Mutex::new(NodeManager::new(service_discovery.clone()));
        let _health_monitor: _ = Arc::new(std::sync::Mutex::new(Mutex::new(HealthMonitor::new(node_manager.clone()));
