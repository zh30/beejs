...
impl FaultDetector {
    ...
    pub fn new(
        ...
        let detector: _ = Self {
            ...
            node_manager,
            task_scheduler,
            active_faults: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new()))))),
            fault_history: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(Vec::new()))))),
            recovery_actions: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new()))))),
        };
...
use std::collections::{HashMap, BTreeMap};
    ...
    async fn test_fault_detection() {
        ...
        let _health_monitor: _ = Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(HealthMonitor::new(node_manager.clone())))));
