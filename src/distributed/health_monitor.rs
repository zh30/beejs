...
impl HealthMonitor {
    ...
    pub fn new(node_manager: Arc<NodeManager>) -> Self {
        ...
        let monitor: _ = Self {
            node_manager,
            config,
            health_history: Arc::new(Mutex::new(RwLock::new(HashMap::new())),
            failure_counts: Arc::new(Mutex::new(RwLock::new(HashMap::new())),
            recovery_counts: Arc::new(Mutex::new(RwLock::new(HashMap::new())),
            metrics: Arc::new(Mutex::new(RwLock::new(MonitorMetrics {
                total_checks: 0,
                healthy_checks: 0,
                degraded_checks: 0,
                unhealthy_checks: 0,
