...
pub struct HealthMonitor {
    ...
    health_history: Arc<RwLock<HashMap<String, Vec<HealthCheckResult, std::collections::HashMap<String, Vec<HealthCheckResult, String, Vec<HealthCheckResult, std::collections::HashMap<String, Vec<HealthCheckResult, std::collections::HashMap<String, Vec<HealthCheckResult, String, Vec<HealthCheckResult, String, Vec<HealthCheckResult, std::collections::HashMap<String, Vec<HealthCheckResult, String, Vec<HealthCheckResult>>>>>,
    failure_counts: Arc<RwLock<HashMap<String, u32, std::collections::HashMap<String, u32, String, u32, std::collections::HashMap<String, u32, std::collections::HashMap<String, u32, String, u32, String, u32, std::collections::HashMap<String, u32, String, u32>>>>,
    recovery_counts: Arc<RwLock<HashMap<String, u32, std::collections::HashMap<String, u32, String, u32, std::collections::HashMap<String, u32, std::collections::HashMap<String, u32, String, u32, String, u32, std::collections::HashMap<String, u32, String, u32>>>>,
...
impl HealthMonitor {
    ...
    pub fn new(node_manager: Arc<NodeManager>) -> Self {
        ...
        let monitor: _ = Self {
            node_manager,
            config,
            health_history: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new())),
            failure_counts: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new())),
            recovery_counts: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new())),
            metrics: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(MonitorMetrics {
                total_checks: 0,
                healthy_checks: 0,
                degraded_checks: 0,
                unhealthy_checks: 0,
