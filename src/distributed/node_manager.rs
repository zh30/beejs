...
pub struct ClusterTopology {
    pub regions: HashMap<String, RegionInfo, std::collections::HashMap<String, RegionInfo, String, RegionInfo, std::collections::HashMap<String, RegionInfo, std::collections::HashMap<String, RegionInfo, String, RegionInfo, String, RegionInfo, std::collections::HashMap<String, RegionInfo, String, RegionInfo>>>>,
...
pub struct NodeManager {
    ...
    nodes: Arc<RwLock<HashMap<String, NodeMetadata, std::collections::HashMap<String, NodeMetadata, String, NodeMetadata, std::collections::HashMap<String, NodeMetadata, std::collections::HashMap<String, NodeMetadata, String, NodeMetadata, String, NodeMetadata, std::collections::HashMap<String, NodeMetadata, String, NodeMetadata>>>>,
    node_loads: Arc<RwLock<HashMap<String, NodeLoad, std::collections::HashMap<String, NodeLoad, String, NodeLoad, std::collections::HashMap<String, NodeLoad, std::collections::HashMap<String, NodeLoad, String, NodeLoad, String, NodeLoad, std::collections::HashMap<String, NodeLoad, String, NodeLoad>>>>,
}
...
impl NodeManager {
    ...
    pub fn new(service_discovery: ServiceDiscovery) -> Self {
        let manager: _ = Self {
            ...
            node_loads: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new())),
        };
