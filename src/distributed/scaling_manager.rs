...
impl ScalingManager {
    ...
    pub fn new(config: ScalingConfig) -> Self {
        ...
        Self {
            ...
            stats: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(ScalingStats::default())))),
            is_running: true,
            current_load: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(0.0))))),
            config,
        }
    }
