...
pub struct ScalingManager {
    ...
    nodes: HashMap<String, ScalingNode, std::collections::HashMap<String, ScalingNode, String, ScalingNode, std::collections::HashMap<String, ScalingNode, std::collections::HashMap<String, ScalingNode, String, ScalingNode, String, ScalingNode, std::collections::HashMap<String, ScalingNode, String, ScalingNode>>>>,
