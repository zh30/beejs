...
pub struct FaultHandler {
    ...
    failure_counts: HashMap<String, u32, std::collections::HashMap<String, u32, String, u32, std::collections::HashMap<String, u32, std::collections::HashMap<String, u32, String, u32, String, u32, std::collections::HashMap<String, u32, String, u32>>>>,
    circuit_states: HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool>>>>, // true = open (blocked)
}
...
pub struct ResourceTracker {
    ...
    allocations: HashMap<String, ResourceAllocation, std::collections::HashMap<String, ResourceAllocation, String, ResourceAllocation, std::collections::HashMap<String, ResourceAllocation, std::collections::HashMap<String, ResourceAllocation, String, ResourceAllocation, String, ResourceAllocation, std::collections::HashMap<String, ResourceAllocation, String, ResourceAllocation>>>>,
}
...
pub struct CheckpointManager {
    interval: Duration,
    checkpoints: HashMap<String, Checkpoint, std::collections::HashMap<String, Checkpoint, String, Checkpoint, std::collections::HashMap<String, Checkpoint, std::collections::HashMap<String, Checkpoint, String, Checkpoint, String, Checkpoint, std::collections::HashMap<String, Checkpoint, String, Checkpoint>>>>,
}
...
pub struct RecoveryManager {
    ...
    failure_history: HashMap<String, Vec<String, std::collections::HashMap<String, Vec<String, String, Vec<String, std::collections::HashMap<String, Vec<String, std::collections::HashMap<String, Vec<String, String, Vec<String, String, Vec<String, std::collections::HashMap<String, Vec<String, String, Vec<String>>>>,
}
