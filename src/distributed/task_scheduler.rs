...
pub struct TaskScheduler {
    ...
    running_tasks: HashMap<String, Task, std::collections::HashMap<String, Task, String, Task, std::collections::HashMap<String, Task, std::collections::HashMap<String, Task, String, Task, String, Task, std::collections::HashMap<String, Task, String, Task>>>>,
    completed_tasks: HashMap<String, TaskResult, std::collections::HashMap<String, TaskResult, String, TaskResult, std::collections::HashMap<String, TaskResult, std::collections::HashMap<String, TaskResult, String, TaskResult, String, TaskResult, std::collections::HashMap<String, TaskResult, String, TaskResult>>>>,
    failed_tasks: HashMap<String, Task, std::collections::HashMap<String, Task, String, Task, std::collections::HashMap<String, Task, std::collections::HashMap<String, Task, String, Task, String, Task, std::collections::HashMap<String, Task, String, Task>>>>,
...
pub struct ResultAggregator {
    ...
    batches: HashMap<String, BatchResults, std::collections::HashMap<String, BatchResults, String, BatchResults, std::collections::HashMap<String, BatchResults, std::collections::HashMap<String, BatchResults, String, BatchResults, String, BatchResults, std::collections::HashMap<String, BatchResults, String, BatchResults>>>>,
}
