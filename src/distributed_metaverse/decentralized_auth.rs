...
pub struct DecentralizedAuth {
    ...
    config: AuthConfig,
    /// 身份缓存
    identities: HashMap<String, Identity, std::collections::HashMap<String, Identity, String, Identity, std::collections::HashMap<String, Identity, std::collections::HashMap<String, Identity, String, Identity, String, Identity, std::collections::HashMap<String, Identity, String, Identity>>>>,
    /// 凭证缓存
