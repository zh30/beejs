...
pub struct MetaverseNetwork {
    ...
    /// 节点映射
    nodes: HashMap<String, NetworkNode, std::collections::HashMap<String, NetworkNode, String, NetworkNode, std::collections::HashMap<String, NetworkNode, std::collections::HashMap<String, NetworkNode, String, NetworkNode, String, NetworkNode, std::collections::HashMap<String, NetworkNode, String, NetworkNode>>>>,
    /// 是否运行中
    running: bool,
}
