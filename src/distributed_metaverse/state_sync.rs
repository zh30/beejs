...
pub struct StateSync {
    ...
    config: SyncConfig,
    /// 本地状态
    state: HashMap<String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange, String, StateChange, std::collections::HashMap<String, StateChange, String, StateChange>>>>>>>,
    /// 版本计数器
    version_counter: u64,
}
