...
impl AnalyticsCollector {
    ...
    pub fn new(max_events: usize) -> Self {
        Self {
            events: Arc::new(std::sync::Mutex::new(RwLock::new(VecDeque::with_capacity(max_events)))),
            benchmarks: Arc::new(std::sync::Mutex::new(RwLock::new(HashMap::new()))),
            aggregator: Arc::new(std::sync::Mutex::new(DataAggregator::new())),
            max_events,
        }
    }
...
impl DataAggregator {
    pub fn new() -> Self {
        Self {
            event_counts: Arc::new(std::sync::Mutex::new(RwLock::new(HashMap::new()))),
            module_usage: Arc::new(std::sync::Mutex::new(RwLock::new(HashMap::new()))),
        }
    }
