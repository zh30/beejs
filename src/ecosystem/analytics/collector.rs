...
pub struct AnalyticsReport {
    ...
    pub event_counts: HashMap<EventType, u64, std::collections::HashMap<EventType, u64, EventType, u64, std::collections::HashMap<EventType, u64, std::collections::HashMap<EventType, u64, EventType, u64, EventType, u64, std::collections::HashMap<EventType, u64, EventType, u64>>>>,
...
pub struct AnalyticsCollector {
    ...
    benchmarks: Arc<RwLock<HashMap<String, Vec<BenchmarkResult, std::collections::HashMap<String, Vec<BenchmarkResult, String, Vec<BenchmarkResult, std::collections::HashMap<String, Vec<BenchmarkResult, std::collections::HashMap<String, Vec<BenchmarkResult, String, Vec<BenchmarkResult, String, Vec<BenchmarkResult, std::collections::HashMap<String, Vec<BenchmarkResult, String, Vec<BenchmarkResult>>>>>,
...
pub struct DataAggregator {
    event_counts: Arc<RwLock<HashMap<EventType, u64, std::collections::HashMap<EventType, u64, EventType, u64, std::collections::HashMap<EventType, u64, std::collections::HashMap<EventType, u64, EventType, u64, EventType, u64, std::collections::HashMap<EventType, u64, EventType, u64>>>>,
    module_usage: Arc<RwLock<HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64>>>>,
}
...
impl AnalyticsCollector {
    ...
    pub fn new(max_events: usize) -> Self {
        Self {
            events: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(VecDeque::with_capacity(max_events))),
            benchmarks: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new())),
            aggregator: Arc::new(std::sync::Mutex::new(Mutex::new(DataAggregator::new())),
            max_events,
        }
    }
    ...
    async fn calculate_trends(&self, timeframe: &TimeFrame) -> Result<Vec<TrendData>, Box<dyn std::error::Error>> {
        let events: _ = self.events.read().await;
        let mut daily_counts: HashMap<DateTime<Utc, std::collections::HashMap<DateTime<Utc, DateTime<Utc, std::collections::HashMap<DateTime<Utc, std::collections::HashMap<DateTime<Utc, DateTime<Utc, DateTime<Utc, std::collections::HashMap<DateTime<Utc, DateTime<Utc, std::collections::HashMap<DateTime<Utc, std::collections::HashMap<DateTime<Utc, DateTime<Utc, std::collections::HashMap<DateTime<Utc, std::collections::HashMap<DateTime<Utc, DateTime<Utc, DateTime<Utc, std::collections::HashMap<DateTime<Utc, DateTime<Utc, DateTime<Utc, std::collections::HashMap<DateTime<Utc, DateTime<Utc, std::collections::HashMap<DateTime<Utc, std::collections::HashMap<DateTime<Utc, DateTime<Utc, DateTime<Utc, std::collections::HashMap<DateTime<Utc, DateTime<Utc>>>>, u64> = HashMap::new();
    ...
    async fn calculate_performance_metrics(&self) -> Result<PerformanceMetrics, Box<dyn std::error::Error>> {
        ...
        // 找出最慢和最快的模块
        let mut module_times: HashMap<String, std::time::Duration, std::collections::HashMap<String, std::time::Duration, String, std::time::Duration, std::collections::HashMap<String, std::time::Duration, std::collections::HashMap<String, std::time::Duration, String, std::time::Duration, String, std::time::Duration, std::collections::HashMap<String, std::time::Duration, String, std::time::Duration>>>> = HashMap::new();
...
pub struct CollectorStats {
    pub total_events: u64,
    pub event_type_counts: HashMap<EventType, u64, std::collections::HashMap<EventType, u64, EventType, u64, std::collections::HashMap<EventType, u64, std::collections::HashMap<EventType, u64, EventType, u64, EventType, u64, std::collections::HashMap<EventType, u64, EventType, u64>>>>,
    pub total_benchmarks: u64,
...
impl DataAggregator {
    pub fn new() -> Self {
        Self {
            event_counts: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new())),
            module_usage: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new())),
        }
    }
