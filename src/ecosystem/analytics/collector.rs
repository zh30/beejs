...
impl AnalyticsCollector {
    ...
    pub fn new(max_events: usize) -> Self {
        Self {
            events: Arc::new(Mutex::new(RwLock::new(VecDeque::with_capacity(max_events))),
            benchmarks: Arc::new(Mutex::new(RwLock::new(HashMap::new())),
...
impl DataAggregator {
    pub fn new() -> Self {
        Self {
            event_counts: Arc::new(Mutex::new(RwLock::new(HashMap::new())),
            module_usage: Arc::new(Mutex::new(RwLock::new(HashMap::new())),
        }
    }
