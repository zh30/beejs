...
impl CommunityPortal {
    ...
    pub fn new() -> Self {
        Self {
            ...
            auth: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(AuthManager::new()))))),
            ratings: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new()))))),
            trending: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(Vec::new()))))),
        }
    }
...
impl ModuleRegistry {
    pub fn new() -> Self {
        Self {
            modules: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new()))))),
        }
    }
...
impl AuthManager {
    pub fn new() -> Self {
        Self {
            users: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new()))))),
            sessions: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new()))))),
        }
    }
