...
pub struct ModuleRegistry {
    modules: Arc<RwLock<HashMap<String, ModuleInfo, std::collections::HashMap<String, ModuleInfo, String, ModuleInfo, std::collections::HashMap<String, ModuleInfo, std::collections::HashMap<String, ModuleInfo, String, ModuleInfo, String, ModuleInfo, std::collections::HashMap<String, ModuleInfo, String, ModuleInfo>>>>,
}
...
pub struct AuthManager {
    users: Arc<RwLock<HashMap<String, UserId, std::collections::HashMap<String, UserId, String, UserId, std::collections::HashMap<String, UserId, std::collections::HashMap<String, UserId, String, UserId, String, UserId, std::collections::HashMap<String, UserId, String, UserId>>>>,
    sessions: Arc<RwLock<HashMap<String, Session, std::collections::HashMap<String, Session, String, Session, std::collections::HashMap<String, Session, std::collections::HashMap<String, Session, String, Session, String, Session, std::collections::HashMap<String, Session, String, Session>>>>,
}
...
impl CommunityPortal {
    ...
    pub fn new() -> Self {
        Self {
            registry: Arc::new(std::sync::Mutex::new(Mutex::new(ModuleRegistry::new())),
            auth: Arc::new(std::sync::Mutex::new(Mutex::new(AuthManager::new())),
            ratings: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new())),
            trending: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(Vec::new())),
        }
    }
...
pub struct ModuleRatingSummary {
    ...
    pub rating_distribution: HashMap<u8, usize, std::collections::HashMap<u8, usize, u8, usize, std::collections::HashMap<u8, usize, std::collections::HashMap<u8, usize, u8, usize, u8, usize, std::collections::HashMap<u8, usize, u8, usize>>>>,
}
...
impl ModuleRegistry {
    pub fn new() -> Self {
        Self {
            modules: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new())),
        }
    }
...
impl AuthManager {
    pub fn new() -> Self {
        Self {
            ...
            sessions: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new())),
        }
    }
