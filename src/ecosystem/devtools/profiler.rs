...
impl Profiler {
    ...
    pub fn new() -> Self {
        Self {
            sampler: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(CallGraphSampler::new())))),
            call_graph_analyzer: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(CallGraphAnalyzer::new())))),
        }
    }
...
impl CallGraphAnalyzer {
    ...
    pub fn analyze_samples(&self, samples: &[CallSample]) -> Result<CallGraph, Box<dyn std::error::Error + Send + Sync>> {
        let mut call_tree: HashMap<String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode, String, CallNode, std::collections::HashMap<String, CallNode, String, CallNode>>>>>>> = HashMap::new();
...
impl CallGraphSampler {
    ...
    fn record_call_start(
        ...
        CallHandle {
            sampler: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(self.clone())))),
