...
impl Profiler {
    ...
    pub fn new() -> Self {
        Self {
            sampler: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(CallGraphSampler::new()))))),
            call_graph_analyzer: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(CallGraphAnalyzer::new()))))),
        }
    }
...
impl CallGraphSampler {
    ...
    fn record_call_start(
        ...
        CallHandle {
            sampler: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(self.clone()))))),
