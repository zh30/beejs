...
pub struct ComponentInfo {
    pub name: String,
    pub path: String,
    pub props: HashMap<String, PropInfo, std::collections::HashMap<String, PropInfo, String, PropInfo, std::collections::HashMap<String, PropInfo, std::collections::HashMap<String, PropInfo, String, PropInfo, String, PropInfo, std::collections::HashMap<String, PropInfo, String, PropInfo>>>>,
