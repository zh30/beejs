...
impl SsrRenderer {
    ...
    pub async fn prerender_static_pages(
        ...
        framework_type: FrameworkType,
        components: &[serde_json::Value],
    ) -> Result<HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String>>>>, Box<dyn std::error::Error>> {
...
pub struct SsrRequest {
    ...
    pub query_params: HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String>>>>,
...
impl CacheManager {
    ...
    pub fn new() -> Self {
        Self {
            cache: Arc::new(std::sync::Mutex::new(Mutex::new(tokio::sync::Mutex::new(HashMap::new())),
