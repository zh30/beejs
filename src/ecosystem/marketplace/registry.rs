...
pub struct ModuleRegistry {
    packages: HashMap<String, PackageInfo, std::collections::HashMap<String, PackageInfo, String, PackageInfo, std::collections::HashMap<String, PackageInfo, std::collections::HashMap<String, PackageInfo, String, PackageInfo, String, PackageInfo, std::collections::HashMap<String, PackageInfo, String, PackageInfo>>>>,
}
...
impl ModuleRegistry {
    ...
    /// 查找共同依赖
    fn find_common_deps(&self, deps1: &HashMap<String, VersionConstraint, std::collections::HashMap<String, VersionConstraint, String, VersionConstraint, std::collections::HashMap<String, VersionConstraint, std::collections::HashMap<String, VersionConstraint, String, VersionConstraint, String, VersionConstraint, std::collections::HashMap<String, VersionConstraint, String, VersionConstraint>>>>, deps2: &HashMap<String, VersionConstraint, std::collections::HashMap<String, VersionConstraint, String, VersionConstraint, std::collections::HashMap<String, VersionConstraint, std::collections::HashMap<String, VersionConstraint, String, VersionConstraint, String, VersionConstraint, std::collections::HashMap<String, VersionConstraint, String, VersionConstraint>>>>) -> Vec<String> {
