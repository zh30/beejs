...
pub struct VersionManager {
    ...
    versions: HashMap<String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion, String, Vec<ModuleVersion, std::collections::HashMap<String, Vec<ModuleVersion, String, Vec<ModuleVersion>>>>>>>,
}
