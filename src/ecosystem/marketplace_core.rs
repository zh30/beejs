...
pub struct PluginIndex {
    ...
    /// 标签索引
    tag_index: BTreeMap<String, HashSet<PluginId, String, HashSet<PluginId, String, HashSet<PluginId, String, HashSet<PluginId, String, HashSet<PluginId, String, HashSet<PluginId, String, HashSet<PluginId, String, HashSet<PluginId>>,
    /// 作者索引
    author_index: BTreeMap<String, HashSet<PluginId, String, HashSet<PluginId, String, HashSet<PluginId, String, HashSet<PluginId, String, HashSet<PluginId, String, HashSet<PluginId, String, HashSet<PluginId, String, HashSet<PluginId>>,
    /// 分类索引
    category_index: BTreeMap<String, HashSet<PluginId, String, HashSet<PluginId, String, HashSet<PluginId, String, HashSet<PluginId, String, HashSet<PluginId, String, HashSet<PluginId, String, HashSet<PluginId, String, HashSet<PluginId>>,
}
...
impl PluginMarketplace {
    ...
    pub fn new() -> Self {
        Self {
            plugin_index: Arc::new(std::sync::Mutex::new(Mutex::new(PluginIndex::new())),
            search_engine: Arc::new(std::sync::Mutex::new(Mutex::new(SearchEngine::new())),
            rating_system: Arc::new(std::sync::Mutex::new(Mutex::new(RatingSystem::new())),
            review_system: Arc::new(std::sync::Mutex::new(Mutex::new(ReviewSystem::new())),
            cache: Arc::new(std::sync::Mutex::new(Mutex::new(MarketplaceCache::new())),
        }
    }
...
impl SearchEngine {
    pub fn new() -> Self {
        Self {
            search_index: Arc::new(std::sync::Mutex::new(Mutex::new(SearchIndex::new())),
            ranking_algorithm: Arc::new(std::sync::Mutex::new(Mutex::new(RankingAlgorithm::new())),
        }
    }
...
impl RatingSystem {
    pub fn new() -> Self {
        Self {
            ratings: Arc::new(std::sync::Mutex::new(Mutex::new(RatingStorage::new())),
            stats_calculator: Arc::new(std::sync::Mutex::new(Mutex::new(RatingStatsCalculator))),
        }
    }
...
impl ReviewSystem {
    pub fn new() -> Self {
        Self {
            review_queue: Arc::new(std::sync::Mutex::new(Mutex::new(ReviewQueue::new())),
            auto_reviewer: Arc::new(std::sync::Mutex::new(Mutex::new(AutoReviewer::new())),
        }
    }
}
...
impl AutoReviewer {
    pub fn new() -> Self {
        Self {
            security_scanner: Arc::new(std::sync::Mutex::new(Mutex::new(SecurityScanner))),
            quality_analyzer: Arc::new(std::sync::Mutex::new(Mutex::new(QualityAnalyzer))),
        }
    }
}
