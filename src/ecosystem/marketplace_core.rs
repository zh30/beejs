...
pub struct PluginIndex {
    ...
    /// 标签索引
    tag_index: BTreeMap<String, HashSet<PluginId, String, HashSet<PluginId, String, HashSet<PluginId, String, HashSet<PluginId>>,
    /// 作者索引
    author_index: BTreeMap<String, HashSet<PluginId, String, HashSet<PluginId, String, HashSet<PluginId, String, HashSet<PluginId>>,
    /// 分类索引
    category_index: BTreeMap<String, HashSet<PluginId, String, HashSet<PluginId, String, HashSet<PluginId, String, HashSet<PluginId>>,
}
