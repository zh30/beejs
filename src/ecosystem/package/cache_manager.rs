...
impl CacheManager {
    ...
    pub fn new() -> Self {
        Self {
            ...
            l2: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(L2DiskCache::new())),
            l3: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(L3DistributedCache::new())),
        }
    }
...
struct L1MemoryCache {
    cache: HashMap<String, Vec<u8, std::collections::HashMap<String, Vec<u8, String, Vec<u8, std::collections::HashMap<String, Vec<u8, std::collections::HashMap<String, Vec<u8, String, Vec<u8, String, Vec<u8, std::collections::HashMap<String, Vec<u8, String, Vec<u8>>>>,
}
