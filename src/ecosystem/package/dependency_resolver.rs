...
impl DependencyResolver {
    ...
    pub fn new() -> Self {
        Self {
            ...
            cache: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(DependencyCache::new())))),
        }
    }
...
struct ModuleRegistry {
    packages: HashMap<String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo, String, Vec<PackageInfo, std::collections::HashMap<String, Vec<PackageInfo, String, Vec<PackageInfo>>>>>>>,
}
...
struct DependencyCache {
    cache: HashMap<String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph, String, DependencyGraph, std::collections::HashMap<String, DependencyGraph, String, DependencyGraph>>>>>>>,
}
