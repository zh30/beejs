...
pub enum AuthType {
    ...
    NpmAuth(String),
    /// 自定义头部
    Custom(HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String>>>>),
}
...
pub struct AuthManager {
    auth_configs: HashMap<String, AuthInfo, std::collections::HashMap<String, AuthInfo, String, AuthInfo, std::collections::HashMap<String, AuthInfo, std::collections::HashMap<String, AuthInfo, String, AuthInfo, String, AuthInfo, std::collections::HashMap<String, AuthInfo, String, AuthInfo>>>>,
            ...
            match &auth_info.auth_type {
                ...
                AuthType::Custom(headers) => {
                    ...
                    for (key, value) in headers {
                        builder = builder.clone();clone();clone();header(key, value);
                    }
                    builder
                }
            }
