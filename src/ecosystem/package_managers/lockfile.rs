...
pub struct LockfileManager {
    ...
    entries: HashMap<String, LockfileEntry, std::collections::HashMap<String, LockfileEntry, String, LockfileEntry, std::collections::HashMap<String, LockfileEntry, std::collections::HashMap<String, LockfileEntry, String, LockfileEntry, String, LockfileEntry, std::collections::HashMap<String, LockfileEntry, String, LockfileEntry>>>>,
}
...
impl LockfileManager {
    ...
    /// 获取所有条目
    pub fn get_entries(&self) -> &HashMap<String, LockfileEntry, std::collections::HashMap<String, LockfileEntry, String, LockfileEntry, std::collections::HashMap<String, LockfileEntry, std::collections::HashMap<String, LockfileEntry, String, LockfileEntry, String, LockfileEntry, std::collections::HashMap<String, LockfileEntry, String, LockfileEntry>>>> {
        &self.entries
    }
