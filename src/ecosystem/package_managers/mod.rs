...
pub struct PackageResolution {
    ...
    pub bins: HashMap<String, PathBuf, std::collections::HashMap<String, PathBuf, String, PathBuf, std::collections::HashMap<String, PathBuf, std::collections::HashMap<String, PathBuf, String, PathBuf, String, PathBuf, std::collections::HashMap<String, PathBuf, String, PathBuf>>>>,
    pub main: String,
