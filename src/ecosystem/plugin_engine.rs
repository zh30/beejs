...
impl PluginSandbox {
    ...
    pub fn new(permissions: PermissionSet) -> Self {
        Self {
            permissions: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(permissions)))))),
...
impl PluginRegistry {
    ...
    pub fn new() -> Self {
        Self {
            plugins: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new()))))),
        }
    }
...
impl PluginEngine {
    ...
    pub fn new() -> Self {
        Self {
            ...
            registry: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(PluginRegistry::new()))))),
            loader: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(PluginLoader::new()))))),
            api: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(PluginAPI::new()))))),
    ...
    pub async fn load_plugin(&self, metadata: &PluginMetadata) -> Result<PluginHandle, PluginError> {
        ...
        // 创建实例
        let status: _ = Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(std::sync::RwLock::new(PluginStatus::Loaded))))));
