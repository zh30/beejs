...
pub struct SymbolResolver {
    symbol_table: HashMap<String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo, String, SymbolInfo, std::collections::HashMap<String, SymbolInfo, String, SymbolInfo>>>>>>>,
