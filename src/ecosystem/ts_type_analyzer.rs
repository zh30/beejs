...
impl TypeAnalyzer {
    ...
    /// 从 AST 提取类型
    pub fn extract_types_from_ast(&self, ast: &AstNode, filename: &str) -> Result<HashMap<String, TypeDefinition, std::collections::HashMap<String, TypeDefinition, String, TypeDefinition, std::collections::HashMap<String, TypeDefinition, std::collections::HashMap<String, TypeDefinition, String, TypeDefinition, String, TypeDefinition, std::collections::HashMap<String, TypeDefinition, String, TypeDefinition>>>>, Box<dyn std::error::Error>> {
        let mut types = HashMap::new();
    ...
    /// 分析 AST 节点
    fn analyze_ast(&self, node: &AstNode, types: &mut HashMap<String, TypeDefinition, std::collections::HashMap<String, TypeDefinition, String, TypeDefinition, std::collections::HashMap<String, TypeDefinition, std::collections::HashMap<String, TypeDefinition, String, TypeDefinition, String, TypeDefinition, std::collections::HashMap<String, TypeDefinition, String, TypeDefinition>>>>) -> Result<(), Box<dyn std::error::Error>> {
        match node {
    ...
    /// 从 JSDoc 提取类型
    pub fn extract_jsdoc_types(&self, source: &str) -> Result<HashMap<String, TypeDefinition, std::collections::HashMap<String, TypeDefinition, String, TypeDefinition, std::collections::HashMap<String, TypeDefinition, std::collections::HashMap<String, TypeDefinition, String, TypeDefinition, String, TypeDefinition, std::collections::HashMap<String, TypeDefinition, String, TypeDefinition>>>>, Box<dyn std::error::Error>> {
        let mut types = HashMap::new();
        let mut lines = source.lines().peekable();
    ...
    /// 从 JSDoc 提取类型
    fn extract_type_from_jsdoc(&self, comment: &str, types: &mut HashMap<String, TypeDefinition, std::collections::HashMap<String, TypeDefinition, String, TypeDefinition, std::collections::HashMap<String, TypeDefinition, std::collections::HashMap<String, TypeDefinition, String, TypeDefinition, String, TypeDefinition, std::collections::HashMap<String, TypeDefinition, String, TypeDefinition>>>>) -> Result<(), Box<dyn std::error::Error>> {
        let lines: Vec<&str> = comment.lines().collect();
...
pub struct SourceFile {
    ...
    pub js_doc: HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String>>>>,
}
