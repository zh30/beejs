...
impl TypeDefinitionGenerator {
    ...
    /// 从目录生成所有类型定义
    pub async fn generate_types_from_directory(&self, dir: &PathBuf) -> Result<HashMap<PathBuf, String, std::collections::HashMap<PathBuf, String, PathBuf, String, std::collections::HashMap<PathBuf, String, std::collections::HashMap<PathBuf, String, PathBuf, String, PathBuf, String, std::collections::HashMap<PathBuf, String, PathBuf, String>>>>, Box<dyn std::error::Error>> {
...
pub struct TypeInfo {
    ...
    pub info: HashMap<String, TypeDefinition, std::collections::HashMap<String, TypeDefinition, String, TypeDefinition, std::collections::HashMap<String, TypeDefinition, std::collections::HashMap<String, TypeDefinition, String, TypeDefinition, String, TypeDefinition, std::collections::HashMap<String, TypeDefinition, String, TypeDefinition>>>>,
}
...
pub struct TypeDefinition {
    ...
    pub members: HashMap<String, TypeMember, std::collections::HashMap<String, TypeMember, String, TypeMember, std::collections::HashMap<String, TypeMember, std::collections::HashMap<String, TypeMember, String, TypeMember, String, TypeMember, std::collections::HashMap<String, TypeMember, String, TypeMember>>>>,
...
pub enum Type {
    ...
    Object(HashMap<String, Type, std::collections::HashMap<String, Type, String, Type, std::collections::HashMap<String, Type, std::collections::HashMap<String, Type, String, Type, String, Type, std::collections::HashMap<String, Type, String, Type>>>>),
    Function {
        params: Vec<Type>,
...
pub struct ProjectTypeInfo {
    pub files: HashMap<String, FileTypeInfo, std::collections::HashMap<String, FileTypeInfo, String, FileTypeInfo, std::collections::HashMap<String, FileTypeInfo, std::collections::HashMap<String, FileTypeInfo, String, FileTypeInfo, String, FileTypeInfo, std::collections::HashMap<String, FileTypeInfo, String, FileTypeInfo>>>>,
    pub globals: HashMap<String, TypeDefinition, std::collections::HashMap<String, TypeDefinition, String, TypeDefinition, std::collections::HashMap<String, TypeDefinition, std::collections::HashMap<String, TypeDefinition, String, TypeDefinition, String, TypeDefinition, std::collections::HashMap<String, TypeDefinition, String, TypeDefinition>>>>,
    pub modules: HashMap<String, ModuleInfo, std::collections::HashMap<String, ModuleInfo, String, ModuleInfo, std::collections::HashMap<String, ModuleInfo, std::collections::HashMap<String, ModuleInfo, String, ModuleInfo, String, ModuleInfo, std::collections::HashMap<String, ModuleInfo, String, ModuleInfo>>>>,
...
pub struct FileTypeInfo {
    pub path: String,
    pub exports: HashMap<String, TypeDefinition, std::collections::HashMap<String, TypeDefinition, String, TypeDefinition, std::collections::HashMap<String, TypeDefinition, std::collections::HashMap<String, TypeDefinition, String, TypeDefinition, String, TypeDefinition, std::collections::HashMap<String, TypeDefinition, String, TypeDefinition>>>>,
