...
impl EdgeDeploymentOptimizer {
    ...
    pub fn new() -> Self {
        EdgeDeploymentOptimizer {
            deployment_history: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(Vec::new()))))),
            performance_metrics: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(PerformanceMetrics {
