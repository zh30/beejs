...
pub struct DistributedCoordinator {
    ...
    active_proposals: Arc<RwLock<HashMap<String, Proposal, std::collections::HashMap<String, Proposal, String, Proposal, std::collections::HashMap<String, Proposal, std::collections::HashMap<String, Proposal, String, Proposal, String, Proposal, std::collections::HashMap<String, Proposal, String, Proposal>>>>,
}
...
impl DistributedCoordinator {
    ...
    pub async fn new(node_manager: Arc<super::node_manager::EdgeNodeManager>) -> Result<Self> {
        let coordinator: _ = DistributedCoordinator {
            consensus: Arc::new(std::sync::Mutex::new(Mutex::new(ConsensusAlgorithm::new(ConsensusType::SimpleMajority, 3, 5000))),
            node_manager,
            active_proposals: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new())),
        };
