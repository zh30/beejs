...
impl EdgeRuntime {
    ...
    pub fn new() -> Self {
        EdgeRuntime {
            instances: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new()))))),
            warm_regions: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(Vec::new()))))),
            prewarm_pool: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(Vec::new()))))),
            stats: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(RuntimeStats {
                total_cold_starts: 0,
                total_warm_executions: 0,
                average_cold_start_ms: 0.0,
                average_warm_execution_ms: 0.0,
            })))))),
            resource_manager: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(EdgeResourceManager::new(
...
impl EdgeResourceManager {
    ...
    pub fn new(cpu_limit: ResourceQuota, memory_limit: ResourceQuota) -> Self {
        EdgeResourceManager {
            cpu_limit,
            memory_limit,
            battery_monitor: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(BatteryMonitor {
                is_supported: false,
                level_percent: None,
                is_charging: false,
            })))))),
            current_usage: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(ResourceUsage {
