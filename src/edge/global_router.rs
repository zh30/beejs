...
pub struct GlobalRouter {
    ...
    geo_mapping: Arc<RwLock<HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String>>>>, // IP to region mapping
...
impl GlobalRouter {
    ...
    pub fn new() -> Self {
        ...
        GlobalRouter {
            edge_nodes: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(default_nodes))),
            geo_mapping: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new())),
            routing_rules: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(Vec::new())),
        }
    }
    ...
    pub async fn check_node_health(&self) -> Result<HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, std::collections::HashMap<String, bool, std::collections::HashMap<String, bool, String, bool, String, bool, std::collections::HashMap<String, bool, String, bool>>>> {
        let mut nodes = self.edge_nodes.write().await;
