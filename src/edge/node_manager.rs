...
pub struct EdgeNodeManager {
    nodes: Arc<RwLock<HashMap<NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode, NodeId, EdgeNode, std::collections::HashMap<NodeId, EdgeNode, NodeId, EdgeNode>>>>>>>,
...
pub struct EdgeLoadBalancer {
    ...
    metrics: Arc<RwLock<HashMap<NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics, NodeId, NodeMetrics, std::collections::HashMap<NodeId, NodeMetrics, NodeId, NodeMetrics>>>>>>>,
}
...
impl EdgeNodeManager {
    ...
    pub fn new() -> Self {
        EdgeNodeManager {
            ...
            load_balancer: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(EdgeLoadBalancer::new(LoadBalancingStrategy::ResourceBased))))),
            health_checker: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(HealthChecker::new(Duration::from_secs(30))))),
        }
    }
