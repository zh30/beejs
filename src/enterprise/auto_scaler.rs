...
impl AutoScaler {
    ...
    pub fn new(metrics_client: MetricsClient, k8s_client: K8sClient) -> Self {
        Self {
            metrics_client: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(metrics_client)))))),
            k8s_client: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(k8s_client)))))),
