...
impl EnterpriseCodeAnalyzer {
    ...
    pub fn new() -> Self {
        Self {
            metrics_cache: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(MetricsCache::new())))),
            pattern_detector: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(PatternDetector::new())))),
            debt_analyzer: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(DebtAnalyzer::new())))),
        }
    }
