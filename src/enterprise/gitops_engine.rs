...
impl GitOpsEngine {
    ...
    pub fn new(git_client: GitClient, reconciler: ConfigReconciler) -> Self {
        Self {
            git_client: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(git_client)))))),
            reconciler: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(reconciler)))))),
