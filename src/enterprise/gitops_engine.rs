...
pub struct GitOpsEngine {
    ...
    sync_history: BTreeMap<Uuid, SyncResult, Uuid, SyncResult, Uuid, SyncResult, Uuid, SyncResult, Uuid, SyncResult, Uuid, SyncResult, Uuid, SyncResult, Uuid, SyncResult>,
    pending_changes: BTreeMap<Uuid, ConfigChange, Uuid, ConfigChange, Uuid, ConfigChange, Uuid, ConfigChange, Uuid, ConfigChange, Uuid, ConfigChange, Uuid, ConfigChange, Uuid, ConfigChange>,
}
...
impl GitOpsEngine {
    ...
    pub fn new(git_client: GitClient, reconciler: ConfigReconciler) -> Self {
        Self {
            git_client: Arc::new(std::sync::Mutex::new(Mutex::new(git_client))),
            reconciler: Arc::new(std::sync::Mutex::new(Mutex::new(reconciler))),
