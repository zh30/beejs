...
pub struct ObjectMeta {
    ...
    pub labels: Option<std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String>>>>,
}
...
pub struct Operator {
    ...
    /// Active clusters
    clusters: Arc<RwLock<std::collections::HashMap<String, BeejsCluster, std::collections::HashMap<String, BeejsCluster, String, BeejsCluster, std::collections::HashMap<String, BeejsCluster, std::collections::HashMap<String, BeejsCluster, String, BeejsCluster, String, BeejsCluster, std::collections::HashMap<String, BeejsCluster, String, BeejsCluster>>>>,
...
impl Operator {
    ...
    pub fn new(config: OperatorConfig) -> (Self, tokio::sync::mpsc::UnboundedReceiver<OperatorEvent>) {
        ...
        let operator: _ = Operator {
            config,
            clusters: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(std::collections::HashMap::new())),
            event_sender: Arc::new(std::sync::Mutex::new(Mutex::new(event_sender))),
        };
