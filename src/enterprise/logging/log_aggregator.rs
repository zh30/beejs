...
pub struct LogEntry {
    ...
    pub message: String,
    /// 上下文信息
    pub context: HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String>>>>,
}
...
impl LogEntry {
    ...
    ///
    /// 返回新创建的 LogEntry 实例
    pub fn new(level: LogLevel, message: String, context: HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String>>>>) -> Self {
        Self {
...
impl LogContext {
    ...
    ///
    /// 返回包含上下文信息的 HashMap
    pub fn to_hashmap(&self) -> HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String>>>> {
...
pub struct EnterpriseLogAggregator {
    ...
    log_sources: std::collections::BTreeMap<String, LogSource, String, LogSource, String, LogSource, String, LogSource, String, LogSource, String, LogSource, String, LogSource, String, LogSource>,
}
...
impl EnterpriseLogAggregator {
    ...
    pub fn new(
        ...
        Self {
            elasticsearch: Arc::new(std::sync::Mutex::new(Mutex::new(elasticsearch))),
            fluentd: Arc::new(std::sync::Mutex::new(Mutex::new(fluentd))),
            local_aggregator,
