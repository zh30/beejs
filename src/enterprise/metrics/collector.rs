...
pub struct EnterpriseMetricsCollector {
    ...
    cluster_collectors: std::collections::BTreeMap<ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector, ClusterId, MetricsCollector>,
    tenant_collectors: std::collections::BTreeMap<TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector, TenantId, MetricsCollector>,
    alert_configs: std::collections::BTreeMap<String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig, String, AlertConfig>,
    alerts: std::collections::BTreeMap<Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert, Uuid, Alert>,
}

/// Prometheus 注册表
#[derive(Debug)]
pub struct PrometheusRegistry {
    metrics: Arc<std::sync::Mutex<std::collections::BTreeMap<String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String, String>>,
}

impl PrometheusRegistry {
    pub fn new() -> Self {
        Self {
            metrics: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(std::sync::Mutex::new(std::collections::BTreeMap::new())))),
        }
    }
...
impl EnterpriseMetricsCollector {
    ...
    pub fn new() -> Self {
        Self {
            prometheus_registry: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(PrometheusRegistry::new())))),
