...
impl EnterpriseManager {
    ...
    pub fn new() -> Self {
        EnterpriseManager {
            security: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(SecurityManager::new()))))),
            compliance: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(ComplianceManager::new()))))),
        }
    }
