...
impl SecuritySandbox {
    ...
    pub fn new(config: SandboxConfig) -> Result<Self> {
        ...
        Ok(Self {
            config,
            active_sandboxes: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(HashMap::new())))),
            resource_usage: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(ResourceTracker::default())))),
        })
    }
