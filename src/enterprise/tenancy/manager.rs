...
impl TenancyManager {
    ...
    pub fn new() -> Self {
        TenancyManager {
            tenants: Arc::new(Mutex::new(RwLock::new(std::collections::HashMap::new())),
            executions: Arc::new(Mutex::new(RwLock::new(std::collections::HashMap::new())),
            resource_usage: Arc::new(Mutex::new(RwLock::new(std::collections::HashMap::new())),
        }
    }
