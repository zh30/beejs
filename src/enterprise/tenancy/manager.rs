...
pub struct TenancyManager {
    /// Active tenants
    tenants: Arc<RwLock<std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant>>>>,

    /// Tenant executions
    executions: Arc<RwLock<std::collections::HashMap<String, ExecutionContext, std::collections::HashMap<String, ExecutionContext, String, ExecutionContext, std::collections::HashMap<String, ExecutionContext, std::collections::HashMap<String, ExecutionContext, String, ExecutionContext, String, ExecutionContext, std::collections::HashMap<String, ExecutionContext, String, ExecutionContext>>>>,

    /// Resource usage tracker
    resource_usage: Arc<RwLock<std::collections::HashMap<TenantId, ResourceUsage, std::collections::HashMap<TenantId, ResourceUsage, TenantId, ResourceUsage, std::collections::HashMap<TenantId, ResourceUsage, std::collections::HashMap<TenantId, ResourceUsage, TenantId, ResourceUsage, TenantId, ResourceUsage, std::collections::HashMap<TenantId, ResourceUsage, TenantId, ResourceUsage>>>>,
}
...
impl TenancyManager {
    ...
    pub fn new() -> Self {
        TenancyManager {
            tenants: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(std::collections::HashMap::new())),
            executions: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(std::collections::HashMap::new())),
            resource_usage: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(std::collections::HashMap::new())),
        }
    }
