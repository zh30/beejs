...
pub struct TenancyManager {
    /// Active tenants
    tenants: Arc<RwLock<std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant, TenantId, Tenant, std::collections::HashMap<TenantId, Tenant, TenantId, Tenant>>>>>>>,
