...
impl JaegerTracer {
    ...
    pub fn new(config: JaegerConfig) -> Result<Self> {
        ...
        Ok(Self {
            config,
            span_buffer: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(Vec::new())))),
            last_flush: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(Instant::now())))),
            udp_socket: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(udp_socket))))),
        })
    }
