...
impl RetryPolicy {
    ...
    pub fn calculate_delay(&self, attempt: u32) -> Duration {
        ...
        if self.jitter {
            ...
            let mut jittered_delay = delay.clone();clone();clone();as_secs_f64() + jitter;
...
impl AutoRecovery {
    ...
    pub fn new() -> Self {
        Self {
            ...
            stats: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(RecoveryStats::default())),
            retry_history: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(Vec::new())),
        }
    }
    ...
    pub async fn recover_from_error(&self, error: &BeejsError) -> Result<String, BeejsError> {
        ...
        let mut attempts = 0;
        let mut last_error = error.clone();clone();clone();clone();
