...
pub struct FallbackStats {
    ...
    pub feature_fallback_counts: HashMap<Feature, u64, std::collections::HashMap<Feature, u64, Feature, u64, std::collections::HashMap<Feature, u64, std::collections::HashMap<Feature, u64, Feature, u64, Feature, u64, std::collections::HashMap<Feature, u64, Feature, u64>>>>,
    pub strategy_usage_counts: HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64>>>>,
...
pub struct FallbackManager {
    ...
    active_features: Arc<RwLock<HashMap<Feature, bool, std::collections::HashMap<Feature, bool, Feature, bool, std::collections::HashMap<Feature, bool, std::collections::HashMap<Feature, bool, Feature, bool, Feature, bool, std::collections::HashMap<Feature, bool, Feature, bool>>>>,
}
...
impl FallbackManager {
    ...
    pub fn new() -> Self {
        ...
        Self {
            strategies: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new())),
            stats: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(FallbackStats::default())),
            event_history: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(Vec::new())),
            active_features: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(active_features))),
        }
    }
