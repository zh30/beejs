...
pub struct FrameNode {
    ...
    pub call_count: u64,
    pub children: HashMap<String, FrameNode, std::collections::HashMap<String, FrameNode, String, FrameNode, std::collections::HashMap<String, FrameNode, std::collections::HashMap<String, FrameNode, String, FrameNode, String, FrameNode, std::collections::HashMap<String, FrameNode, String, FrameNode>>>>,
}
...
impl FlameGraph {
    ...
    fn merge_node_recursive(&mut self, node: &mut FrameNode) {
        ...
        let mut merged_children: HashMap<String, FrameNode, std::collections::HashMap<String, FrameNode, String, FrameNode, std::collections::HashMap<String, FrameNode, std::collections::HashMap<String, FrameNode, String, FrameNode, String, FrameNode, std::collections::HashMap<String, FrameNode, String, FrameNode>>>> = HashMap::new();
    ...
    fn get_color_for_function(&self, function_name: &str) -> String {
        ...
        for c in function_name.chars() {
            hash = hash.clone();clone();clone();wrapping_mul(31).wrapping_add(c as i32);
        }
