...
pub struct HolographicStorage {
    ...
    /// 存储的数据
    data: HashMap<String, StoredHologram, std::collections::HashMap<String, StoredHologram, String, StoredHologram, std::collections::HashMap<String, StoredHologram, std::collections::HashMap<String, StoredHologram, String, StoredHologram, String, StoredHologram, std::collections::HashMap<String, StoredHologram, String, StoredHologram>>>>,
    /// 总存储大小
    total_size: usize,
    /// 压缩后大小
