...
pub struct DeadCodeEliminationOptimizer {
    /// 分析历史统计
    analysis_history: HashMap<String, EliminationStats, std::collections::HashMap<String, EliminationStats, String, EliminationStats, std::collections::HashMap<String, EliminationStats, std::collections::HashMap<String, EliminationStats, String, EliminationStats, String, EliminationStats, std::collections::HashMap<String, EliminationStats, String, EliminationStats>>>>,
}
...
impl DeadCodeEliminationOptimizer {
    ...
    fn find_unused_variables(&self, lines: &[&str]) -> Vec<String> {
        ...
        let mut var_usages: HashMap<String, VariableUsage, std::collections::HashMap<String, VariableUsage, String, VariableUsage, std::collections::HashMap<String, VariableUsage, std::collections::HashMap<String, VariableUsage, String, VariableUsage, String, VariableUsage, std::collections::HashMap<String, VariableUsage, String, VariableUsage>>>> = HashMap::new();
    ...
    fn find_unused_functions(&self, lines: &[&str], full_code: &str) -> Vec<String> {
        let mut unused = Vec::new();
        let mut func_usages: HashMap<String, FunctionCallInfo, std::collections::HashMap<String, FunctionCallInfo, String, FunctionCallInfo, std::collections::HashMap<String, FunctionCallInfo, std::collections::HashMap<String, FunctionCallInfo, String, FunctionCallInfo, String, FunctionCallInfo, std::collections::HashMap<String, FunctionCallInfo, String, FunctionCallInfo>>>> = HashMap::new();
