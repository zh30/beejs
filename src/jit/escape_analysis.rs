...
pub struct EscapeAnalysisOptimizer {
    /// 分析历史统计
    analysis_history: HashMap<String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats, String, EscapeStats, std::collections::HashMap<String, EscapeStats, String, EscapeStats>>>>>>>,
}
