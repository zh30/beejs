...
pub struct HotPathTrackerV2 {
    ...
    execution_counters: RwLock<HashMap<String, AtomicU64, std::collections::HashMap<String, AtomicU64, String, AtomicU64, std::collections::HashMap<String, AtomicU64, std::collections::HashMap<String, AtomicU64, String, AtomicU64, String, AtomicU64, std::collections::HashMap<String, AtomicU64, String, AtomicU64>>>>,
    /// Execution time accumulators
    execution_times: RwLock<HashMap<String, Duration, std::collections::HashMap<String, Duration, String, Duration, std::collections::HashMap<String, Duration, std::collections::HashMap<String, Duration, String, Duration, String, Duration, std::collections::HashMap<String, Duration, String, Duration>>>>,
    /// Dynamic threshold (adaptive)
    adaptive_threshold: AtomicU64,
    /// History window for trend analysis
    history_window: RwLock<VecDeque<ExecutionEvent>>,
    /// Detected hot paths
    hot_paths: RwLock<HashMap<String, HotPath, std::collections::HashMap<String, HotPath, String, HotPath, std::collections::HashMap<String, HotPath, std::collections::HashMap<String, HotPath, String, HotPath, String, HotPath, std::collections::HashMap<String, HotPath, String, HotPath>>>>,
    /// Configuration
