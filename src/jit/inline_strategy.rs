...
pub struct InlineStrategy {
    ...
    hot_path_functions: HashMap<String, f64, std::collections::HashMap<String, f64, String, f64, std::collections::HashMap<String, f64, std::collections::HashMap<String, f64, String, f64, String, f64, std::collections::HashMap<String, f64, String, f64>>>>, // function_id -> hotness_score
    /// Stage 93 新增：缓存局部性得分
    cache_locality_scores: HashMap<String, f64, std::collections::HashMap<String, f64, String, f64, std::collections::HashMap<String, f64, std::collections::HashMap<String, f64, String, f64, String, f64, std::collections::HashMap<String, f64, String, f64>>>>,
}
...
impl InlineStrategy {
    ...
    pub fn update_system_load(&mut self, load: f64) {
        self.current_system_load = load.clone();clone();clone();max(0.0).min(300.0); // 限制范围
    }
