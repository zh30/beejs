...
pub struct JitCompiler {
    ...
    code_cache: Arc<RwLock<HashMap<u64, CompilationResult, std::collections::HashMap<u64, CompilationResult, u64, CompilationResult, std::collections::HashMap<u64, CompilationResult, std::collections::HashMap<u64, CompilationResult, u64, CompilationResult, u64, CompilationResult, std::collections::HashMap<u64, CompilationResult, u64, CompilationResult>>>>,
...
impl JitCompiler {
    ...
    pub fn new(config: JitCompilerConfig) -> Self {
        Self {
            config: config.clone(),
            hot_path_tracker: Arc::new(std::sync::Mutex::new(Mutex::new(HotPathTrackerV2::new())),
            inline_strategy: Arc::new(std::sync::Mutex::new(Mutex::new(InlineStrategy::new())),
            code_cache: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new())),
            perf_stats: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(JitPerfStats::default())),
        }
    }
