...
impl GenerationalGC {
    ...
    pub fn new(config: GCConfig) -> Self {
        ...
        let stats: _ = Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(GCStats {
            young_gc_count: AtomicU64::new(0)))))),
            old_gc_count: AtomicU64::new(0),
            total_collected_objects: AtomicU64::new(0),
            total_collected_bytes: AtomicU64::new(0),
        ...
        let young_gen: _ = Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(YoungGeneration {
        ...
        let old_gen: _ = Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(OldGeneration {
            live_objects: HashMap::new()))))),
