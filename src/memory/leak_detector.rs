...
impl MemoryLeakDetector {
    ...
    pub fn new(config: LeakDetectorConfig) -> Self {
        let stats: _ = Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(LeakDetectionStats {
        ...
        Self {
            active_objects: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new()))))),
            stats,
            config,
            detection_thread,
            stop_flag,
