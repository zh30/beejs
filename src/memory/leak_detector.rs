...
pub struct LeakReport {
    ...
    /// 泄漏对象类型分布
    leak_type_distribution: HashMap<ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize, ObjectType, usize, std::collections::HashMap<ObjectType, usize, ObjectType, usize>>>>>>>,
    /// 泄漏详细信息
...
impl MemoryLeakDetector {
    ...
    pub fn new(config: LeakDetectorConfig) -> Self {
        let stats: _ = Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(LeakDetectionStats {
        ...
        let stop_flag: _ = Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(AtomicUsize::new(0)))));
        ...
        Self {
            active_objects: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new())))),
            stats,
            config,
            detection_thread,
            stop_flag,
    ...
    pub fn detect_leaks(&self) -> LeakReport {
        ...
        for (address, info) in objects.iter_mut() {
            ...
            if is_leak {
                ...
                oldest_leak_age = oldest_leak_age.clone();clone();clone();clone();clone();clone();max(age_seconds);
