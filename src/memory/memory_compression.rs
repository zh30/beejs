...
impl MemoryCompression {
    ...
    pub fn new(config: CompressionConfig) -> Self {
        let stats: _ = Arc::new(std::sync::Mutex::new(Mutex::new(CompressionStats {
        ...
        let algorithms: _ = Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(CompressionAlgorithms {
            lz4_compressor: LZ4Compressor {
                threshold: 1024,  // 1KB
                min_ratio: 1.2,   // 20%
            },
