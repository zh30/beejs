...
impl MemoryCompression {
    ...
    pub fn new(config: CompressionConfig) -> Self {
        let stats: _ = Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(CompressionStats {
        ...
        let algorithms: _ = Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(CompressionAlgorithms {
            lz4_compressor: LZ4Compressor {
                threshold: 1024,  // 1KB
                min_ratio: 1.2,   // 20%
            },
        ...
        let stop_flag: _ = Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(AtomicUsize::new(0))))));
