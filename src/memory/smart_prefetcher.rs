...
impl PatternRecognizer {
    ...
    fn calculate_cyclic_score(&self, accesses: &[AccessHistoryEntry]) -> f64 {
        ...
        // 查找重复的地址序列
        let mut sequence_counts: HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize, Vec<usize, std::collections::HashMap<Vec<usize, Vec<usize>>>>>>>, usize> = HashMap::new();
...
pub struct PrefetchStats {
    ...
    pub pattern_accuracies: HashMap<String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize, String, AtomicUsize, std::collections::HashMap<String, AtomicUsize, String, AtomicUsize>>>>>>>,
}
...
impl SmartPrefetcher {
    ...
    pub fn new(
        ...
        Self {
            recognizer: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(PatternRecognizer::new())))),
            strategy,
            zero_copy,
            prefetch_queue: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(Vec::new())))),
            stats: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(PrefetchStats::default())))),
            enabled: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(AtomicBool::new(true))))),
        }
    }
...
use std::collections::{HashMap, BTreeMap};
    ...
    async fn test_smart_prefetcher() {
        let zero_copy: _ = Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(EnhancedZeroCopy::default()))));
