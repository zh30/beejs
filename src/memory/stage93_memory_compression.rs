...
impl Stage93MemoryCompressor {
    ...
    pub fn new(config: Stage93CompressionConfig) -> Self {
        ...
        Self {
            config,
            compression_pool: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(LruCache::new(cache_size as u64))),
            decompress_cache: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(LruCache::new(cache_size as u64))),
            stats: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(CompressionStats::default())),
