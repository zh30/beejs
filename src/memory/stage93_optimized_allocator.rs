...
impl Stage93OptimizedAllocator {
    ...
    pub fn new(base: SmartMemoryAllocator, config: Stage93AllocatorConfig) -> Self {
        ...
        Self {
            ...
            arena,
            size_classes,
            defragmenter: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(Defragmenter::new(config.defrag_threshold))),
            stats: Arc::new(std::sync::Mutex::new(Mutex::new(Stage93AllocatorStats::default())),
        }
    }
