...
impl ZeroCopyAllocator {
    ...
    pub fn new(config: AllocatorConfig) -> Self {
        ...
        Self {
            pools: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(pools)))))),
            large_allocations: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(HashMap::new()))))),
            stats: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(AllocatorStats {
