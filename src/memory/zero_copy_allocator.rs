...
pub struct ZeroCopyAllocator {
    /// 内存池按大小分类管理
    pools: Arc<Mutex<HashMap<usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool, usize, MemoryPool, std::collections::HashMap<usize, MemoryPool, usize, MemoryPool>>>>>>>,
    /// 大内存直接分配池
...
impl ZeroCopyAllocator {
    ...
    pub fn new(config: AllocatorConfig) -> Self {
        ...
        Self {
            pools: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(pools))))),
            large_allocations: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(HashMap::new())))),
            stats: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(AllocatorStats {
