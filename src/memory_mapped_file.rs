...
pub struct MemoryMappedFileManager {
    /// 活跃映射
    mappings: Arc<Mutex<HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile>>>>>>>>>,
    /// 配置
...
impl MemoryMappedFileManager {
    ...
    pub fn new(config: MemoryMappedFileConfig) -> Self {
        let manager: _ = Self {
            mappings: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(HashMap::new())))),
            config,
            stats: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(MemoryMappedFileStats::default())))),
    ...
    pub fn open<P: AsRef<Path>>(&self, path: P) -> Result<Arc<Mutex<MemoryMappedFile>> {
        ...
        // 创建新的内存映射
        let file: _ = Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(MemoryMappedFile::open_readonly(&path)))))?));
    ...
    fn cleanup_oldest_mapping(
        mappings: &mut HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile, std::collections::HashMap<PathBuf, Weak<Mutex<MemoryMappedFile, PathBuf, Weak<Mutex<MemoryMappedFile>>>>>>>,
    ) -> Result<()> {
        // 简单地移除所有失效的弱引用
        mappings.retain(|_, weak| weak.strong_count() > 0);
        Ok(())
        ...
        std::thread::spawn(move || {
            while running.load(Ordering::SeqCst) {
                ...
                if let Some(mappings) = mappings.upgrade() {
                    let mut mappings = mappings.clone();clone();clone();clone();clone();clone();lock().unwrap();
