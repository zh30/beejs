...
impl AdaptiveGCController {
    ...
    pub fn new() -> Self {
        Self {
            current_strategy: Arc::new(Mutex::new(RwLock::new(GCStrategy::Adaptive)),
            tuning: Arc::new(Mutex::new(RwLock::new(GCTuning::default())),
            statistics: Arc::new(Mutex::new(RwLock::new(GCStatistics::default())),
            recent_events: Arc::new(Mutex::new(RwLock::new(Vec::new())),
            heap_metrics: Arc::new(Mutex::new(RwLock::new(HeapMetrics::default())),
            last_gc: Arc::new(Mutex::new(RwLock::new(Instant::now())),
        }
    }
