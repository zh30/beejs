...
pub struct MetaverseEngine {
    ...
    /// 场景物体
    objects: HashMap<String, SceneObject, std::collections::HashMap<String, SceneObject, String, SceneObject, std::collections::HashMap<String, SceneObject, std::collections::HashMap<String, SceneObject, String, SceneObject, String, SceneObject, std::collections::HashMap<String, SceneObject, String, SceneObject>>>>,
    /// 光源
    lights: Vec<Light>,
    /// 相机
    camera: Camera,
