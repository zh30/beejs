...
pub struct MultiuserRenderer {
    ...
    sync_mode: SyncMode,
    /// 用户 Avatar 映射
    avatars: HashMap<String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar, String, UserAvatar, std::collections::HashMap<String, UserAvatar, String, UserAvatar>>>>>>>,
    /// 最大用户数
    max_users: u32,
}
