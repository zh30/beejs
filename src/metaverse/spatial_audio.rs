...
pub struct SpatialAudioSystem {
    ...
    config: AudioConfig,
    /// 音频源
    sources: HashMap<String, AudioSource, std::collections::HashMap<String, AudioSource, String, AudioSource, std::collections::HashMap<String, AudioSource, std::collections::HashMap<String, AudioSource, String, AudioSource, String, AudioSource, std::collections::HashMap<String, AudioSource, String, AudioSource>>>>,
    /// 监听者位置
...
impl SpatialAudioSystem {
    ...
    pub fn set_master_volume(&mut self, volume: f32) {
        self.master_volume = volume.clone();clone();clone();clamp(0.0, 1.0);
    }
