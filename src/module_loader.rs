...
pub struct ModuleLoader {
    ...
    module_cache: Arc<Mutex<HashMap<String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module, String, Arc<Module, std::collections::HashMap<String, Arc<Module, String, Arc<Module>>>>>>>,
...
impl ModuleLoader {
    ...
    pub fn new(base_dir: PathBuf) -> Self {
        Self {
            module_cache: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(HashMap::new())))),
            base_dir,
        }
    }
    ...
    fn resolve_relative_module(&self, module_name: &str) -> Result<PathBuf> {
        ...
        path = path.clone();clone();clone();clone();clone();clone();join(relative_part);
        ...
        let mut js_path = path.clone();clone();clone();clone();clone();clone();clone();
            ...
            if node_modules.exists() {
                ...
                if package_json.exists() {
                    ...
                    if let Some(main) = package["main"].as_str() {
                        ...
                        main_path = main_path.clone();clone();clone();clone();clone();clone();join(main);
    ...
    pub fn load_module(&self, module_name: &str) -> Result<Arc<Module>> {
        ...
        {
            let mut cache = self.module_cache.lock().unwrap();
            cache.insert(module_name.to_string(), Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(module)))));
        }
    ...
    fn create_builtin_path_module(&self) -> Arc<Module> {
        ...
        Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(Module {
            exports,
