...
pub struct NotificationChannel {
    ...
    /// 配置
    pub config: HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String>>>>,
    /// 是否启用
    pub enabled: bool,
}
...
pub struct AlertSystem {
    ...
    /// 告警规则
    rules: Arc<Mutex<HashMap<String, AlertRule, std::collections::HashMap<String, AlertRule, String, AlertRule, std::collections::HashMap<String, AlertRule, std::collections::HashMap<String, AlertRule, String, AlertRule, String, AlertRule, std::collections::HashMap<String, AlertRule, String, AlertRule>>>>,
    /// 活跃告警
    active_alerts: Arc<Mutex<HashMap<String, AlertInstance, std::collections::HashMap<String, AlertInstance, String, AlertInstance, std::collections::HashMap<String, AlertInstance, std::collections::HashMap<String, AlertInstance, String, AlertInstance, String, AlertInstance, std::collections::HashMap<String, AlertInstance, String, AlertInstance>>>>,
    /// 告警历史
    alert_history: Arc<Mutex<VecDeque<AlertInstance>>,
    /// 通知渠道
    notification_channels: Arc<Mutex<HashMap<String, NotificationChannel, std::collections::HashMap<String, NotificationChannel, String, NotificationChannel, std::collections::HashMap<String, NotificationChannel, std::collections::HashMap<String, NotificationChannel, String, NotificationChannel, String, NotificationChannel, std::collections::HashMap<String, NotificationChannel, String, NotificationChannel>>>>,
    /// 静默规则
    silence_rules: Arc<Mutex<HashMap<String, SilenceRule, std::collections::HashMap<String, SilenceRule, String, SilenceRule, std::collections::HashMap<String, SilenceRule, std::collections::HashMap<String, SilenceRule, String, SilenceRule, String, SilenceRule, std::collections::HashMap<String, SilenceRule, String, SilenceRule>>>>,
    /// 统计信息
...
pub struct SilenceRule {
    ...
    pub end_time: u64,
    /// 匹配的标签
    pub match_tags: HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String>>>>,
    /// 创建时间
    pub created_at: u64,
}
...
impl AlertSystem {
    ...
    /// 检查是否应该静默
    fn should_silence(&self, tags: &HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String>>>>) -> bool {
    ...
    pub fn cleanup_expired_alerts(&self) -> Result<u64, String> {
        ...
        // 清理静默的告警
        let silence_rule_tags: HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String>>>> = HashMap::new();
