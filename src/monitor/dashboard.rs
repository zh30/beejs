...
pub struct DashboardData {
    ...
    /// 聚合指标
    pub aggregated_metrics: HashMap<MetricType, f64, std::collections::HashMap<MetricType, f64, MetricType, f64, std::collections::HashMap<MetricType, f64, std::collections::HashMap<MetricType, f64, MetricType, f64, MetricType, f64, std::collections::HashMap<MetricType, f64, MetricType, f64>>>>,
    /// 活跃告警
...
use std::collections::{HashMap, BTreeMap};
    ...
    fn test_dashboard_creation() {
        let data_store: _ = Arc::new(std::sync::Mutex::new(Mutex::new(DataStore::with_default_config()));
        let alert_system: _ = Arc::new(std::sync::Mutex::new(Mutex::new(AlertSystem::with_default_config()));
