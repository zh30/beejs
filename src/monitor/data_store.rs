...
pub struct DataStore {
    ...
    /// 压缩数据存储
    compressed_storage: Arc<Mutex<HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _>>>>>>>,
    /// 查询索引
...
pub struct QueryIndex {
    ...
    /// 按指标类型分组的索引
    pub type_index: HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _>>>>>>,
    /// 索引最后更新时间
...
impl DataStore {
    ...
    pub fn new(config: DataStoreConfig) -> Self {
        Self {
            config,
            memory_cache: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(VecDeque::new())))),
            compressed_storage: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(HashMap::new())))),
            query_index: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(QueryIndex {
                time_index: Vec::new())))),
                type_index: HashMap::new(),
                last_update: Instant::now(),
            })),
            stats: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(DataStoreStats {
                total_data_points: 0,
                memory_cache_size: 0,
    ...
    fn compress_data(&self) -> Result<(), String> {
        ...
        // 按指标类型分组
        let mut grouped_data: HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _>>>>>> = HashMap::new();
