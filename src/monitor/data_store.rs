...
pub struct QueryCondition {
    ...
    /// 标签过滤
    pub tag_filters: HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _>>>,
    /// 限制返回数量
...
pub struct DataStore {
    ...
    /// 压缩数据存储
    compressed_storage: Arc<Mutex<HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _>>>>,
    /// 查询索引
...
pub struct QueryIndex {
    ...
    /// 按指标类型分组的索引
    pub type_index: HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _>>>,
    /// 索引最后更新时间
...
impl DataStore {
    ...
    fn compress_data(&self) -> Result<(), String> {
        ...
        // 按指标类型分组
        let mut grouped_data: HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _>>> = HashMap::new();
