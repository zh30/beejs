...
pub struct MetricValue {
    ...
    pub timestamp: u64,
    /// 标签
    pub tags: HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _>>>,
}
...
pub struct PerformanceMonitor {
    ...
    /// 聚合指标缓存
    aggregated_metrics: Arc<Mutex<HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _>>>>,
    /// 指标收集统计
...
impl PerformanceMonitor {
    ...
    /// 获取聚合指标
    pub fn get_aggregated_metrics(&self) -> Result<HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _>>>, String> {
    ...
    pub fn aggregate_metrics(&self) -> Result<(), String> {
        ...
        // 按指标类型分组
        let mut grouped_metrics: HashMap<String, _, std::collections::HashMap<String, _, String, _, std::collections::HashMap<String, _, std::collections::HashMap<String, _, String, _, String, _, std::collections::HashMap<String, _, String, _>>> = HashMap::new();
