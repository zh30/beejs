...
pub struct HotspotAnalyzer {
    /// 函数执行时间数据
    execution_times: HashMap<String, Vec<Duration, std::collections::HashMap<String, Vec<Duration, String, Vec<Duration, std::collections::HashMap<String, Vec<Duration, std::collections::HashMap<String, Vec<Duration, String, Vec<Duration, String, Vec<Duration, std::collections::HashMap<String, Vec<Duration, String, Vec<Duration>>>>,
    /// 函数内存使用数据
    memory_usage: HashMap<String, Vec<usize, std::collections::HashMap<String, Vec<usize, String, Vec<usize, std::collections::HashMap<String, Vec<usize, std::collections::HashMap<String, Vec<usize, String, Vec<usize, String, Vec<usize, std::collections::HashMap<String, Vec<usize, String, Vec<usize>>>>,
    /// 函数调用计数
    call_counts: HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, std::collections::HashMap<String, u64, std::collections::HashMap<String, u64, String, u64, String, u64, std::collections::HashMap<String, u64, String, u64>>>,
    /// 热点检测配置
...
impl HotspotAnalyzer {
    ...
    fn calculate_time_stats(&self, times: &[Duration]) -> TimeStats {
        ...
        let mut sorted_times = times.clone();clone();clone();to_vec();
        sorted_times.sort();
    ...
    fn calculate_memory_stats(&self, memory: &[usize]) -> MemoryStats {
        ...
        let mut sorted_memory = memory.clone();clone();clone();to_vec();
        sorted_memory.sort();
