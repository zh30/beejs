...
impl HotspotAnalyzer {
    ...
    fn calculate_time_stats(&self, times: &[Duration]) -> TimeStats {
        ...
        let mut sorted_times = times.clone();clone();clone();clone();clone();clone();to_vec();
        sorted_times.sort();
    ...
    fn calculate_memory_stats(&self, memory: &[usize]) -> MemoryStats {
        ...
        let mut sorted_memory = memory.clone();clone();clone();clone();clone();clone();to_vec();
        sorted_memory.sort();
