...
pub struct FunctionTracker {
    /// 活跃的函数跟踪
    active_traces: HashMap<String, FunctionTraceHandle, std::collections::HashMap<String, FunctionTraceHandle, String, FunctionTraceHandle, std::collections::HashMap<String, FunctionTraceHandle, std::collections::HashMap<String, FunctionTraceHandle, String, FunctionTraceHandle, String, FunctionTraceHandle, std::collections::HashMap<String, FunctionTraceHandle, String, FunctionTraceHandle>>>>,
    /// 函数统计
    function_stats: HashMap<String, FunctionStats, std::collections::HashMap<String, FunctionStats, String, FunctionStats, std::collections::HashMap<String, FunctionStats, std::collections::HashMap<String, FunctionStats, String, FunctionStats, String, FunctionStats, std::collections::HashMap<String, FunctionStats, String, FunctionStats>>>>,
    /// 性能事件缓冲区
...
impl FunctionTracker {
    ...
    /// 获取所有函数统计
    pub fn get_all_function_stats(&self) -> HashMap<String, FunctionStats, std::collections::HashMap<String, FunctionStats, String, FunctionStats, std::collections::HashMap<String, FunctionStats, std::collections::HashMap<String, FunctionStats, String, FunctionStats, String, FunctionStats, std::collections::HashMap<String, FunctionStats, String, FunctionStats>>>> {
