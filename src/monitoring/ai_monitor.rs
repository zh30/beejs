...
pub struct RealtimePerformanceMonitor {
    ...
    thresholds: Arc<RwLock<HashMap<MetricType, f64, std::collections::HashMap<MetricType, f64, MetricType, f64, std::collections::HashMap<MetricType, f64, std::collections::HashMap<MetricType, f64, MetricType, f64, MetricType, f64, std::collections::HashMap<MetricType, f64, MetricType, f64>>>>,
}
...
impl RealtimePerformanceMonitor {
    pub fn new() -> Self {
        ...
        Self {
            ...
            thresholds: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(thresholds))),
        }
    }
