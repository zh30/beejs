...
impl RealtimePerformanceMonitor {
    pub fn new() -> Self {
        ...
        Self {
            ...
            thresholds: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(thresholds))))),
        }
    }
