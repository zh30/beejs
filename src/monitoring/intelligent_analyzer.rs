...
impl IntelligentAnalyzer {
    ...
    fn detect_anomalies(&self, metrics: &[crate::ai_monitor::PerformanceMetrics]) -> Vec<AnomalyDetection> {
        ...
        // 按指标类型分组
        let mut grouped: HashMap<String, Vec<_, std::collections::HashMap<String, Vec<_, String, Vec<_, std::collections::HashMap<String, Vec<_, std::collections::HashMap<String, Vec<_, String, Vec<_, String, Vec<_, std::collections::HashMap<String, Vec<_, String, Vec<_>>>> = HashMap::new();
