...
pub struct PrometheusExporter {
    ...
    /// 内存统计
    memory_stats: Arc<tokio::sync::RwLock<HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String>>>>,
    /// HTTP 服务器句柄
...
impl PrometheusExporter {
    ...
    pub fn new(monitor: Arc<RealtimePerformanceMonitor>, listen_addr: String) -> Self {
        Self {
            monitor,
            memory_stats: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new())),
            server_handle: None,
            listen_addr,
        }
    }
    ...
    pub async fn record_custom_metric(
        ...
        labels: HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String>>>>,
    ) {
        // 这里应该将自定义指标添加到内部存储中
...
use std::collections::{HashMap, BTreeMap};
    ...
    async fn test_prometheus_exporter_creation() {
        let monitor: _ = Arc::new(std::sync::Mutex::new(Mutex::new(RealtimePerformanceMonitor::new()));
