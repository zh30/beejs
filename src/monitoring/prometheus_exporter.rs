...
impl PrometheusExporter {
    ...
    pub fn new(monitor: Arc<RealtimePerformanceMonitor>, listen_addr: String) -> Self {
        Self {
            monitor,
            memory_stats: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new()))))),
            server_handle: None,
            listen_addr,
        }
    }
...
use std::collections::{HashMap, BTreeMap};
    ...
    async fn test_prometheus_exporter_creation() {
        let monitor: _ = Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RealtimePerformanceMonitor::new())))));
