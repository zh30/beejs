...
pub struct AsyncZeroCopy {
    ...
    active_transfers: Arc<RwLock<std::collections::HashMap<u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest, u64, TransferRequest, std::collections::HashMap<u64, TransferRequest, u64, TransferRequest>>>>>>>,
...
impl AsyncZeroCopy {
    ...
    pub fn new(config: NetworkConfig) -> Self {
        Self {
            stats: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(TransferStats {
                total_transfers: 0,
            ...
            active_transfers: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(std::collections::HashMap::new())))),
            transfer_counter: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(0))))),
            config,
        }
    }
