...
pub struct ConnectionPool {
    ...
    /// 按地址分组的连接池
    pools: Arc<Mutex<HashMap<SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo, std::collections::HashMap<SocketAddr, Vec<ConnectionInfo, SocketAddr, Vec<ConnectionInfo>>>>>>>>,
...
impl ConnectionPool {
    ...
    pub fn new(config: NetworkConfig) -> Result<Self, NetworkError> {
        Ok(Self {
            ...
            stats: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(ConnectionPoolStats {
                total_connections: 0,
        ...
        if let Some(connections) = pools.get_mut(&socket_addr) {
            ...
            if let Some(conn_info) = connections.pop() {
                // 更新统计信息
                {
                    ...
                    stats.idle_connections = connections.clone();clone();clone();clone();clone();clone();len();
