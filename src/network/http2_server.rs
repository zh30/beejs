...
pub struct Http2Server {
    ...
    enabled: bool,
    routes: HashMap<String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler, String, Http2Handler, std::collections::HashMap<String, Http2Handler, String, Http2Handler>>>>>>>,
...
impl Http2Server {
    ...
    pub fn new(config: NetworkConfig) -> Result<Self, NetworkError> {
        Ok(Self {
            ...
            config,
            routes: HashMap::new(),
            stats: std::sync::Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(std::sync::Mutex::new(Http2ServerStats {
                total_requests: 0,
                active_streams: 0,
                total_connections: 0,
            }))))),
