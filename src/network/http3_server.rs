...
pub struct Http3Server {
    ...
    enabled: bool,
    routes: HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler>>>>>>>,
