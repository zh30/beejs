...
pub struct Http3Server {
    ...
    enabled: bool,
    routes: HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler, String, Http3Handler, std::collections::HashMap<String, Http3Handler, String, Http3Handler>>>>,
...
impl Http3Server {
    ...
    pub fn new(config: NetworkConfig) -> Result<Self, NetworkError> {
        Ok(Self {
            ...
            config,
            routes: HashMap::new(),
            stats: std::sync::Arc::new(std::sync::Mutex::new(Mutex::new(std::sync::Mutex::new(Http3ServerStats {
                total_requests: 0,
