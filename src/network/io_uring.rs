...
pub struct IoUringEngine {
    ...
    active_operations: Arc<RwLock<HashMap<u64, std::time::Instant, std::collections::HashMap<u64, std::time::Instant, u64, std::time::Instant, std::collections::HashMap<u64, std::time::Instant, std::collections::HashMap<u64, std::time::Instant, u64, std::time::Instant, u64, std::time::Instant, std::collections::HashMap<u64, std::time::Instant, u64, std::time::Instant>>>>,
...
impl IoUringEngine {
    ...
    pub fn new(config: NetworkConfig) -> Self {
        ...
        Self {
            stats: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(UringStats {
                submissions: 0,
                completions: 0,
            ...
            active_operations: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new())),
            operation_counter: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(0))),
            completion_queue: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(Vec::new())),
            config,
            uring_config,
        }
    }
