...
impl MemoryMapper {
    ...
    pub fn new(config: Option<MemoryMapperConfig>) -> io::Result<Self> {
        ...
        Ok(Self {
            ...
            next_region_id: Arc::new(std::sync::Mutex::new(Mutex::new(std::sync::atomic::AtomicU64::new(1))),
            total_mapped_memory: Arc::new(std::sync::Mutex::new(Mutex::new(std::sync::atomic::AtomicUsize::new(0))),
        })
    }
