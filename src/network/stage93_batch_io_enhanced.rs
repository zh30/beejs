...
impl Stage93BatchIoEngine {
    ...
    pub fn new(config: NetworkConfig) -> Self {
        ...
        Self {
            ...
            adaptive_batch_size: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(batch_config.max_batch_size)))))),
            adaptive_timeout: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(Duration::from_millis(batch_config.batch_timeout_ms)))))),
            config,
            batch_config,
            stats: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(Stage93BatchStats::default()))))),
            priority_queues: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(priority_queues)))))),
            operation_counter: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(AtomicU64::new(0)))))),
        }
    }
