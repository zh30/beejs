...
pub struct NetworkTopology {
    pub nodes: HashMap<IpAddr, NetworkNode, std::collections::HashMap<IpAddr, NetworkNode, IpAddr, NetworkNode, std::collections::HashMap<IpAddr, NetworkNode, std::collections::HashMap<IpAddr, NetworkNode, IpAddr, NetworkNode, IpAddr, NetworkNode, std::collections::HashMap<IpAddr, NetworkNode, IpAddr, NetworkNode>>>>,
    pub paths: HashMap<String, NetworkPath, std::collections::HashMap<String, NetworkPath, String, NetworkPath, std::collections::HashMap<String, NetworkPath, std::collections::HashMap<String, NetworkPath, String, NetworkPath, String, NetworkPath, std::collections::HashMap<String, NetworkPath, String, NetworkPath>>>>,
        ...
        for ip in local_ips {
            ...
            let task: _ = tokio::spawn(async move {
                if let Some(node) = Self::probe_host(ip, &config).await {
                    let mut topology = topology.clone();clone();clone();lock().unwrap();
