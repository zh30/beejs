...
pub struct ZeroCopyAccessPredictor {
    ...
    size_patterns: Arc<RwLock<HashMap<usize, u32, std::collections::HashMap<usize, u32, usize, u32, std::collections::HashMap<usize, u32, std::collections::HashMap<usize, u32, usize, u32, usize, u32, std::collections::HashMap<usize, u32, usize, u32>>>>,
...
impl ZeroCopyAccessPredictor {
    pub fn new() -> Self {
        Self {
            access_history: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(VecDeque::with_capacity(10000))),
            size_patterns: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new())),
            accuracy_tracker: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(VecDeque::with_capacity(1000))),
        }
    }
...
impl Stage93ZeroCopySocket {
    ...
    pub fn new(config: NetworkConfig) -> Self {
        ...
        Self {
            zero_copy_config,
            stats: Arc::new(std::sync::Mutex::new(Mutex::new(Stage93ZeroCopyStats::default())),
            mmap_pool: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(Vec::new())),
            predictor: Arc::new(std::sync::Mutex::new(Mutex::new(ZeroCopyAccessPredictor::new())),
            adaptive_threshold: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(zero_copy_config.zero_copy_threshold))),
            config,
        }
    }
