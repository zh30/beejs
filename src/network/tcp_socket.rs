...
impl ZeroCopyTcpSocket {
    ...
    pub fn new(stream: TcpStream, buffer_size: usize) -> Self {
        let mut socket = Self {
            stream: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(stream))))),
            send_buffer: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(Vec::with_capacity(buffer_size))))),
            buffer_size,
            stats: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(ZeroCopyStats::default())))),
        };
