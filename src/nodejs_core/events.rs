...
thread_local! {
    static EVENT_LISTENERS: Mutex<HashMap<String, Vec<v8::Global<v8::Function, std::collections::HashMap<String, Vec<v8::Global<v8::Function, String, Vec<v8::Global<v8::Function, std::collections::HashMap<String, Vec<v8::Global<v8::Function, std::collections::HashMap<String, Vec<v8::Global<v8::Function, String, Vec<v8::Global<v8::Function, String, Vec<v8::Global<v8::Function, std::collections::HashMap<String, Vec<v8::Global<v8::Function, String, Vec<v8::Global<v8::Function>>>>> = Mutex::new(HashMap::new());
    static ONCE_LISTENERS: Mutex<HashMap<String, Vec<v8::Global<v8::Function, std::collections::HashMap<String, Vec<v8::Global<v8::Function, String, Vec<v8::Global<v8::Function, std::collections::HashMap<String, Vec<v8::Global<v8::Function, std::collections::HashMap<String, Vec<v8::Global<v8::Function, String, Vec<v8::Global<v8::Function, String, Vec<v8::Global<v8::Function, std::collections::HashMap<String, Vec<v8::Global<v8::Function, String, Vec<v8::Global<v8::Function>>>>> = Mutex::new(HashMap::new());
}
...
fn event_emitter_on_callback(
    ...
    let mut listeners_map: HashMap<String, Vec<v8::Global<v8::Function, std::collections::HashMap<String, Vec<v8::Global<v8::Function, String, Vec<v8::Global<v8::Function, std::collections::HashMap<String, Vec<v8::Global<v8::Function, std::collections::HashMap<String, Vec<v8::Global<v8::Function, String, Vec<v8::Global<v8::Function, String, Vec<v8::Global<v8::Function, std::collections::HashMap<String, Vec<v8::Global<v8::Function, String, Vec<v8::Global<v8::Function>>>> = HashMap::new();
