...
pub fn setup_os_api(
    ...
    // OS常量
    let key_uv_udp_reuseaddr = v8::String::new(scope, "UV_UDP_REUSEADDR").unwrap();
    let val_uv_udp_reuseaddr = v8::Integer::new(scope, 4);
    constants_obj.set(scope, key_uv_udp_reuseaddr.into(), val_uv_udp_reuseaddr.into());

    // Signal常量
    let signals_obj = v8::Object::new(scope);
    let key_sighup = v8::String::new(scope, "SIGHUP").unwrap();
    let val_sighup = v8::Integer::new(scope, 1);
    signals_obj.set(scope, key_sighup.into(), val_sighup.into());
    let key_sigint = v8::String::new(scope, "SIGINT").unwrap();
    let val_sigint = v8::Integer::new(scope, 2);
    signals_obj.set(scope, key_sigint.into(), val_sigint.into());
    let key_sigquit = v8::String::new(scope, "SIGQUIT").unwrap();
    let val_sigquit = v8::Integer::new(scope, 3);
    signals_obj.set(scope, key_sigquit.into(), val_sigquit.into());
    let key_sigill = v8::String::new(scope, "SIGILL").unwrap();
    let val_sigill = v8::Integer::new(scope, 4);
    signals_obj.set(scope, key_sigill.into(), val_sigill.into());
    let key_sigtrap = v8::String::new(scope, "SIGTRAP").unwrap();
    let val_sigtrap = v8::Integer::new(scope, 5);
    signals_obj.set(scope, key_sigtrap.into(), val_sigtrap.into());
    let key_sigabrt = v8::String::new(scope, "SIGABRT").unwrap();
    let val_sigabrt = v8::Integer::new(scope, 6);
    signals_obj.set(scope, key_sigabrt.into(), val_sigabrt.into());
    let key_sigiot = v8::String::new(scope, "SIGIOT").unwrap();
    let val_sigiot = v8::Integer::new(scope, 6);
    signals_obj.set(scope, key_sigiot.into(), val_sigiot.into());
    let key_sigbus = v8::String::new(scope, "SIGBUS").unwrap();
    let val_sigbus = v8::Integer::new(scope, 7);
    signals_obj.set(scope, key_sigbus.into(), val_sigbus.into());
    let key_sigfpe = v8::String::new(scope, "SIGFPE").unwrap();
    let val_sigfpe = v8::Integer::new(scope, 8);
    signals_obj.set(scope, key_sigfpe.into(), val_sigfpe.into());
    let key_sigkill = v8::String::new(scope, "SIGKILL").unwrap();
    let val_sigkill = v8::Integer::new(scope, 9);
    signals_obj.set(scope, key_sigkill.into(), val_sigkill.into());
    let key_sigusr1 = v8::String::new(scope, "SIGUSR1").unwrap();
    let val_sigusr1 = v8::Integer::new(scope, 10);
    signals_obj.set(scope, key_sigusr1.into(), val_sigusr1.into());
    let key_sigusr2 = v8::String::new(scope, "SIGUSR2").unwrap();
    let val_sigusr2 = v8::Integer::new(scope, 12);
    signals_obj.set(scope, key_sigusr2.into(), val_sigusr2.into());
    let key_sigpipe = v8::String::new(scope, "SIGPIPE").unwrap();
    let val_sigpipe = v8::Integer::new(scope, 13);
    signals_obj.set(scope, key_sigpipe.into(), val_sigpipe.into());
    let key_sigalrm = v8::String::new(scope, "SIGALRM").unwrap();
    let val_sigalrm = v8::Integer::new(scope, 14);
    signals_obj.set(scope, key_sigalrm.into(), val_sigalrm.into());
    let key_sigterm = v8::String::new(scope, "SIGTERM").unwrap();
    let val_sigterm = v8::Integer::new(scope, 15);
    signals_obj.set(scope, key_sigterm.into(), val_sigterm.into());
    let key_sigchld = v8::String::new(scope, "SIGCHLD").unwrap();
    let val_sigchld = v8::Integer::new(scope, 17);
    signals_obj.set(scope, key_sigchld.into(), val_sigchld.into());
    let key_sigcld = v8::String::new(scope, "SIGCLD").unwrap();
    let val_sigcld = v8::Integer::new(scope, 17);
    signals_obj.set(scope, key_sigcld.into(), val_sigcld.into());
    let key_sigcont = v8::String::new(scope, "SIGCONT").unwrap();
    let val_sigcont = v8::Integer::new(scope, 18);
    signals_obj.set(scope, key_sigcont.into(), val_sigcont.into());
    let key_sigstop = v8::String::new(scope, "SIGSTOP").unwrap();
    let val_sigstop = v8::Integer::new(scope, 19);
    signals_obj.set(scope, key_sigstop.into(), val_sigstop.into());
    let key_sigtstp = v8::String::new(scope, "SIGTSTP").unwrap();
    let val_sigtstp = v8::Integer::new(scope, 20);
    signals_obj.set(scope, key_sigtstp.into(), val_sigtstp.into());
    let key_sigttin = v8::String::new(scope, "SIGTTIN").unwrap();
    let val_sigttin = v8::Integer::new(scope, 21);
    signals_obj.set(scope, key_sigttin.into(), val_sigttin.into());
    let key_sigttou = v8::String::new(scope, "SIGTTOU").unwrap();
    let val_sigttou = v8::Integer::new(scope, 22);
    signals_obj.set(scope, key_sigttou.into(), val_sigttou.into());
    let key_sigurg = v8::String::new(scope, "SIGURG").unwrap();
    let val_sigurg = v8::Integer::new(scope, 23);
    signals_obj.set(scope, key_sigurg.into(), val_sigurg.into());
    let key_sigxcpu = v8::String::new(scope, "SIGXCPU").unwrap();
    let val_sigxcpu = v8::Integer::new(scope, 24);
    signals_obj.set(scope, key_sigxcpu.into(), val_sigxcpu.into());
    let key_sigxfsz = v8::String::new(scope, "SIGXFSZ").unwrap();
    let val_sigxfsz = v8::Integer::new(scope, 25);
    signals_obj.set(scope, key_sigxfsz.into(), val_sigxfsz.into());
    let key_sigvtalrm = v8::String::new(scope, "SIGVTALRM").unwrap();
    let val_sigvtalrm = v8::Integer::new(scope, 26);
    signals_obj.set(scope, key_sigvtalrm.into(), val_sigvtalrm.into());
    let key_sigprof = v8::String::new(scope, "SIGPROF").unwrap();
    let val_sigprof = v8::Integer::new(scope, 27);
    signals_obj.set(scope, key_sigprof.into(), val_sigprof.into());
    let key_sigwinch = v8::String::new(scope, "SIGWINCH").unwrap();
    let val_sigwinch = v8::Integer::new(scope, 28);
    signals_obj.set(scope, key_sigwinch.into(), val_sigwinch.into());
    let key_sigio = v8::String::new(scope, "SIGIO").unwrap();
    let val_sigio = v8::Integer::new(scope, 29);
    signals_obj.set(scope, key_sigio.into(), val_sigio.into());
    let key_sigpoll = v8::String::new(scope, "SIGPOLL").unwrap();
    let val_sigpoll = v8::Integer::new(scope, 29);
    signals_obj.set(scope, key_sigpoll.into(), val_sigpoll.into());
    let key_sigpwr = v8::String::new(scope, "SIGPWR").unwrap();
    let val_sigpwr = v8::Integer::new(scope, 30);
    signals_obj.set(scope, key_sigpwr.into(), val_sigpwr.into());
    let key_sigsys = v8::String::new(scope, "SIGSYS").unwrap();
    let val_sigsys = v8::Integer::new(scope, 31);
    signals_obj.set(scope, key_sigsys.into(), val_sigsys.into());
    let key_sigunused = v8::String::new(scope, "SIGUNUSED").unwrap();
    ...
    let key_eol = v8::String::new(scope, "EOL").unwrap();
    let val_eol = v8::String::new(scope, eol).unwrap();
    os_obj.set(scope, key_eol.into(), val_eol.into());

    // arch()的常量版本
    let arch_constants_obj = v8::Object::new(scope);
    let key_arm = v8::String::new(scope, "arm").unwrap();
    let val_arm = v8::String::new(scope, "arm").unwrap();
    arch_constants_obj.set(scope, key_arm.into(), val_arm.into());
    let key_arm64 = v8::String::new(scope, "arm64").unwrap();
    let val_arm64 = v8::String::new(scope, "arm64").unwrap();
    arch_constants_obj.set(scope, key_arm64.into(), val_arm64.into());
    let key_ia32 = v8::String::new(scope, "ia32").unwrap();
    let val_ia32 = v8::String::new(scope, "ia32").unwrap();
    arch_constants_obj.set(scope, key_ia32.into(), val_ia32.into());
    let key_mips = v8::String::new(scope, "mips").unwrap();
    let val_mips = v8::String::new(scope, "mips").unwrap();
    arch_constants_obj.set(scope, key_mips.into(), val_mips.into());
    let key_mipsel = v8::String::new(scope, "mipsel").unwrap();
    let val_mipsel = v8::String::new(scope, "mipsel").unwrap();
    arch_constants_obj.set(scope, key_mipsel.into(), val_mipsel.into());
    let key_ppc = v8::String::new(scope, "ppc").unwrap();
    let val_ppc = v8::String::new(scope, "ppc").unwrap();
    arch_constants_obj.set(scope, key_ppc.into(), val_ppc.into());
    let key_ppc64 = v8::String::new(scope, "ppc64").unwrap();
    let val_ppc64 = v8::String::new(scope, "ppc64").unwrap();
    arch_constants_obj.set(scope, key_ppc64.into(), val_ppc64.into());
    let key_riscv64 = v8::String::new(scope, "riscv64").unwrap();
    let val_riscv64 = v8::String::new(scope, "riscv64").unwrap();
    arch_constants_obj.set(scope, key_riscv64.into(), val_riscv64.into());
    let key_s390 = v8::String::new(scope, "s390").unwrap();
    let val_s390 = v8::String::new(scope, "s390").unwrap();
    arch_constants_obj.set(scope, key_s390.into(), val_s390.into());
    let key_s390x = v8::String::new(scope, "s390x").unwrap();
    let val_s390x = v8::String::new(scope, "s390x").unwrap();
    arch_constants_obj.set(scope, key_s390x.into(), val_s390x.into());
    let key_x64 = v8::String::new(scope, "x64").unwrap();
    let val_x64 = v8::String::new(scope, "x64").unwrap();
    arch_constants_obj.set(scope, key_x64.into(), val_x64.into());
    let key_x86 = v8::String::new(scope, "x86").unwrap();
    ...
    let key_aix = v8::String::new(scope, "aix").unwrap();
    let val_aix = v8::String::new(scope, "aix").unwrap();
    platform_constants_obj.set(scope, key_aix.into(), val_aix.into());
    let key_darwin = v8::String::new(scope, "darwin").unwrap();
    let val_darwin = v8::String::new(scope, "darwin").unwrap();
    platform_constants_obj.set(scope, key_darwin.into(), val_darwin.into());
    let key_freebsd = v8::String::new(scope, "freebsd").unwrap();
    let val_freebsd = v8::String::new(scope, "freebsd").unwrap();
    platform_constants_obj.set(scope, key_freebsd.into(), val_freebsd.into());
    let key_linux = v8::String::new(scope, "linux").unwrap();
    let val_linux = v8::String::new(scope, "linux").unwrap();
    platform_constants_obj.set(scope, key_linux.into(), val_linux.into());
    let key_openbsd = v8::String::new(scope, "openbsd").unwrap();
    let val_openbsd = v8::String::new(scope, "openbsd").unwrap();
    platform_constants_obj.set(scope, key_openbsd.into(), val_openbsd.into());
    let key_sunos = v8::String::new(scope, "sunos").unwrap();
    let val_sunos = v8::String::new(scope, "sunos").unwrap();
    platform_constants_obj.set(scope, key_sunos.into(), val_sunos.into());
    let key_win32 = v8::String::new(scope, "win32").unwrap();
    let val_win32 = v8::String::new(scope, "win32").unwrap();
    platform_constants_obj.set(scope, key_win32.into(), val_win32.into());
    let key_android = v8::String::new(scope, "android").unwrap();
    let val_android = v8::String::new(scope, "android").unwrap();
    platform_constants_obj.set(scope, key_android.into(), val_android.into());
    let key_cygwin = v8::String::new(scope, "cygwin").unwrap();
    let val_cygwin = v8::String::new(scope, "cygwin").unwrap();
    platform_constants_obj.set(scope, key_cygwin.into(), val_cygwin.into());
    let key_netbsd = v8::String::new(scope, "netbsd").unwrap();
...
fn os_cpus_callback(
    ...
    for i in 0..cpu_count {
        ...
        let key_user = v8::String::new(scope, "user").unwrap();
        let val_user = v8::Number::new(scope, 1000000.0);
        times_obj.set(scope, key_user.into(), val_user.into());
        let key_nice = v8::String::new(scope, "nice").unwrap();
        let val_nice = v8::Number::new(scope, 0.0);
        times_obj.set(scope, key_nice.into(), val_nice.into());
        let key_sys = v8::String::new(scope, "sys").unwrap();
        let val_sys = v8::Number::new(scope, 500000.0);
        times_obj.set(scope, key_sys.into(), val_sys.into());
        let key_idle = v8::String::new(scope, "idle").unwrap();
        let val_idle = v8::Number::new(scope, 8000000.0);
        times_obj.set(scope, key_idle.into(), val_idle.into());
        let key_irq = v8::String::new(scope, "irq").unwrap();
...
fn os_network_interfaces_callback(
    ...
    let key_address = v8::String::new(scope, "address").unwrap();
    let val_address = v8::String::new(scope, "127.0.0.1").unwrap();
    loopback_obj.set(scope, key_address.into(), val_address.into());
    let key_netmask = v8::String::new(scope, "netmask").unwrap();
    let val_netmask = v8::String::new(scope, "255.0.0.0").unwrap();
    loopback_obj.set(scope, key_netmask.into(), val_netmask.into());
    let key_family = v8::String::new(scope, "family").unwrap();
    let val_family = v8::String::new(scope, "IPv4").unwrap();
    loopback_obj.set(scope, key_family.into(), val_family.into());
    let key_internal = v8::String::new(scope, "internal").unwrap();
    let val_internal = v8::Boolean::new(scope, true);
