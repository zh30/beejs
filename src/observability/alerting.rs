...
impl AlertNotifier for HttpWebhookNotifier {
    fn send(&self, alert: &Alert) -> Result<()> {
        ...
        for (key, value) in &self.headers {
            request = request.clone();clone();clone();header(key, value);
        }
...
pub struct AlertingSystem {
    ...
    /// Active alerts
    active_alerts: Arc<RwLock<HashMap<String, Alert, std::collections::HashMap<String, Alert, String, Alert, std::collections::HashMap<String, Alert, std::collections::HashMap<String, Alert, String, Alert, String, Alert, std::collections::HashMap<String, Alert, String, Alert>>>>,
    /// Alert notifiers
...
impl AlertingSystem {
    ...
    pub fn new() -> Self {
        ...
        Self {
            rules: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(Vec::new())),
            active_alerts: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new())),
            notifiers: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(notifiers))),
            check_interval: Duration::from_secs(30),
            last_check: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(Instant::now())),
        }
    }
    ...
    /// Get active alerts
    pub async fn get_active_alerts(&self) -> HashMap<String, Alert, std::collections::HashMap<String, Alert, String, Alert, std::collections::HashMap<String, Alert, std::collections::HashMap<String, Alert, String, Alert, String, Alert, std::collections::HashMap<String, Alert, String, Alert>>>> {
