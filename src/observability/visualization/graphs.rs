...
"#,
    ...
    async fn apply_radial_layout(&mut self) -> Result<()> {
        ...
        let mut depth_groups: HashMap<u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode, u32, Vec<&GraphNode, std::collections::HashMap<u32, Vec<&GraphNode, u32, Vec<&GraphNode>>>>>>> = HashMap::new();
        for node in &self.nodes {
