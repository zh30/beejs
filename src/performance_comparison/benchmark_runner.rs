...
impl BenchmarkRunner {
    ...
    /// 运行所有基准测试
    pub async fn run_all(&mut self) -> Result<HashMap<String, PerformanceComparisonResult, std::collections::HashMap<String, PerformanceComparisonResult, String, PerformanceComparisonResult, std::collections::HashMap<String, PerformanceComparisonResult, std::collections::HashMap<String, PerformanceComparisonResult, String, PerformanceComparisonResult, String, PerformanceComparisonResult, std::collections::HashMap<String, PerformanceComparisonResult, String, PerformanceComparisonResult>>>> {
    ...
    ) -> HashMap<String, Duration, std::collections::HashMap<String, Duration, String, Duration, std::collections::HashMap<String, Duration, std::collections::HashMap<String, Duration, String, Duration, String, Duration, std::collections::HashMap<String, Duration, String, Duration>>>> {
    ...
    fn create_memory_usage_comparison(
        ...
        nodejs_result: &Option<BenchmarkResult>,
        bun_result: &Option<BenchmarkResult>,
    ) -> HashMap<String, usize, std::collections::HashMap<String, usize, String, usize, std::collections::HashMap<String, usize, std::collections::HashMap<String, usize, String, usize, String, usize, std::collections::HashMap<String, usize, String, usize>>>> {
        let mut comparison = HashMap::new();
