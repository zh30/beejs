...
pub struct PerformanceComparisonResult {
    ...
    pub execution_time_comparison: HashMap<String, Duration, std::collections::HashMap<String, Duration, String, Duration, std::collections::HashMap<String, Duration, std::collections::HashMap<String, Duration, String, Duration, String, Duration, std::collections::HashMap<String, Duration, String, Duration>>>>,
    pub memory_usage_comparison: HashMap<String, usize, std::collections::HashMap<String, usize, String, usize, std::collections::HashMap<String, usize, std::collections::HashMap<String, usize, String, usize, String, usize, std::collections::HashMap<String, usize, String, usize>>>>,
}
