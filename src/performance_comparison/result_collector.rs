...
pub struct ResultCollector {
    results: HashMap<String, BenchmarkComparison, std::collections::HashMap<String, BenchmarkComparison, String, BenchmarkComparison, std::collections::HashMap<String, BenchmarkComparison, std::collections::HashMap<String, BenchmarkComparison, String, BenchmarkComparison, String, BenchmarkComparison, std::collections::HashMap<String, BenchmarkComparison, String, BenchmarkComparison>>>>,
