...
pub struct WASMRuntime {
    engine: Arc<Engine>,
    modules: Arc<RwLock<HashMap<String, WASMModule, std::collections::HashMap<String, WASMModule, String, WASMModule, std::collections::HashMap<String, WASMModule, std::collections::HashMap<String, WASMModule, String, WASMModule, String, WASMModule, std::collections::HashMap<String, WASMModule, String, WASMModule>>>>,
...
impl WASMRuntime {
    ...
    pub fn new(bee_api: Arc<dyn BeeWasmAPI>) -> Result<Self> {
        let engine: _ = Arc::new(std::sync::Mutex::new(Mutex::new(Engine::default()));
        let modules: _ = Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new()));
        let host_functions: _ = Arc::new(std::sync::Mutex::new(Mutex::new(HostFunctions { bee_api })));
...
impl JS2WASMCompiler {
    ...
    pub fn new() -> Result<Self> {
        Ok(JS2WASMCompiler {
            engine: Arc::new(std::sync::Mutex::new(Mutex::new(Engine::default())),
        })
    }
