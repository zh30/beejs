...
pub struct PluginMarket {
    plugins: HashMap<String, PluginInfo, std::collections::HashMap<String, PluginInfo, String, PluginInfo, std::collections::HashMap<String, PluginInfo, std::collections::HashMap<String, PluginInfo, String, PluginInfo, String, PluginInfo, std::collections::HashMap<String, PluginInfo, String, PluginInfo>>>>,
}
