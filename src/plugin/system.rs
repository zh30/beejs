...
pub struct JsPlugin {
    ...
    state: PluginState,
    code: String,
    exports: HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String>>>>,
}
...
pub struct PluginManager {
    plugins: Arc<Mutex<HashMap<String, Arc<dyn Plugin, std::collections::HashMap<String, Arc<dyn Plugin, String, Arc<dyn Plugin, std::collections::HashMap<String, Arc<dyn Plugin, std::collections::HashMap<String, Arc<dyn Plugin, String, Arc<dyn Plugin, String, Arc<dyn Plugin, std::collections::HashMap<String, Arc<dyn Plugin, String, Arc<dyn Plugin>>>>>,
...
impl PluginManager {
    ...
    pub fn register_js_plugin(&self, plugin: JsPlugin) -> Result<()> {
        let name: _ = plugin.metadata().name.clone();
        let arc_plugin: Arc<dyn Plugin> = Arc::new(std::sync::Mutex::new(Mutex::new(plugin)));
