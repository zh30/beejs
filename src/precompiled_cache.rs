...
pub struct PrecompiledModuleCache {
    ...
    cache_dir: PathBuf,
    /// 内存缓存的模块
    modules: Arc<Mutex<HashMap<String, PrecompiledModuleEntry, std::collections::HashMap<String, PrecompiledModuleEntry, String, PrecompiledModuleEntry, std::collections::HashMap<String, PrecompiledModuleEntry, std::collections::HashMap<String, PrecompiledModuleEntry, String, PrecompiledModuleEntry, String, PrecompiledModuleEntry, std::collections::HashMap<String, PrecompiledModuleEntry, String, PrecompiledModuleEntry>>>>,
    /// 统计信息
...
impl PrecompiledModuleCache {
    ...
    pub fn new_with_path(cache_dir: PathBuf) -> Result<Self> {
        ...
        Ok(Self {
            ...
            bytecode_cache: Arc::new(std::sync::Mutex::new(Mutex::new(BytecodeCache::new(cache_config))),
        })
    }
