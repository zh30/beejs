...
pub struct Profiler {
    mode: ProfilingMode,
    active_profiles: HashMap<u64, ProfileData, std::collections::HashMap<u64, ProfileData, u64, ProfileData, std::collections::HashMap<u64, ProfileData, std::collections::HashMap<u64, ProfileData, u64, ProfileData, u64, ProfileData, std::collections::HashMap<u64, ProfileData, u64, ProfileData>>>>,
...
pub struct ProfilingStats {
    ...
    pub profiles_by_target: HashMap<ProfileTarget, u64, std::collections::HashMap<ProfileTarget, u64, ProfileTarget, u64, std::collections::HashMap<ProfileTarget, u64, std::collections::HashMap<ProfileTarget, u64, ProfileTarget, u64, ProfileTarget, u64, std::collections::HashMap<ProfileTarget, u64, ProfileTarget, u64>>>>,
}
...
impl Profiler {
    ...
    pub fn new(mode: ProfilingMode) -> Result<Self, String> {
        Ok(Self {
            ...
            stats: Arc::new(std::sync::Mutex::new(Mutex::new(ProfilingStats::default())),
        })
    }
