...
impl CircuitResult {
    ...
    /// 获取所有概率分布
    pub fn probability_distribution(&self) -> HashMap<Vec<u8, std::collections::HashMap<Vec<u8, Vec<u8, std::collections::HashMap<Vec<u8, std::collections::HashMap<Vec<u8, Vec<u8, Vec<u8, std::collections::HashMap<Vec<u8, Vec<u8>>>, f64> {
