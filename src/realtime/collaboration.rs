...
impl CollaborationSession {
    pub fn new(session_id: String, document_id: String) -> Self {
        ...
        Self {
            session_id,
            document_id,
            participants: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new()))))),
            operations: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(Vec::new()))))),
            version: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(AtomicU64::new(0)))))),
        }
    }
