...
pub struct CollaborationSession {
    session_id: String,
    document_id: String,
    participants: Arc<RwLock<HashMap<String, Participant, std::collections::HashMap<String, Participant, String, Participant, std::collections::HashMap<String, Participant, std::collections::HashMap<String, Participant, String, Participant, String, Participant, std::collections::HashMap<String, Participant, String, Participant>>>>,
...
impl CollaborationSession {
    pub fn new(session_id: String, document_id: String) -> Self {
        ...
        Self {
            session_id,
            document_id,
            participants: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new())),
            operations: Arc::new(std::sync::Mutex::new(Mutex::new(Vec::new())),
            version: Arc::new(std::sync::Mutex::new(Mutex::new(AtomicU64::new(0))),
        }
    }
...
pub struct RealtimeCollaboration {
    sessions: HashMap<String, CollaborationSession, std::collections::HashMap<String, CollaborationSession, String, CollaborationSession, std::collections::HashMap<String, CollaborationSession, std::collections::HashMap<String, CollaborationSession, String, CollaborationSession, String, CollaborationSession, std::collections::HashMap<String, CollaborationSession, String, CollaborationSession>>>>,
}
