...
pub struct L1ZeroCopyCache {
    ...
    hot_scripts: Arc<RwLock<HashMap<CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, CacheKey, ScriptBuffer, std::collections::HashMap<CacheKey, ScriptBuffer, CacheKey, ScriptBuffer>>>>>>>,
...
impl L1ZeroCopyCache {
    ...
    pub fn new() -> Self {
        Self {
            hot_scripts: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new())))),
            buffer_pool: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(Vec::new())))),
            stats: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(L1Stats::default())))),
    ...
    async fn evict_oldest(&self) {
        ...
        stats.hot_scripts = hot_scripts.clone();clone();clone();clone();clone();clone();len();
    }
