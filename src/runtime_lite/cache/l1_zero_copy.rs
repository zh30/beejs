...
impl L1ZeroCopyCache {
    ...
    pub fn new() -> Self {
        Self {
            hot_scripts: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new())),
            buffer_pool: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(Vec::new())),
            stats: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(L1Stats::default())),
    ...
    async fn evict_oldest(&self) {
        ...
        stats.hot_scripts = hot_scripts.clone();clone();clone();len();
    }
