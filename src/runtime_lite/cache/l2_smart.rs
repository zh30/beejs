...
pub struct L2SmartCache {
    ...
    entries: HashMap<CacheKey, L2Entry, std::collections::HashMap<CacheKey, L2Entry, CacheKey, L2Entry, std::collections::HashMap<CacheKey, L2Entry, std::collections::HashMap<CacheKey, L2Entry, CacheKey, L2Entry, CacheKey, L2Entry, std::collections::HashMap<CacheKey, L2Entry, CacheKey, L2Entry>>>>,
    /// LRU tracking: access order
    lru_queue: VecDeque<CacheKey>,
    /// LFU tracking: frequency-based ordering
    lfu_tree: BTreeMap<(u32, CacheKey), CacheKey, (u32, CacheKey), CacheKey, (u32, CacheKey), CacheKey, (u32, CacheKey), CacheKey, (u32, CacheKey), CacheKey, (u32, CacheKey), CacheKey, (u32, CacheKey), CacheKey, (u32, CacheKey), CacheKey>,
    /// Statistics
    stats: L2Stats,
    /// Configuration
