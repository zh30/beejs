...
impl L3MmapCache {
    ...
    pub fn new() -> Self {
        ...
        Self {
            entries: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new()))))),
            stats: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(L3Stats::default()))))),
            cache_dir,
