...
pub struct L3MmapCache {
    ...
    entries: Arc<RwLock<HashMap<String, L3Entry, std::collections::HashMap<String, L3Entry, String, L3Entry, std::collections::HashMap<String, L3Entry, std::collections::HashMap<String, L3Entry, String, L3Entry, String, L3Entry, std::collections::HashMap<String, L3Entry, String, L3Entry>>>>,
    /// Statistics
...
impl L3MmapCache {
    ...
    pub fn new() -> Self {
        ...
        Self {
            entries: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new())),
            stats: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(L3Stats::default())),
            cache_dir,
