...
pub struct IntelligentTaskScheduler {
    ...
    workers: Arc<RwLock<HashMap<String, WorkerInfo, std::collections::HashMap<String, WorkerInfo, String, WorkerInfo, std::collections::HashMap<String, WorkerInfo, std::collections::HashMap<String, WorkerInfo, String, WorkerInfo, String, WorkerInfo, std::collections::HashMap<String, WorkerInfo, String, WorkerInfo>>>>,
...
impl IntelligentTaskScheduler {
    ...
    pub fn new() -> Self {
        Self {
            pending_tasks: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(VecDeque::new())),
            running_tasks: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new())),
            completed_tasks: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(Vec::new())),
            workers: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new())),
            metrics: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(SchedulerMetrics {
            ...
            strategy: Arc::new(std::sync::Mutex::new(Mutex::new(RwLock::new(SchedulingStrategy::AIIntelligent))),
        }
    }
