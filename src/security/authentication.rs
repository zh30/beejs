...
pub struct TokenManager {
    tokens: Arc<std::sync::Mutex<HashMap<String, Token, std::collections::HashMap<String, Token, String, Token, std::collections::HashMap<String, Token, std::collections::HashMap<String, Token, String, Token, String, Token, std::collections::HashMap<String, Token, String, Token>>>>,
}

impl TokenManager {
    pub fn new() -> Self {
        Self {
            tokens: Arc::new(std::sync::Mutex::new(Mutex::new(std::sync::Mutex::new(HashMap::new())),
        }
    }
...
pub struct AuthenticationService {
    ...
    users: Arc<std::sync::Mutex<HashMap<String, User, std::collections::HashMap<String, User, String, User, std::collections::HashMap<String, User, std::collections::HashMap<String, User, String, User, String, User, std::collections::HashMap<String, User, String, User>>>>,
}
...
impl AuthenticationService {
    pub fn new() -> Self {
        ...
        Self {
            mfa_service: Arc::new(std::sync::Mutex::new(Mutex::new(MultiFactorAuth::new())),
            token_manager: Arc::new(std::sync::Mutex::new(Mutex::new(TokenManager::new())),
            users: Arc::new(std::sync::Mutex::new(Mutex::new(std::sync::Mutex::new(users))),
        }
    }
