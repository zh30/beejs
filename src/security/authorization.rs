...
impl RoleManager {
    pub fn new() -> Self {
        Self {
            user_roles: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(std::sync::Mutex::new(HashMap::new()))))),
        }
    }
...
impl AuthorizationService {
    pub fn new() -> Self {
        Self {
            ...
            role_manager: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RoleManager::new()))))),
        }
    }
