...
pub struct RoleManager {
    user_roles: Arc<std::sync::Mutex<HashMap<UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role, UserId, Vec<Role, std::collections::HashMap<UserId, Vec<Role, UserId, Vec<Role>>>>>>>>,
}

impl RoleManager {
    pub fn new() -> Self {
        Self {
            user_roles: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(std::sync::Mutex::new(HashMap::new())))),
        }
    }
...
impl AuthorizationService {
    pub fn new() -> Self {
        Self {
            ...
            role_manager: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(RoleManager::new())))),
        }
    }
