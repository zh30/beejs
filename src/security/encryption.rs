...
impl KeyManager {
    pub fn new() -> Self {
        ...
        Self {
            keys: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(std::sync::Mutex::new(keys)))))),
            active_key_id: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(std::sync::Mutex::new(key_id)))))),
        }
    }
...
impl EncryptionEngine {
    pub fn new() -> Self {
        Self {
            key_manager: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(KeyManager::new()))))),
        }
    }
