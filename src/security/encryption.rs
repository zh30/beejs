...
pub struct KeyManager {
    keys: Arc<std::sync::Mutex<std::collections::HashMap<String, CryptoKey, std::collections::HashMap<String, CryptoKey, String, CryptoKey, std::collections::HashMap<String, CryptoKey, std::collections::HashMap<String, CryptoKey, String, CryptoKey, String, CryptoKey, std::collections::HashMap<String, CryptoKey, String, CryptoKey>>>>,
...
impl KeyManager {
    pub fn new() -> Self {
        ...
        Self {
            keys: Arc::new(std::sync::Mutex::new(Mutex::new(std::sync::Mutex::new(keys))),
            active_key_id: Arc::new(std::sync::Mutex::new(Mutex::new(std::sync::Mutex::new(key_id))),
        }
    }
...
impl EncryptionEngine {
    pub fn new() -> Self {
        Self {
            key_manager: Arc::new(std::sync::Mutex::new(Mutex::new(KeyManager::new())),
        }
    }
