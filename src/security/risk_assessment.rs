...
pub struct RiskAssessor {
    factors: HashMap<String, RiskFactor, std::collections::HashMap<String, RiskFactor, String, RiskFactor, std::collections::HashMap<String, RiskFactor, std::collections::HashMap<String, RiskFactor, String, RiskFactor, String, RiskFactor, std::collections::HashMap<String, RiskFactor, String, RiskFactor>>>>,
}
