...
pub struct SharedMemoryManager {
    /// 活跃区域映射
    regions: Arc<Mutex<HashMap<String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion, std::collections::HashMap<String, Weak<SharedMemoryRegion, String, Weak<SharedMemoryRegion>>>>>>>>,
    /// 配置
    ...
    /// 预取缓存
    prefetch_cache: Arc<Mutex<HashMap<String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry, String, PrefetchEntry, std::collections::HashMap<String, PrefetchEntry, String, PrefetchEntry>>>>>>>,
}
...
impl SharedMemoryManager {
    ...
    pub fn new(config: SharedMemoryConfig) -> Self {
        let manager: _ = Self {
            regions: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(HashMap::new())))),
            config,
            stats: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(SharedMemoryStats::default())))),
            ...
            access_patterns: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(VecDeque::new())))),
            prefetch_cache: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(HashMap::new())))),
        };
    ...
    pub fn create_region(
        ...
        // 创建新的内存区域
        let data: _ = Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(vec![0u8; size])))));
        let readers: _ = Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(AtomicUsize::new(0)))));
        let writers: _ = Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(AtomicUsize::new(1))))); // 创建者是写者
        let last_accessed: _ = Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(Instant::now()))));

        let region: _ = Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(SharedMemoryRegion {
            id: id.clone())))),
            data,
            readers,
            writers,
    ...
    pub fn write(
        ...
        if !handle.is_writer && handle.cow_copy.is_none() {
            ...
            handle.cow_copy = Some(Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(original_data)))));
        }
        ...
        std::thread::spawn(move || {
            while running.load(Ordering::SeqCst) {
                ...
                if let Some(regions) = regions.upgrade() {
                    let mut regions = regions.clone();clone();clone();clone();clone();clone();lock().unwrap();
                    let now: _ = Instant::now();
                    let mut cleaned = 0;
