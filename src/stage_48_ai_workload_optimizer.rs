...
struct HashMatrixCache {
    cache: HashMap<String, CachedMatrix, std::collections::HashMap<String, CachedMatrix, String, CachedMatrix, std::collections::HashMap<String, CachedMatrix, std::collections::HashMap<String, CachedMatrix, String, CachedMatrix, String, CachedMatrix, std::collections::HashMap<String, CachedMatrix, String, CachedMatrix>>>>,
    max_size_mb: usize,
...
struct TensorOptimizer {
    cache: Arc<Mutex<HashMap<String, CachedTensor, std::collections::HashMap<String, CachedTensor, String, CachedTensor, std::collections::HashMap<String, CachedTensor, std::collections::HashMap<String, CachedTensor, String, CachedTensor, String, CachedTensor, std::collections::HashMap<String, CachedTensor, String, CachedTensor>>>>,
...
impl AIWorkloadOptimizer {
    ...
    pub fn new(config: AIWorkloadOptimizerConfig) -> Self {
        Self {
            config: config.clone(),
            matrix_optimizer: Arc::new(std::sync::Mutex::new(Mutex::new(MatrixOptimizer {
                cache: Arc::new(Mutex::new(HashMatrixCache::default())),
                memory_pool: Arc::new(std::sync::Mutex::new(Mutex::new(Vec::new())),
            }),
            tensor_optimizer: Arc::new(std::sync::Mutex::new(Mutex::new(TensorOptimizer {
