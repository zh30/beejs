...
impl MemoryPreallocator {
    ...
    pub fn new(prealloc_size: usize) -> Self {
        Self {
            prealloc_size,
            stats: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(MemoryStats::new()))))),
...
impl JITPrecompiler {
    ...
    pub fn new() -> Self {
        Self {
            stats: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(JITStats::new()))))),
            created_at: SystemTime::now(),
