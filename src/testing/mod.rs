...
static TEST_REGISTRY: OnceLock<Mutex<HashMap<String, TestSuite, std::collections::HashMap<String, TestSuite, String, TestSuite, std::collections::HashMap<String, TestSuite, std::collections::HashMap<String, TestSuite, String, TestSuite, String, TestSuite, std::collections::HashMap<String, TestSuite, String, TestSuite>>>> = OnceLock::new();
...
pub fn get_all_suites() -> HashMap<String, TestSuite, std::collections::HashMap<String, TestSuite, String, TestSuite, std::collections::HashMap<String, TestSuite, std::collections::HashMap<String, TestSuite, String, TestSuite, String, TestSuite, std::collections::HashMap<String, TestSuite, String, TestSuite>>>> {
    let registry: _ = TEST_REGISTRY.get_or_init(|| Mutex::new(HashMap::new());
