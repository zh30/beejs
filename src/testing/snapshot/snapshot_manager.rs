...
pub struct SnapshotManager {
    ...
    snapshots_cache: HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String>>>>,
}
...
impl SnapshotManager {
    ...
    pub fn update_all_snapshots(&mut self, values: HashMap<String, &dyn std::fmt::Display, std::collections::HashMap<String, &dyn std::fmt::Display, String, &dyn std::fmt::Display, std::collections::HashMap<String, &dyn std::fmt::Display, std::collections::HashMap<String, &dyn std::fmt::Display, String, &dyn std::fmt::Display, String, &dyn std::fmt::Display, std::collections::HashMap<String, &dyn std::fmt::Display, String, &dyn std::fmt::Display>>>>) -> Result<(), SnapshotError> {
