...
pub enum ASTNode {
    ...
    InterfaceDeclaration {
        name: String,
        properties: HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String>>>>,
    },
    EnumDeclaration {
        name: String,
        ...
        loop {
            match self.current_token() {
                ...
                Token::LParen => {
                    // 处理分组表达式 (a + b)
                    self.advance();
                    let inner_expr: _ = self.parse_expression()?;
                    self.consume(Token::RParen)?;
                    expr = inner_expr;
                }
                Token::LBracket => {
