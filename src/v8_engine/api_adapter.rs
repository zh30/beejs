...
impl V8APIAdapter {
    ...
    pub fn new(config: AdapterConfig) -> Self {
        let mut adapter = Self {
            config,
            adapters: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(HashMap::new()))))),
            stats: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(AdaptationStats {
                total_adapters: 0,
