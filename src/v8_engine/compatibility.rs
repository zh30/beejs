...
pub struct CompatibilityReport {
    ...
    pub api_map: HashMap<String, APICompatibilityInfo, std::collections::HashMap<String, APICompatibilityInfo, String, APICompatibilityInfo, std::collections::HashMap<String, APICompatibilityInfo, std::collections::HashMap<String, APICompatibilityInfo, String, APICompatibilityInfo, String, APICompatibilityInfo, std::collections::HashMap<String, APICompatibilityInfo, String, APICompatibilityInfo>>>>,
...
pub struct APIUsageReport {
    ...
    pub usage_count: HashMap<String, usize, std::collections::HashMap<String, usize, String, usize, std::collections::HashMap<String, usize, std::collections::HashMap<String, usize, String, usize, String, usize, std::collections::HashMap<String, usize, String, usize>>>>,
}
