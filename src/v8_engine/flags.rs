...
pub struct V8ConfigManager {
    ...
    configs: HashMap<String, V8EngineFlags, std::collections::HashMap<String, V8EngineFlags, String, V8EngineFlags, std::collections::HashMap<String, V8EngineFlags, std::collections::HashMap<String, V8EngineFlags, String, V8EngineFlags, String, V8EngineFlags, std::collections::HashMap<String, V8EngineFlags, String, V8EngineFlags>>>>,
}
