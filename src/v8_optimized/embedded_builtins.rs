...
impl EmbeddedBuiltinsManager {
    ...
    pub fn new() -> Self {
        let mut manager = Self {
            string_interner: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(StringInterner::new()))))),
            stats: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(BuiltinStats::new()))))),
