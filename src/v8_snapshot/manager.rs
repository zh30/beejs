...
pub struct SnapshotManager {
    /// 快照缓存
    pub snapshot_cache: Arc<Mutex<std::collections::BTreeMap<String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot, String, V8Snapshot>>,
    /// 快照配置
...
impl SnapshotManager {
    ...
    pub fn new(config: SnapshotConfig) -> Self {
        ...
        Self {
            snapshot_cache: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(cache))))),
            config,
            stats: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(SnapshotStats::new())))),
