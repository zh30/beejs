...
struct FunctionCache {
    /// 函数缓存映射
    cache: HashMap<String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction, String, CachedFunction, std::collections::HashMap<String, CachedFunction, String, CachedFunction>>>>>>>,
    /// 缓存大小限制
...
impl Default for CallStats {
    fn default() -> Self {
        Self {
            total_calls: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(std::sync::atomic::AtomicUsize::new(0))))),
            successful_calls: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(std::sync::atomic::AtomicUsize::new(0))))),
            failed_calls: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(std::sync::atomic::AtomicUsize::new(0))))),
            total_duration: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(std::sync::atomic::AtomicU64::new(0))))),
            zero_copy_calls: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(std::sync::atomic::AtomicUsize::new(0))))),
            batch_calls: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(std::sync::atomic::AtomicUsize::new(0))))),
        }
    }
}
...
impl JsWasmInterop {
    ...
    pub fn new() -> Self {
        JsWasmInterop {
            function_cache: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(FunctionCache::default())))),
            call_stats: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(CallStats::default())))),
    ...
    pub async fn call_wasm_function_async(
        ...
        let interop: _ = Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(self.clone()))));
