...
pub enum JsValue {
    ...
    Array(Vec<JsValue>),
    /// 对象
    Object(HashMap<String, JsValue, std::collections::HashMap<String, JsValue, String, JsValue, std::collections::HashMap<String, JsValue, std::collections::HashMap<String, JsValue, String, JsValue, String, JsValue, std::collections::HashMap<String, JsValue, String, JsValue>>>>),
    /// 空值
    Null,
    /// 未定义
    Undefined,
...
impl Default for CallStats {
    fn default() -> Self {
        Self {
            total_calls: Arc::new(std::sync::Mutex::new(Mutex::new(std::sync::atomic::AtomicUsize::new(0))),
            successful_calls: Arc::new(std::sync::Mutex::new(Mutex::new(std::sync::atomic::AtomicUsize::new(0))),
            failed_calls: Arc::new(std::sync::Mutex::new(Mutex::new(std::sync::atomic::AtomicUsize::new(0))),
            total_duration: Arc::new(std::sync::Mutex::new(Mutex::new(std::sync::atomic::AtomicU64::new(0))),
            zero_copy_calls: Arc::new(std::sync::Mutex::new(Mutex::new(std::sync::atomic::AtomicUsize::new(0))),
            batch_calls: Arc::new(std::sync::Mutex::new(Mutex::new(std::sync::atomic::AtomicUsize::new(0))),
        }
    }
}
...
impl JsWasmInterop {
    ...
    pub fn new() -> Self {
        JsWasmInterop {
            ...
            call_stats: Arc::new(std::sync::Mutex::new(Mutex::new(CallStats::default())),
    ...
    pub async fn call_wasm_function_async(
        ...
        let interop: _ = Arc::new(std::sync::Mutex::new(Mutex::new(self.clone()));
