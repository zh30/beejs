...
pub struct WasmMemoryManager {
    ...
    /// 大块内存分配器
    large_allocator: Arc<Mutex<HashMap<usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock, usize, MemoryBlock, std::collections::HashMap<usize, MemoryBlock, usize, MemoryBlock>>>>>>>,
    /// 内存统计
...
impl WasmMemoryManager {
    ...
    pub fn new(pool_size: usize) -> Result<Self> {
        ...
        Ok(WasmMemoryManager {
            memory_pool: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(memory_pool))))),
            large_allocator: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(HashMap::new())))),
            stats: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(MemoryStats::default())))),
...
use std::collections::{HashMap, BTreeMap};
    ...
    fn test_memory_allocation() {
        let manager: _ = Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(WasmMemoryManager::new(1024 * 1024))))).unwrap());
