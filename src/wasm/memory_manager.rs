...
impl WasmMemoryManager {
    ...
    pub fn new(pool_size: usize) -> Result<Self> {
        ...
        Ok(WasmMemoryManager {
            memory_pool: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(memory_pool)))))),
            large_allocator: Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(HashMap::new()))))),
...
use std::collections::{HashMap, BTreeMap};
    ...
    fn test_memory_allocation() {
        let manager: _ = Arc::new(Mutex::new(Mutex::new(std::sync::Mutex::new(Mutex::new(WasmMemoryManager::new(1024 * 1024)))))).unwrap());
