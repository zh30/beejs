...
impl SharedMemoryRegion {
    ...
    pub fn new(size: usize) -> Self {
        ...
        Self {
            data: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(vec![0u8; aligned_size]))))),
            size: aligned_size,
            alignment: page_size,
        }
    }
...
impl WasmThreadsManager {
    ...
    pub fn new(config: ThreadPoolConfig) -> Self {
        Self {
            ...
            stats: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(ManagerStats::new())))),
        ...
        T: Send + 'static,
    {
        ...
        let cancelled: _ = Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(AtomicBool::new(false)))));
