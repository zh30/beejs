...
impl WasmCacheManager {
    ...
    pub fn new(config: CacheConfig) -> Result<Self> {
        ...
        let cache: _ = Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(LruCache::new(NonZero::new(config.max_size))))).unwrap_or(NonZero::new(100).unwrap());
        ...
        let manager: _ = Self {
            ...
            config,
            statistics: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(RwLock::new(CacheStatistics {
                total_entries: 0,
                hits: 0,
                misses: 0,
                evictions: 0,
