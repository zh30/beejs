...
pub struct WasmOptimizedExecutor {
    engine: Arc<Engine>,
    compiled_modules: Arc<std::sync::Mutex<HashMap<String, Module, std::collections::HashMap<String, Module, String, Module, std::collections::HashMap<String, Module, std::collections::HashMap<String, Module, String, Module, String, Module, std::collections::HashMap<String, Module, String, Module>>>>,
    module_metadata: Arc<std::sync::Mutex<HashMap<String, WasmModuleMetadata, std::collections::HashMap<String, WasmModuleMetadata, String, WasmModuleMetadata, std::collections::HashMap<String, WasmModuleMetadata, std::collections::HashMap<String, WasmModuleMetadata, String, WasmModuleMetadata, String, WasmModuleMetadata, std::collections::HashMap<String, WasmModuleMetadata, String, WasmModuleMetadata>>>>,
    performance_stats: Arc<std::sync::Mutex<HashMap<String, WasmExecutionResult, std::collections::HashMap<String, WasmExecutionResult, String, WasmExecutionResult, std::collections::HashMap<String, WasmExecutionResult, std::collections::HashMap<String, WasmExecutionResult, String, WasmExecutionResult, String, WasmExecutionResult, std::collections::HashMap<String, WasmExecutionResult, String, WasmExecutionResult>>>>,
}
...
impl WasmOptimizedExecutor {
    ...
    pub fn new() -> Result<Self> {
        ...
        let engine: _ = Arc::new(std::sync::Mutex::new(Mutex::new(Engine::new(&config)))?);

        Ok(Self {
            engine,
            compiled_modules: Arc::new(std::sync::Mutex::new(Mutex::new(std::sync::Mutex::new(HashMap::new())),
            module_metadata: Arc::new(std::sync::Mutex::new(Mutex::new(std::sync::Mutex::new(HashMap::new())),
            performance_stats: Arc::new(std::sync::Mutex::new(Mutex::new(std::sync::Mutex::new(HashMap::new())),
        })
    }
