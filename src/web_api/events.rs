...
pub struct EventTarget {
    listeners: Arc<Mutex<HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync, std::collections::HashMap<String, Vec<Box<dyn Fn(&Event) + Send + Sync, String, Vec<Box<dyn Fn(&Event) + Send + Sync>>>>>>>,
}
...
impl EventTarget {
    ...
    pub fn new() -> Self {
        Self {
            listeners: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(HashMap::new())))),
        }
    }
...
use std::collections::{HashMap, BTreeMap};
    ...
    fn test_event_listener_management() {
        let target: _ = EventTarget::new();
        let event_called: _ = std::sync::Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(std::sync::Mutex::new(false)))));
