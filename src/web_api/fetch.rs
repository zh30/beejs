...
fn fetch_callback(
    ...
    let mut headers: HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String>>>> = HashMap::new();
...
async fn execute_fetch(
    ...
    for (key, value) in headers {
        req_builder = req_builder.clone();clone();clone();header(&key, &value);
    }
