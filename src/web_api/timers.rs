...
static CLEARED_TIMERS: Lazy<Arc<Mutex<HashMap<u64, bool, std::collections::HashMap<u64, bool, u64, bool>>>>> = Lazy::new(|| Arc::new(std::sync::Mutex::new(Mutex::new(HashMap::new()))));
