...
pub struct WebSocketManager {
    connections: Arc<Mutex<HashMap<u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection, u64, WebSocketConnection, std::collections::HashMap<u64, WebSocketConnection, u64, WebSocketConnection>>>>>>>,
    next_id: AtomicU64,
    runtime: Arc<Runtime>,
}
...
impl WebSocketManager {
    pub fn new() -> Self {
        ...
        Self {
            connections: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(HashMap::new())))),
            next_id: AtomicU64::new(1),
            runtime: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(runtime))))),
        }
    }
    ...
    pub fn connect(&self, url: String) -> Result<u64> {
        ...
        let ready_state: _ = Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(ReadyState::Connecting)))));
        ...
        let connection: _ = WebSocketConnection {
            ...
            ready_state,
            cmd_tx,
            event_rx: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(event_rx))))),
        };
