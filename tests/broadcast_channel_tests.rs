...
mod broadcast_channel_tests {
    ...
    fn test_broadcast_channel_creation() {
        ...
        assert!(stdout.contains("channel name: test-channel"), "Expected channel name to be 'test-channel'. Got: {}", stdout);
    ...
    fn test_broadcast_channel_different_names() {
        ...
        let stdout = String::from_utf8_lossy(&output.stdout);
        assert!(stdout.contains("true"), "Expected channels with different names. Got: {}", stdout);
    }
    ...
    fn test_post_message() {
        ...
        let stdout = String::from_utf8_lossy(&output.stdout);
        assert!(stdout.contains("true"), "Expected message to be received. Got: {}", stdout);
    }
    ...
    fn test_post_message_object() {
        ...
        let stdout = String::from_utf8_lossy(&output.stdout);
        assert!(stdout.contains("true"), "Expected object message to be received. Got: {}", stdout);
    }
    ...
    fn test_post_message_array() {
        ...
        let stdout = String::from_utf8_lossy(&output.stdout);
        assert!(stdout.contains("true"), "Expected array message to be received. Got: {}", stdout);
    }
    ...
    fn test_add_event_listener() {
        ...
        let stdout = String::from_utf8_lossy(&output.stdout);
        assert!(stdout.contains("true"), "Expected message via addEventListener. Got: {}", stdout);
    }
    ...
    fn test_remove_event_listener() {
        ...
        let stdout = String::from_utf8_lossy(&output.stdout);
        assert!(stdout.contains("true"), "Expected removeEventListener API to exist. Got: {}", stdout);
    }
    ...
    fn test_close() {
        ...
        let stdout = String::from_utf8_lossy(&output.stdout);
        assert!(stdout.contains("true"), "Expected close to work without error. Got: {}", stdout);
    }
    ...
    fn test_message_event_origin() {
        ...
        let stdout = String::from_utf8_lossy(&output.stdout);
        assert!(stdout.contains("true"), "Expected message event to have origin. Got: {}", stdout);
    }
    ...
    fn test_message_event_data() {
        ...
        let stdout = String::from_utf8_lossy(&output.stdout);
        assert!(stdout.contains("true"), "Expected message event data to be correct. Got: {}", stdout);
    }
    ...
    fn test_empty_name_channel() {
        ...
        let stdout = String::from_utf8_lossy(&output.stdout);
        assert!(stdout.contains("true"), "Expected empty name to work. Got: {}", stdout);
    }
    ...
    fn test_unicode_name_channel() {
        ...
        let stdout = String::from_utf8_lossy(&output.stdout);
        assert!(stdout.contains("true"), "Expected unicode name to work. Got: {}", stdout);
    }
    ...
    fn test_multiple_channels_same_name() {
        ...
        let stdout = String::from_utf8_lossy(&output.stdout);
        assert!(stdout.contains("true"), "Expected each channel to work independently. Got: {}", stdout);
    }
}
