...
fn test_global_object_exists() {
    ...
    assert!(stdout.contains("object"), "global should be an object, got: {}", stdout);
}
...
fn test_global_equals_global_this() {
    ...
    let stdout = String::from_utf8_lossy(&output.stdout);
    assert!(stdout.contains("true"), "globalThis.global should equal globalThis, got: {}", stdout);
}
...
fn test_global_contains_all_globals() {
    ...
    let stdout = String::from_utf8_lossy(&output.stdout);
    assert!(stdout.contains("true"), "global should contain setTimeout, got: {}", stdout);
}
...
fn test_global_contains_process() {
    ...
    let stdout = String::from_utf8_lossy(&output.stdout);
    assert!(stdout.contains("true"), "global should contain process, got: {}", stdout);
}
...
fn test_global_contains_console() {
    ...
    let stdout = String::from_utf8_lossy(&output.stdout);
    assert!(stdout.contains("true"), "global should contain console, got: {}", stdout);
}
...
fn test_global_contains_buffer() {
    ...
    let stdout = String::from_utf8_lossy(&output.stdout);
    assert!(stdout.contains("true"), "global should contain Buffer, got: {}", stdout);
}
...
fn test_global_this_is_same_reference() {
    ...
    let stdout = String::from_utf8_lossy(&output.stdout);
    assert!(stdout.contains("true"), "Object.is(globalThis.global, globalThis) should be true, got: {}", stdout);
}
