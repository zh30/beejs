...
#[test]
#[serial]
fn test_readline_has_createInterface() {
    let mut runtime = beejs::runtime_minimal::MinimalRuntime::new().expect("Failed to create runtime");
    let code = r#"typeof global.readline.createInterface"#;
    let result = runtime.execute_code(code).expect("Execution failed");
    assert_eq!(result.trim(), "function", "readline.createInterface should be a function");
}
...
fn test_readline_require_returns_object() {
    ...
    "#;
    let result = runtime.execute_code(code).expect("Execution failed");
    assert_eq!(result.trim(), "object", "require('readline') should return an object");
}
...
fn test_readline_require_has_interface() {
    ...
    "#;
    let result = runtime.execute_code(code).expect("Execution failed");
    assert_eq!(result.trim(), "function", "require('readline').Interface should be a function");
}

#[test]
#[serial]
fn test_readline_require_has_createInterface() {
    let mut runtime = beejs::runtime_minimal::MinimalRuntime::new().expect("Failed to create runtime");
    let code = r#"
        const rl = require('readline');
    ...
    "#;
    let result = runtime.execute_code(code).expect("Execution failed");
    assert_eq!(result.trim(), "function", "require('readline').createInterface should be a function");
}
...
fn test_readline_require_default() {
    ...
    "#;
    let result = runtime.execute_code(code).expect("Execution failed");
    assert_eq!(result.trim(), "object", "require('readline').default should be an object");
}
