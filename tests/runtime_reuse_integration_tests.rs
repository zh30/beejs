...
use std::collections::{HashMap, BTreeMap};
    ...
    fn test_cli_runtime_with_different_optimization_modes() {
        ...
        // Speed 模式
        let output_speed: _ = Command::new("./target/release/beejs")
            .arg("--optimize")
            .arg("speed")
            .arg("--eval")
            .arg("1")
        ...
        // Size 模式
        let output_size: _ = Command::new("./target/release/beejs")
            .arg("--optimize")
            .arg("size")
            .arg("--eval")
            .arg("1")
        ...
        // Auto 模式
        let output_auto: _ = Command::new("./target/release/beejs")
            .arg("--optimize")
            .arg("auto")
            .arg("--eval")
            .arg("1")
    ...
    fn test_cli_runtime_verbose_mode() {
        ...
        let stdout: _ = String::from_utf8_lossy(&output.stdout);
        let stderr: _ = String::from_utf8_lossy(&output.stderr);
        let combined_output: _ = format!("{}{}", stdout, stderr);
    ...
    fn test_cli_runtime_with_file_execution() {
        ...
        // 创建临时测试文件
        let test_file: _ = "/tmp/test_runtime_reuse.js";
        fs::write(
            test_file,
            r#"
...
path.join("/tmp", "test.js");"#)
    ...
    fn test_cli_runtime_memory_efficiency() {
        ...
        let final_output: _ = Command::new("./target/release/beejs")
            .arg("--eval")
            .arg("1")
            .output()
            .expect("Failed to execute beejs");
