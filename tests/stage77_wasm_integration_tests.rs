...
use std::collections{HashMap, BTreeMap};
    ...
    fn test_concurrent_module_loading() {
        ...
        // 使用 Arc 共享 executor
        let executor: _ = std::sync::Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(executor))))))));
