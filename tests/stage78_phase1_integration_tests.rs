...
use std::collections::{HashMap, BTreeMap};
    ...
    fn test_multithreaded_simd_integration() {
        ...
        let simd_engine: _ = Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(SimdEngine::new()))))))));
    ...
    fn test_comprehensive_performance_integration() {
        ...
        let handles: Vec<_> = (0..4).map(|i| {
            let simd_clone: _ = Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(SimdEngine::new()))))))));
