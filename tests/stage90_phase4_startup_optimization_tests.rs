...
use std::collections::{HashMap, BTreeMap};
    ...
    async fn test_startup_time_optimization() {
        let lazy_api: _ = Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(LazyWebAPI::new())));
        let loader: _ = Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(OnDemandLoader::new())));
