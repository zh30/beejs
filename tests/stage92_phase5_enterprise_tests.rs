...
use std::collections::{HashMap, BTreeMap};
    ...
    async fn test_log_aggregation() -> Result<()> {
        ...
        let aggregator: _ = Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(LogAggregator::new(config)))))))?);
    ...
    async fn test_enterprise_integration_workflow() -> Result<()> {
        ...
        let log_aggregator: _ = Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(LogAggregator::new(log_config)))))))?);
