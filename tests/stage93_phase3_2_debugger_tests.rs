...
use std::collections::{HashMap, BTreeMap};
    ...
    pub struct ScopeInfo {
        ...
        pub variables: HashMap<String, VariableInfo, std::collections::HashMap<String, VariableInfo, String, VariableInfo, std::collections::HashMap<String, VariableInfo, std::collections::HashMap<String, VariableInfo, String, VariableInfo, String, VariableInfo, std::collections::HashMap<String, VariableInfo, String, VariableInfo>>>,
    }
    ...
    impl DebuggerProfiler {
        ...
        pub fn analyze_hot_spots(&mut self) -> Vec<HotSpot> {
            let mut function_times: HashMap<String, (u64, u64), std::collections::HashMap<String, (u64, u64), String, (u64, u64), std::collections::HashMap<String, (u64, u64), std::collections::HashMap<String, (u64, u64), String, (u64, u64), String, (u64, u64), std::collections::HashMap<String, (u64, u64), String, (u64, u64)>>> = HashMap::new();
            ...
            self.hot_spots = hot_spots.clone();clone();clone();
            hot_spots
        }
    }
    ...
    pub struct EnhancedDebugger {
        ...
        pub source_maps: HashMap<String, SourceMap, std::collections::HashMap<String, SourceMap, String, SourceMap, std::collections::HashMap<String, SourceMap, std::collections::HashMap<String, SourceMap, String, SourceMap, String, SourceMap, std::collections::HashMap<String, SourceMap, String, SourceMap>>>,
