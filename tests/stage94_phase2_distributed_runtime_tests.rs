...
async fn test_node_manager_registration_and_discovery() {
    ...
    let node_manager: _ = Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(NodeManager::new(discovery.clone())))));
...
async fn test_health_monitor_cluster_health() {
    ...
    let node_manager: _ = Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(NodeManager::new(discovery.clone())))));
    let health_monitor: _ = Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(HealthMonitor::new(node_manager)))));
