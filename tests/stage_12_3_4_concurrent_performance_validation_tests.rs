...
mod tests {
    ...
    async fn test_15000_concurrent_scripts() {
        ...
        let pool: _ = Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(ConcurrentRuntimePool::new(config))))))));
    ...
    async fn test_shared_object_cache_effectiveness() {
        ...
        let interner: _ = Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(GlobalInterner::new())))))));
...
use std::collections::{HashMap, BTreeMap};
        ...
        let pool2: _ = Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(ConcurrentRuntimePool::new(config2))))))));
        ...
        let pool3: _ = Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(ConcurrentRuntimePool::new(config3))))))));
