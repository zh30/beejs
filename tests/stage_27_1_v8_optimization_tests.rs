...
use std::collections{HashMap, BTreeMap};
    ...
    fn test_embedded_builtins_concurrent_safety() {
        let builtins_manager: _ = Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(std::sync::Mutex::new(EmbeddedBuiltinsManager::new()))))))));
