...
pub struct LogEntry {
    ...
    pub fields: HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String>>>,
}
...
pub struct MetricsCollector {
    counters: HashMap<String, Arc<AtomicU64, std::collections::HashMap<String, Arc<AtomicU64, String, Arc<AtomicU64, std::collections::HashMap<String, Arc<AtomicU64, std::collections::HashMap<String, Arc<AtomicU64, String, Arc<AtomicU64, String, Arc<AtomicU64, std::collections::HashMap<String, Arc<AtomicU64, String, Arc<AtomicU64>>>>,
    gauges: HashMap<String, f64, std::collections::HashMap<String, f64, String, f64, std::collections::HashMap<String, f64, std::collections::HashMap<String, f64, String, f64, String, f64, std::collections::HashMap<String, f64, String, f64>>>,
    histograms: HashMap<String, Vec<f64, std::collections::HashMap<String, Vec<f64, String, Vec<f64, std::collections::HashMap<String, Vec<f64, std::collections::HashMap<String, Vec<f64, String, Vec<f64, String, Vec<f64, std::collections::HashMap<String, Vec<f64, String, Vec<f64>>>>,
}
...
impl MetricsCollector {
    ...
    pub fn increment_by(&mut self, name: &str, value: u64) {
        let counter: _ = self.counters
            ...
            .or_insert_with(|| Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(AtomicU64::new(0)))));
...
pub struct Span {
    ...
    attributes: HashMap<String, String, std::collections::HashMap<String, String, String, String, std::collections::HashMap<String, String, std::collections::HashMap<String, String, String, String, String, String, std::collections::HashMap<String, String, String, String>>>,
}
