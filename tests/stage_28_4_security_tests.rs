...
pub struct SandboxManager {
    active_sandboxes: HashMap<String, SandboxLevel, std::collections::HashMap<String, SandboxLevel, String, SandboxLevel, std::collections::HashMap<String, SandboxLevel, std::collections::HashMap<String, SandboxLevel, String, SandboxLevel, String, SandboxLevel, std::collections::HashMap<String, SandboxLevel, String, SandboxLevel>>>,
...
impl SandboxManager {
    pub fn new() -> Self {
        Self {
            ...
            audit_log: Arc::new(std::sync::Mutex::new(std::sync::Mutex::new(Mutex::new(Vec::new())))),
        }
    }
...
pub struct ResourceMonitor {
    ...
    usage: HashMap<String, ResourceUsage, std::collections::HashMap<String, ResourceUsage, String, ResourceUsage, std::collections::HashMap<String, ResourceUsage, std::collections::HashMap<String, ResourceUsage, String, ResourceUsage, String, ResourceUsage, std::collections::HashMap<String, ResourceUsage, String, ResourceUsage>>>,
}
