...
pub struct SandboxManager {
    active_sandboxes: HashMap<String, SandboxLevel>,
...
mod tests {
    ...
    fn test_sandbox_execution() {
        ...
        let result = manager.execute_in_sandbox("test", "console.log('hello')");
    ...
    fn test_sensitive_data_filtering() {
        let filter = DataFilter::new();
        let sensitive_data = "password: secret123";
        let filtered = filter.filter_sensitive_data(sensitive_data);
    ...
    fn test_sensitive_data_detection() {
        let filter = DataFilter::new();
        let sensitive = "my password is 123456";
    ...
    fn test_sandbox_level_permissions() {
        let strict = SandboxLevel::Strict;
        let moderate = SandboxLevel::Moderate;
        let permissive = SandboxLevel::Permissive;
    ...
    fn test_stage_28_4_security_integration() {
        ...
        // 执行代码
        let result = manager.execute_in_sandbox("app", "const x = 1;");
