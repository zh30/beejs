...
import { Rocket, Zap, Shield, Brain, Cpu, MessageSquare } from 'lucide-react'
  ...
  return (
    <div className="flex flex-col overflow-hidden">
        ...
        <div className="relative text-center max-w-4xl">
          ...
          >
            ...
            <div className="flex flex-col md:flex-row items-center justify-center space-y-4 md:space-y-0 md:space-x-4">
              <button className="w-full md:w-auto px-8 py-4 bg-brand-yellow text-brand-black font-bold rounded-xl text-lg hover:scale-105 transition-transform">
                Get Started
              </button>
              <button className="w-full md:w-auto px-8 py-4 glass text-white font-bold rounded-xl text-lg hover:bg-white/10 transition-colors">
                View Documentation
              </button>
            </div>
          </motion.div>
      ...
      <section className="py-24 px-4 bg-brand-gray/30">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold mb-4">Benchmarks</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <BenchmarkCard
              ...
              bunValue="102MB"
              improvement="-19.6%"
              icon={<Cpu className="w-6 h-6 text-brand-yellow" />}
            />
            <BenchmarkCard
              label="Concurrency"
              beeValue="11,200"
      ...
      <section className="py-24 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold mb-4">Why Beejs?</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <FeatureCard
              title="Smart JIT"
              desc="Dynamic阈值调整 based on execution frequency and code heat."
              icon={<Zap />}
            />
            <FeatureCard
              title="Zero-Copy I/O"
      ...
      {/* Code Sample */}
      <section className="py-24 px-4 bg-brand-black/50">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-12">Simplicity by Design</h2>
          <div className="text-left glass rounded-2xl overflow-hidden border border-white/10 shadow-2xl">
            ...
            <pre className="p-6 md:p-8 font-mono text-sm md:text-base text-gray-300 overflow-x-auto">
              <code>{`// Beejs AI 推理示例
  ...
  return (
    <div className="glass p-8 rounded-2xl border border-white/10 relative overflow-hidden group hover:border-brand-yellow/30 transition-colors">
      ...
      <div className="flex items-baseline space-x-4 mb-4">
        <span className="text-4xl font-bold text-white">{beeValue}</span>
        <span className="text-gray-500 line-through text-lg">{bunValue}</span>
      </div>
      <div className="inline-block px-3 py-1 bg-green-500/20 text-green-400 text-xs font-bold rounded-full">
...
function FeatureCard({ title, desc, icon }: any) {
  return (
    <div className="p-8 rounded-2xl bg-white/5 border border-white/5 hover:bg-white/10 transition-all group">
      <div className="w-12 h-12 rounded-xl bg-brand-yellow/10 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
        {Object.cloneElement(icon, { className: "w-6 h-6 text-brand-yellow" })}
      </div>
