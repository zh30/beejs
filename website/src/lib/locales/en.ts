    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          ...
          { id: 'kv-store', label: 'Persistent KV & Durable State (bee:kv)', badge: 'v1.7' },
          { id: 'tool-synthesis', label: 'Tool Auto-Synthesis & OpenAPI (bee:tools)', badge: 'v1.7' },
          { id: 'hardened-sandbox', label: 'Hardened Sandbox & Audit Logs (bee:sandbox)', badge: 'v1.7' },
          { id: 'agent-bus', label: 'Agent Message Bus & PubSub (bee:bus)', badge: 'v1.8' },
          { id: 'streaming-grammar', label: 'Streaming Partial JSON & Grammars (bee:grammar)', badge: 'v1.8' },
          { id: 'agent-checkpoint', label: 'Agent State Checkpointing (bee:checkpoint)', badge: 'v1.8' },
