...
export const fr: TranslationSchema = {
  ...
  home: {
    heroBadge: 'Édition Performance v0.4.3',
    heroBadgeSub: 'Pool Multi-Workers & Parité des Benchmarks',
    heroBanner: '🚀 Sortie de v0.4.3 : Dépasse Node.js & Bun sur les benchmarks clés — Lire l’analyse',
    ...
    heroSubtitle:
      'Conçu selon les premiers principes en Rust & Google V8. Concurrence multi-workers sans verrou, double cache de modules en mémoire (4.6M ops/s), démarrage à froid sub-18ms et compatibilité complète Node/Web.',
    ...
    copiedBtn: 'Copié',
    latestArticle: {
      badge: 'Dernière Analyse Approfondie',
      title: 'Beejs v0.4.3 : Percée Architecturale et Parité de Performance avec Node et Bun',
      desc: 'Découvrez comment les pools de workers sans verrou, le double cache de modules et Rust ont permis d’atteindre 4,6M ops/s sur require et d’éliminer les goulots d’étranglement.',
    ...
    ctaSubtitle: 'Installez Beejs v0.4.3 sur macOS et Linux en une seule commande.',
    ctaButton: 'Lire le Guide d’Installation',
    ctaNotesButton: 'Lire les Notes de Version',
  },
  docs: {
    title: 'Manuel du Runtime',
    subtitle: 'Documentation développeur et opérateur pour Beejs v0.4.3.',
    ...
    sections: {
      introduction: {
        ...
        body: [
          'Beejs v0.4.3 est la version majeure de performance du runtime, avec concurrence HTTP multi-workers, double cache de modules en mémoire et démarrage à froid sous 18ms.',
