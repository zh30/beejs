  ...
  docs: {
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          { id: 'embedded-db', label: 'Base de données & Vecteurs (bee:db & bee:vector)', badge: 'DB' },
          { id: 'standard-library', label: 'Bibliothèque standard (bee:std)', badge: 'Std' },
          { id: 'package-manager-dlx', label: 'Exécuteur de paquets (bee x / dlx)', badge: 'CLI' },
          { id: 'deployment-docker', label: 'Déploiement & Conteneurs (bee deploy)', badge: 'Deploy' },
          { id: 'ide-extension', label: 'Extension VS Code officielle', badge: 'IDE' },
        ],
      },
      {
        ...
        items: [
          ...
          { id: 'kv-store', label: 'KV Persistant & État Durable (bee:kv)', badge: 'v1.7' },
          { id: 'tool-synthesis', label: 'Auto-synthèse d’outils & OpenAPI (bee:tools)', badge: 'v1.7' },
          { id: 'hardened-sandbox', label: 'Bac à sable Renforcé & Journaux d’Audit (bee:sandbox)', badge: 'v1.7' },
          { id: 'agent-bus', label: 'Bus de Messages & PubSub d’Agents (bee:bus)', badge: 'v1.8' },
          { id: 'streaming-grammar', label: 'Flux Structuré & Grammaires (bee:grammar)', badge: 'v1.8' },
          { id: 'agent-checkpoint', label: 'Points de Contrôle & Restauration (bee:checkpoint)', badge: 'v1.8' },
